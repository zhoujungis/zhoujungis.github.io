"""Publish the subscribe + mass-mail article to the blog backend.

Usage:
    python tools/publish_subscribe_mail_article.py
...
Source Markdown: ``article/django-subscribe-mass-mail.md``.
"""
...
ARTICLE_EXCERPT = (
    ...
    "退订重订状态机、流式群发加逐批幂等旗，外加定时命令必须 .save() 的静默吞通知坑。"
)
ARTICLE_COVER = (
