"""Publish the distributed-ID article.

Usage:
    python tools/publish_distributed_id_article.py
    python tools/publish_distributed_id_article.py --cover https://...
...
ARTICLE_EXCERPT = (
    ...
    "含 UUIDv4 页分裂原理、号段模式双 buffer、雪花位分配逐位拆解、三种方案吞吐实测与选型决策树。"
)
ARTICLE_COVER = (
...
TAGS = [
    ...
    {"slug": "distributed-system", "name": "分布式系统"},
