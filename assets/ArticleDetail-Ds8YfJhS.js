import{A as e,C as t,D as n,E as r,R as i,S as a,b as o,c as s,d as c,dt as l,h as u,i as d,j as f,k as p,l as m,lt as h,m as g,p as _,s as v,t as y,u as b,ut as x,w as S,x as C,z as w}from"./_plugin-vue_export-helper-BK47PYcU.js";import{t as T}from"./client-DyaaoQco.js";import{f as E,p as D,v as O,y as k}from"./index-ZphJhF5x.js";import{i as A,n as j,t as ee}from"./labels-H7OcNmBE.js";import{t as te}from"./article-DVG4cnUk.js";function M(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function N(e){if(Array.isArray(e))return e}function P(e,t){var n=e==null?null:typeof Symbol<`u`&&e[Symbol.iterator]||e[`@@iterator`];if(n!=null){var r,i,a,o,s=[],c=!0,l=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(c=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);c=!0);}catch(e){l=!0,i=e}finally{try{if(!c&&n.return!=null&&(o=n.return(),Object(o)!==o))return}finally{if(l)throw i}}return s}}function ne(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function F(e,t){return N(e)||P(e,t)||I(e,t)||ne()}function I(e,t){if(e){if(typeof e==`string`)return M(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?M(e,t):void 0}}var re=Object.entries,L=Object.setPrototypeOf,ie=Object.isFrozen,ae=Object.getPrototypeOf,R=Object.getOwnPropertyDescriptor,z=Object.freeze,B=Object.seal,oe=Object.create,se=typeof Reflect<`u`&&Reflect,ce=se.apply,V=se.construct;z||=function(e){return e},B||=function(e){return e},ce||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},V||=function(e){return new e(...[...arguments].slice(1))};var le=K(Array.prototype.forEach),ue=K(Array.prototype.lastIndexOf),de=K(Array.prototype.pop),fe=K(Array.prototype.push),pe=K(Array.prototype.splice),me=Array.isArray,he=K(String.prototype.toLowerCase),ge=K(String.prototype.toString),_e=K(String.prototype.match),ve=K(String.prototype.replace),ye=K(String.prototype.indexOf),be=K(String.prototype.trim),xe=K(Number.prototype.toString),H=K(Boolean.prototype.toString),Se=typeof BigInt>`u`?null:K(BigInt.prototype.toString),U=typeof Symbol>`u`?null:K(Symbol.prototype.toString),W=K(Object.prototype.hasOwnProperty),Ce=K(Object.prototype.toString),G=K(RegExp.prototype.test),we=Te(TypeError);function K(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return ce(e,t,n)}}function Te(e){return function(){return V(e,[...arguments])}}function q(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:he;if(L&&L(e,null),!me(t))return e;let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(ie(t)||(t[r]=e),i=e)}e[i]=!0}return e}function Ee(e){for(let t=0;t<e.length;t++)W(e,t)||(e[t]=null);return e}function J(e){let t=oe(null);for(let r of re(e)){var n=F(r,2);let i=n[0],a=n[1];W(e,i)&&(me(a)?t[i]=Ee(a):a&&typeof a==`object`&&a.constructor===Object?t[i]=J(a):t[i]=a)}return t}function De(e){switch(typeof e){case`string`:return e;case`number`:return xe(e);case`boolean`:return H(e);case`bigint`:return Se?Se(e):`0`;case`symbol`:return U?U(e):`Symbol()`;case`undefined`:return Ce(e);case`function`:case`object`:{if(e===null)return Ce(e);let t=e,n=Oe(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:Ce(e)}return Ce(e)}default:return Ce(e)}}function Oe(e,t){for(;e!==null;){let n=R(e,t);if(n){if(n.get)return K(n.get);if(typeof n.value==`function`)return K(n.value)}e=ae(e)}function n(){return null}return n}function ke(e){try{return G(e,``),!0}catch{return!1}}var Ae=z(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),je=z(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),Me=z([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),Ne=z([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),Pe=z(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),Fe=z([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),Ie=z([`#text`]),Le=z(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),Re=z(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dominant-baseline.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-orientation.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),ze=z(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),Be=z([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),Ve=B(/{{[\w\W]*|^[\w\W]*}}/g),He=B(/<%[\w\W]*|^[\w\W]*%>/g),Ue=B(/\${[\w\W]*/g),We=B(/^data-[\-\w.\u00B7-\uFFFF]+$/),Ge=B(/^aria-[\-\w]+$/),Ke=B(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),qe=B(/^(?:\w+script|data):/i),Je=B(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ye=B(/^html$/i),Xe=B(/^[a-z][.\w]*(-[.\w]+)+$/i),Ze=B(/<[/\w!]/g),Qe=B(/<[/\w]/g),$e=B(/<\/no(script|embed|frames)/i),et=B(/\/>/i),tt={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},nt=function(){return typeof window>`u`?null:window},rt=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},it=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},at=function(e,t,n,r){return W(e,t)&&me(e[t])?q(r.base?J(r.base):{},e[t],r.transform):n};function ot(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:nt(),t=e=>ot(e);if(t.version=`3.4.12`,t.removed=[],!e||!e.document||e.document.nodeType!==tt.document||!e.Element)return t.isSupported=!1,t;let n=e.document,r=n,i=r.currentScript;e.DocumentFragment;let a=e.HTMLTemplateElement,o=e.Node,s=e.Element,c=e.NodeFilter;e.NamedNodeMap===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;let l=e.DOMParser,u=e.trustedTypes,d=s.prototype,f=Oe(d,`cloneNode`),p=Oe(d,`remove`),m=Oe(d,`nextSibling`),h=Oe(d,`childNodes`),g=Oe(d,`parentNode`),_=Oe(d,`shadowRoot`),v=Oe(d,`attributes`),y=o&&o.prototype?Oe(o.prototype,`nodeType`):null,b=o&&o.prototype?Oe(o.prototype,`nodeName`):null;if(typeof a==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let x,S=``,C,w=!1,T=0,E=function(){if(T>0)throw we(`A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.`)},D=function(e){E(),T++;try{return x.createHTML(e)}finally{T--}},O=function(e){E(),T++;try{return x.createScriptURL(e)}finally{T--}},k=function(){return w||=(C=rt(u,i),!0),C},A=n,j=A.implementation,ee=A.createNodeIterator,te=A.createDocumentFragment,M=A.getElementsByTagName,N=r.importNode,P=it();t.isSupported=typeof re==`function`&&typeof g==`function`&&j&&j.createHTMLDocument!==void 0;let ne=Ve,F=He,I=Ue,L=We,ie=Ge,ae=qe,R=Je,se=Xe,ce=Ke,V=null,xe=q({},[...Ae,...je,...Me,...Pe,...Ie]),H=null,Se=q({},[...Le,...Re,...ze,...Be]),U=Object.seal(oe(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Ce=null,K=null,Te=Object.seal(oe(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),Ee=!0,st=!0,ct=!1,lt=!0,ut=!1,dt=!0,Y=!1,ft=!1,pt=null,mt=null,ht=!1,X=!1,gt=!1,_t=!1,vt=!0,yt=!1,bt=`user-content-`,xt=!0,St=!1,Ct={},Z=null,wt=q({},`annotation-xml.audio.colgroup.desc.foreignobject.head.iframe.math.mi.mn.mo.ms.mtext.noembed.noframes.noscript.plaintext.script.selectedcontent.style.svg.template.thead.title.video.xmp`.split(`.`)),Tt=null,Et=q({},[`audio`,`video`,`img`,`source`,`image`,`track`]),Dt=null,Ot=q({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),kt=`http://www.w3.org/1998/Math/MathML`,At=`http://www.w3.org/2000/svg`,jt=`http://www.w3.org/1999/xhtml`,Mt=jt,Nt=!1,Pt=null,Ft=q({},[kt,At,jt],ge),It=z([`mi`,`mo`,`mn`,`ms`,`mtext`]),Q=q({},It),Lt=z([`annotation-xml`]),Rt=q({},Lt),zt=q({},[`title`,`style`,`font`,`a`,`script`]),Bt=null,Vt=[`application/xhtml+xml`,`text/html`],$=null,Ht=null,Ut=n.createElement(`form`),Wt=function(e){return e instanceof RegExp||e instanceof Function},Gt=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ht&&Ht===e)return;(!e||typeof e!=`object`)&&(e={}),e=J(e),Bt=Vt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,$=Bt===`application/xhtml+xml`?ge:he,V=at(e,`ALLOWED_TAGS`,xe,{transform:$}),H=at(e,`ALLOWED_ATTR`,Se,{transform:$}),Pt=at(e,`ALLOWED_NAMESPACES`,Ft,{transform:ge}),Dt=at(e,`ADD_URI_SAFE_ATTR`,Ot,{transform:$,base:Ot}),Tt=at(e,`ADD_DATA_URI_TAGS`,Et,{transform:$,base:Et}),Z=at(e,`FORBID_CONTENTS`,wt,{transform:$}),Ce=at(e,`FORBID_TAGS`,J({}),{transform:$}),K=at(e,`FORBID_ATTR`,J({}),{transform:$}),Ct=W(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?J(e.USE_PROFILES):e.USE_PROFILES:!1,Ee=e.ALLOW_ARIA_ATTR!==!1,st=e.ALLOW_DATA_ATTR!==!1,ct=e.ALLOW_UNKNOWN_PROTOCOLS||!1,lt=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ut=e.SAFE_FOR_TEMPLATES||!1,dt=e.SAFE_FOR_XML!==!1,Y=e.WHOLE_DOCUMENT||!1,X=e.RETURN_DOM||!1,gt=e.RETURN_DOM_FRAGMENT||!1,_t=e.RETURN_TRUSTED_TYPE||!1,ht=e.FORCE_BODY||!1,vt=e.SANITIZE_DOM!==!1,yt=e.SANITIZE_NAMED_PROPS||!1,xt=e.KEEP_CONTENT!==!1,St=e.IN_PLACE||!1,ce=ke(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:Ke,Mt=typeof e.NAMESPACE==`string`?e.NAMESPACE:jt,Q=W(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?J(e.MATHML_TEXT_INTEGRATION_POINTS):q({},It),Rt=W(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?J(e.HTML_INTEGRATION_POINTS):q({},Lt);let t=W(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?J(e.CUSTOM_ELEMENT_HANDLING):oe(null);if(U=oe(null),W(t,`tagNameCheck`)&&Wt(t.tagNameCheck)&&(U.tagNameCheck=t.tagNameCheck),W(t,`attributeNameCheck`)&&Wt(t.attributeNameCheck)&&(U.attributeNameCheck=t.attributeNameCheck),W(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(U.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),B(U),ut&&(st=!1),gt&&(X=!0),Ct&&(V=q({},Ie),H=oe(null),Ct.html===!0&&(q(V,Ae),q(H,Le)),Ct.svg===!0&&(q(V,je),q(H,Re),q(H,Be)),Ct.svgFilters===!0&&(q(V,Me),q(H,Re),q(H,Be)),Ct.mathMl===!0&&(q(V,Pe),q(H,ze),q(H,Be))),Te.tagCheck=null,Te.attributeCheck=null,W(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?Te.tagCheck=e.ADD_TAGS:me(e.ADD_TAGS)&&(V===xe&&(V=J(V)),q(V,e.ADD_TAGS,$))),W(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?Te.attributeCheck=e.ADD_ATTR:me(e.ADD_ATTR)&&(H===Se&&(H=J(H)),q(H,e.ADD_ATTR,$))),W(e,`ADD_URI_SAFE_ATTR`)&&me(e.ADD_URI_SAFE_ATTR)&&q(Dt,e.ADD_URI_SAFE_ATTR,$),W(e,`FORBID_CONTENTS`)&&me(e.FORBID_CONTENTS)&&(Z===wt&&(Z=J(Z)),q(Z,e.FORBID_CONTENTS,$)),W(e,`ADD_FORBID_CONTENTS`)&&me(e.ADD_FORBID_CONTENTS)&&(Z===wt&&(Z=J(Z)),q(Z,e.ADD_FORBID_CONTENTS,$)),xt&&(V[`#text`]=!0),Y&&q(V,[`html`,`head`,`body`]),V.table&&(q(V,[`tbody`]),delete Ce.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw we(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw we(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);let t=x;x=e.TRUSTED_TYPES_POLICY;try{S=D(``)}catch(e){throw x=t,e}}else e.TRUSTED_TYPES_POLICY===null?(x=void 0,S=``):(x===void 0&&(x=k()),x&&typeof S==`string`&&(S=D(``)));z&&z(e),Ht=e},Kt=q({},[...je,...Me,...Ne]),qt=q({},[...Pe,...Fe]),Jt=function(e,t,n){return t.namespaceURI===jt?e===`svg`:t.namespaceURI===kt?e===`svg`&&(n===`annotation-xml`||Q[n]):!!Kt[e]},Yt=function(e,t,n){return t.namespaceURI===jt?e===`math`:t.namespaceURI===At?e===`math`&&Rt[n]:!!qt[e]},Xt=function(e,t,n){return t.namespaceURI===At&&!Rt[n]||t.namespaceURI===kt&&!Q[n]?!1:!qt[e]&&(zt[e]||!Kt[e])},Zt=function(e){let t=g(e);(!t||!t.tagName)&&(t={namespaceURI:Mt,tagName:`template`});let n=he(e.tagName),r=he(t.tagName);return Pt[e.namespaceURI]?e.namespaceURI===At?Jt(n,t,r):e.namespaceURI===kt?Yt(n,t,r):e.namespaceURI===jt?Xt(n,t,r):!!(Bt===`application/xhtml+xml`&&Pt[e.namespaceURI]):!1},Qt=function(e){fe(t.removed,{element:e});try{g(e).removeChild(e)}catch{if(p(e),!g(e))throw we(`a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place`)}},$t=function(e){nn(e);let t=h(e);if(t){let e=[];le(t,t=>{fe(e,t)}),le(e,e=>{try{p(e)}catch{}})}let n=v(e);if(n)for(let t=n.length-1;t>=0;--t){let r=n[t],i=r&&r.name;if(typeof i==`string`)try{e.removeAttribute(i)}catch{}}},en=function(e,n){try{fe(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{fe(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(X||gt)try{Qt(n)}catch{}else try{n.setAttribute(e,``)}catch{}},tn=function(e){let t=v(e);if(t)for(let n=t.length-1;n>=0;--n){let r=t[n],i=r&&r.name;if(!(typeof i!=`string`||H[$(i)]))try{e.removeAttribute(i)}catch{}}},nn=function(e){let t=[e];for(;t.length>0;){let e=t.pop();(y?y(e):e.nodeType)===tt.element&&tn(e);let n=h(e);if(n)for(let e=n.length-1;e>=0;--e)t.push(n[e])}},rn=function(e){if(!dt)return;let t=[e];for(;t.length>0;){let e=t.pop(),n=y?y(e):e.nodeType;if(n===tt.processingInstruction||n===tt.comment&&G(Qe,e.data)){try{p(e)}catch{}continue}if(n===tt.element){let t=e,n=$(b?b(e):e.nodeName);try{t.hasAttribute&&t.hasAttribute(`patchsrc`)&&t.removeAttribute(`patchsrc`),t.hasAttribute&&t.hasAttribute(`for`)&&n!==`label`&&n!==`output`&&t.removeAttribute(`for`)}catch{}}let r=h(e);if(r)for(let e=r.length-1;e>=0;--e)t.push(r[e])}},an=function(e){let t=null,r=null;if(ht)e=`<remove></remove>`+e;else{let t=_e(e,/^[\r\n\t ]+/);r=t&&t[0]}Bt===`application/xhtml+xml`&&Mt===jt&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=x?D(e):e;if(Mt===jt)try{t=new l().parseFromString(i,Bt)}catch{}if(!t||!t.documentElement){t=j.createDocument(Mt,`template`,null);try{t.documentElement.innerHTML=Nt?S:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),Mt===jt?M.call(t,Y?`html`:`body`)[0]:Y?t.documentElement:a},on=function(e){return ee.call(e.ownerDocument||e,e,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},sn=function(e){return e=ve(e,ne,` `),e=ve(e,F,` `),e=ve(e,I,` `),e},cn=function(e){e.normalize();let t=ee.call(e.ownerDocument||e,e,c.SHOW_TEXT|c.SHOW_COMMENT|c.SHOW_CDATA_SECTION|c.SHOW_PROCESSING_INSTRUCTION,null),n=t.nextNode();for(;n;)n.data=sn(n.data),n=t.nextNode();let r=e.querySelectorAll?.call(e,`template`);r&&le(r,e=>{un(e.content)&&cn(e.content)})},ln=function(e){let t=b?b(e):null;return typeof t!=`string`||$(t)!==`form`?!1:typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||e.attributes!==v(e)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`||e.nodeType!==y(e)||e.childNodes!==h(e)},un=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return y(e)===tt.documentFragment}catch{return!1}},dn=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return typeof y(e)==`number`}catch{return!1}};function fn(e,n,r){e.length!==0&&le(e,e=>{e.call(t,n,r,Ht)})}let pn=function(e,t){return!!(dt&&e.hasChildNodes()&&!dn(e.firstElementChild)&&G(Ze,e.textContent)&&G(Ze,e.innerHTML)||dt&&e.namespaceURI===jt&&t===`style`&&dn(e.firstElementChild)||e.nodeType===tt.processingInstruction||dt&&e.nodeType===tt.comment&&G(Qe,e.data))},mn=function(e,t){if(!Ce[t]&&vn(t)&&(U.tagNameCheck instanceof RegExp&&G(U.tagNameCheck,t)||U.tagNameCheck instanceof Function&&U.tagNameCheck(t)))return!1;if(xt&&!Z[t]){let t=g(e),n=h(e);if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=St?n[i]:f(n[i],!0);t.insertBefore(r,m(e))}}}return Qt(e),!0},hn=function(e,n){if(fn(P.beforeSanitizeElements,e,null),e!==n&&g(e)===null)return!0;if(ln(e))return Qt(e),!0;let r=$(b?b(e):e.nodeName);if(fn(P.uponSanitizeElement,e,{tagName:r,allowedTags:V}),e!==n&&g(e)===null)return!0;if(pn(e,r))return Qt(e),!0;if(Ce[r]||!(Te.tagCheck instanceof Function&&Te.tagCheck(r))&&!V[r]){let t=mn(e,r);return t===!1&&fn(P.afterSanitizeElements,e,null),t}if((y?y(e):e.nodeType)===tt.element&&!Zt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&G($e,e.innerHTML))return Qt(e),!0;if(ut&&e.nodeType===tt.text){let n=sn(e.textContent);e.textContent!==n&&(fe(t.removed,{element:e.cloneNode()}),e.textContent=n)}return fn(P.afterSanitizeElements,e,null),!1},gn=function(e,t,r){if(K[t]||dt&&t===`patchsrc`||dt&&t===`for`&&e!==`label`&&e!==`output`||vt&&(t===`id`||t===`name`)&&(r in n||r in Ut))return!1;let i=H[t]||Te.attributeCheck instanceof Function&&Te.attributeCheck(t,e);if(!(st&&G(L,t))&&!(Ee&&G(ie,t))){if(!i){if(!(vn(e)&&(U.tagNameCheck instanceof RegExp&&G(U.tagNameCheck,e)||U.tagNameCheck instanceof Function&&U.tagNameCheck(e))&&(U.attributeNameCheck instanceof RegExp&&G(U.attributeNameCheck,t)||U.attributeNameCheck instanceof Function&&U.attributeNameCheck(t,e))||t===`is`&&U.allowCustomizedBuiltInElements&&(U.tagNameCheck instanceof RegExp&&G(U.tagNameCheck,r)||U.tagNameCheck instanceof Function&&U.tagNameCheck(r))))return!1}else if(!Dt[t]&&!G(ce,ve(r,R,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&ye(r,`data:`)===0&&Tt[e])&&!(ct&&!G(ae,ve(r,R,``)))&&r)return!1}return!0},_n=q({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),vn=function(e){return!_n[he(e)]&&G(se,e)},yn=function(e,t,n,r){if(x&&typeof u==`object`&&typeof u.getAttributeType==`function`&&!n)switch(u.getAttributeType(e,t)){case`TrustedHTML`:return D(r);case`TrustedScriptURL`:return O(r)}return r},bn=function(e,n,r,i){try{r?e.setAttributeNS(r,n,i):e.setAttribute(n,i),ln(e)?Qt(e):de(t.removed)}catch{en(n,e)}},xn=function(e){fn(P.beforeSanitizeAttributes,e,null);let t=e.attributes;if(!t||ln(e))return;let n={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:H,forceKeepAttr:void 0},r=t.length,i=$(e.nodeName);for(;r--;){let a=t[r],o=a.name,s=a.namespaceURI,c=a.value,l=$(o),u=c,d=o===`value`?u:be(u);if(n.attrName=l,n.attrValue=d,n.keepAttr=!0,n.forceKeepAttr=void 0,fn(P.uponSanitizeAttribute,e,n),d=n.attrValue,yt&&(l===`id`||l===`name`)&&ye(d,bt)!==0&&(en(o,e),d=bt+d),dt&&G(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){en(o,e);continue}if(l===`attributename`&&_e(d,`href`)){en(o,e);continue}if(!n.forceKeepAttr){if(!n.keepAttr){en(o,e);continue}if(!lt&&G(et,d)){en(o,e);continue}if(ut&&(d=sn(d)),!gn(i,l,d)){en(o,e);continue}d=yn(i,l,s,d),d!==u&&bn(e,o,s,d)}}fn(P.afterSanitizeAttributes,e,null)},Sn=function(e){let t=null,n=on(e);for(fn(P.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)if(fn(P.uponSanitizeShadowNode,t,null),hn(t,e),xn(t),un(t.content)&&Sn(t.content),(y?y(t):t.nodeType)===tt.element){let e=_(t);un(e)&&(Cn(e),Sn(e))}fn(P.afterSanitizeShadowDOM,e,null)},Cn=function(e){let t=[{node:e,shadow:null}];for(;t.length>0;){let e=t.pop();if(e.shadow){Sn(e.shadow);continue}let n=e.node,r=(y?y(n):n.nodeType)===tt.element,i=h(n);if(i)for(let e=i.length-1;e>=0;--e)t.push({node:i[e],shadow:null});if(r){let e=b?b(n):null;if(typeof e==`string`&&$(e)===`template`){let e=n.content;un(e)&&t.push({node:e,shadow:null})}}if(r){let e=_(n);un(e)&&t.push({node:null,shadow:e},{node:e,shadow:null})}}};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,a=null,o=null,s=null;if(Nt=!e,Nt&&(e=`<!-->`),typeof e!=`string`&&!dn(e)&&(e=De(e),typeof e!=`string`))throw we(`dirty is not a string, aborting`);if(!t.isSupported)return e;ft?(V=pt,H=mt):Gt(n),(P.uponSanitizeElement.length>0||P.uponSanitizeAttribute.length>0)&&(V=J(V)),P.uponSanitizeAttribute.length>0&&(H=J(H)),t.removed=[];let c=St&&typeof e!=`string`&&dn(e);if(c){rn(e);let t=b?b(e):e.nodeName;if(typeof t==`string`){let n=$(t);if(!V[n]||Ce[n])throw $t(e),we(`root node is forbidden and cannot be sanitized in-place`)}if(ln(e))throw $t(e),we(`root node is clobbered and cannot be sanitized in-place`);try{Cn(e)}catch(t){throw $t(e),t}}else if(dn(e))i=an(`<!---->`),a=i.ownerDocument.importNode(e,!0),a.nodeType===tt.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?i=a:i.appendChild(a),Cn(a);else{if(!X&&!ut&&!Y&&e.indexOf(`<`)===-1)return x&&_t?D(e):e;if(i=an(e),!i)return X?null:_t?S:``}i&&ht&&Qt(i.firstChild);let l=c?e:i,u=on(l);try{for(;o=u.nextNode();)hn(o,l),xn(o),un(o.content)&&Sn(o.content)}catch(n){throw c&&($t(e),le(t.removed,e=>{e.element&&nn(e.element)})),n}if(c)return le(t.removed,e=>{e.element&&nn(e.element)}),ut&&cn(e),e;if(X){if(ut&&cn(i),gt)for(s=te.call(i.ownerDocument);i.firstChild;)s.appendChild(i.firstChild);else s=i;return(H.shadowroot||H.shadowrootmode)&&(s=N.call(r,s,!0)),s}let d=Y?i.outerHTML:i.innerHTML;return Y&&V[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&G(Ye,i.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+d),ut&&(d=sn(d)),x&&_t?D(d):d},t.setConfig=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Gt(e),ft=!0,pt=V,mt=H},t.clearConfig=function(){Ht=null,ft=!1,pt=null,mt=null,x=C,S=``},t.isValidAttribute=function(e,t,n){Ht||Gt({});let r=$(e),i=$(t);return gn(r,i,n)},t.addHook=function(e,t){typeof t==`function`&&W(P,e)&&fe(P[e],t)},t.removeHook=function(e,t){if(W(P,e)){if(t!==void 0){let n=ue(P[e],t);return n===-1?void 0:pe(P[e],n,1)[0]}return de(P[e])}},t.removeHooks=function(e){W(P,e)&&(P[e]=[])},t.removeAllHooks=function(){P=it()},t}var st=ot();function ct(e,t){let n=String(e??``),r=n.match(/^\s*<h1\b[^>]*>([\s\S]*?)<\/h1>\s*/i);if(!r)return n;let i=r[1].replace(/<[^>]*>/g,``).replace(/\s+/g,` `).trim(),a=String(t??``).replace(/\s+/g,` `).trim();return!a||i!==a?n:n.slice(r[0].length)}function lt(e){let t=e.length,n=Array.from({length:t},(e,n)=>n+1<t?n+1:null),r=[],i=null,a=t>0?0:null,o=null,s=(e,t)=>r.push({phase:e,desc:t,prev:i,curr:a,next:o,nextOf:[...n],done:!1}),c=t=>t===null?`∅`:String(e[t]);if(t===0)return s(`init`,"空链表。`head` 本身就是 ∅，直接返回 ∅ —— 这是必须单独处理的第一种边界。"),r[0].done=!0,r;for(s(`init`,`初始状态：\`prev\` 先站在 ∅（反转后头节点会变成尾节点，它的 \`next\` 必须指向空），\`curr\` 指向头节点 ${c(a)}。`);a!==null;)o=n[a],s(`read-next`,`① \`next = curr.next\`，先记住 ${c(o)}。这一步看着多余，其实是整个算法的命门：一旦 ② 把 \`curr\` 的指针掉头，通往后面节点的唯一线索就断了，所以必须提前存好。`),n[a]=i,s(`flip`,`② \`curr.next = prev\`，把 ${c(a)} 的箭头掉个头，指向 ${c(i)}。`+(i===null?` 因为 \`prev\` 还是 ∅，${c(a)} 就成了新的尾节点。`:``)),i=a,a=o,s(`advance`,a===null?`③ \`prev = curr\`，\`curr = next\` = ∅。curr 走出了链表，循环结束 —— 返回 \`prev\`（${c(i)}），它就是反转后的新头节点。`:`③ \`prev\` 和 \`curr\` 一起右移：\`prev\` 指向 ${c(i)}，\`curr\` 指向 ${c(a)}。准备处理下一个节点。`);return r[r.length-1].done=!0,r}var ut=`viz-chrome-styles`,dt=`http://www.w3.org/2000/svg`;function Y(e,t){let n=document.createElementNS(dt,e);if(t)for(let e in t)n.setAttribute(e,t[e]);return n}function ft(e,t,n,r,i=`viz-arrow`){let a=Y(`g`,{class:i}),o=r>0?t:e,s=r>0?e:t;return a.appendChild(Y(`line`,{class:`${i}__line`,x1:s,y1:n,x2:o-r*9,y2:n})),a.appendChild(Y(`path`,{class:`${i}__head`,d:`M ${o} ${n} L ${o-r*9} ${n-5.5} L ${o-r*9} ${n+5.5} Z`})),a}var pt=`
.viz {
  margin: 1.6em 0;
...
`;function ya(){if(mt(),document.getElementById(ea))return;let e=document.createElement(`style`);e.id=ea,e.textContent=va,document.head.appendChild(e)}function ba(e,t={}){if(!e||e.dataset.intsMounted===`1`)return{destroy(){}};e.dataset.intsMounted=`1`,ya();let n=$i(t);n[0];let r=t.autoplay!==!1,i=Array.isArray(t.pool)&&t.pool.length?t.pool:[1,2,3,4,5,6,7],a=Array.isArray(t.pathA)?t.pathA:[0,1,2,3,4],o=Array.isArray(t.pathB)?t.pathB:[5,6,3,4],{a:s,b:c,c:l}=Qi(a,o),u=l>0?a.slice(s):[],d=new Set(u);s>0&&a[s-1],c>0&&o[c-1];let f=Math.max(a.length,o.length,1),p=pa,m=e=>76+e*102,h=2*ia+f*ta+(f-1)*ra,g=h+fa*2+pa*2,_=p+h+fa,v=s,y=e=>e+na/2;function b(e){let t=a.indexOf(e),n=o.indexOf(e);return t>=0&&d.has(e)?{x:m(v+(t-s)),y:aa,col:v+(t-s)}:t>=0&&n<0?{x:m(t),y:aa,col:t}:n>=0&&t<0?{x:m(n),y:oa,col:n}:t>=0?{x:m(t),y:aa,col:t}:{x:m(n),y:oa,col:n}}let x=document.createElement(`div`);x.className=`viz ints`;let S=document.createElement(`div`);S.className=`viz__stage`,x.appendChild(S);let C=Y(`svg`,{class:`viz__svg ints__svg`,viewBox:`0 0 ${g} 440`,role:`img`,"aria-label":`相交链表推演动画`});S.appendChild(C);let w=Y(`g`,{class:`ints-shared-note`}),T=Y(`line`,{class:`ints-shared-note__line`}),E=Y(`text`,{class:`ints-shared-note__text`,x:g/2,y:ha});w.append(T,E),C.appendChild(w);let D=[];for(let[e,t]of[[_,y(aa)],[_,y(oa)]]){C.appendChild(Y(`circle`,{class:`ints-null__ring`,cx:e,cy:t,r:14}));let n=Y(`text`,{class:`ints-null__text`,x:e,y:t});n.textContent=`∅`,C.appendChild(n),D.push({cx:e,cy:t})}let O=Y(`g`,{class:`ints-edges`});C.appendChild(O);let k=Y(`g`,{class:`ints-answer`}),A=Y(`rect`,{class:`ints-answer__box`,x:0,y:0,width:76,height:60,rx:13});k.appendChild(A),C.appendChild(k);let j=new Map;for(let e of new Set([...a,...o])){let t=b(e),n=Y(`g`,{class:`ints-node${d.has(e)?` is-shared`:``}`});n.setAttribute(`transform`,`translate(${t.x} ${t.y})`),n.appendChild(Y(`rect`,{class:`ints-node__box`,x:0,y:0,width:ta,height:na,rx:9}));let r=Y(`text`,{class:`ints-node__value`,x:ta/2,y:na/2});r.textContent=String(i[e]),n.appendChild(r),C.appendChild(n),j.set(e,n)}let ee=[],te=(e,t)=>{for(let n=0;n<e.length-1;n+=1){let r=e[n],i=e[n+1],a=`${r}->${i}`;ee.some(e=>e.key===a)||ee.push({key:a,from:r,to:i,kind:t})}};te(a,`a`),te(o,`b`);let M=[];for(let e of ee){let t=Y(`g`,{class:`ints-edge ints-edge--${e.kind}`}),n=Y(`path`,{class:`ints-edge__line`}),r=Y(`path`,{class:`ints-edge__head`});t.append(n,r),O.appendChild(t),M.push({...e,g:t,line:n,head:r})}let N=[];{let e=Y(`g`,{class:`ints-edge`}),t=Y(`path`,{class:`ints-edge__line`}),n=Y(`path`,{class:`ints-edge__head`});e.append(t,n),O.appendChild(e),N.push({g:e,line:t,head:n,slot:a[a.length-1],row:aa})}let P={};for(let e of[`a`,`b`]){let t=Y(`g`,{class:`ints-hop ints-hop--${e}`}),n=Y(`path`,{class:`ints-hop__line`}),r=Y(`path`,{class:`ints-hop__head`}),i=Y(`rect`,{class:`ints-hop__tag-bg`,x:-76,y:-9,width:152,height:18,rx:6}),a=Y(`text`,{class:`ints-hop__tag`,x:0,y:0});t.append(n,r,i,a),C.appendChild(t),P[e]={g:t,line:n,head:r,tagBg:i,tag:a}}let ne=[];if(s>0){let e=Y(`text`,{class:`ints-row__text ints-row__text--a`,x:m(0)+ga,y:y(aa)});e.textContent=`A`,C.appendChild(e),ne.push(e)}if(c>0){let e=Y(`text`,{class:`ints-row__text ints-row__text--b`,x:m(0)+ga,y:y(oa)});e.textContent=`B`,C.appendChild(e),ne.push(e)}function F(e,t){let n=Y(`g`,{class:`ints-chip ints-chip--${e}`});n.appendChild(Y(`rect`,{class:`ints-chip__box`,x:-52/2,y:-24/2,width:ua,height:da}));let r=Y(`text`,{class:`ints-chip__text`,x:0,y:0});return r.textContent=t,n.appendChild(r),n}let I=F(`a`,`pA`),re=F(`b`,`pB`);C.append(I,re);let L=Y(`line`,{class:`ints-lead ints-lead--a`}),ie=Y(`line`,{class:`ints-lead ints-lead--b`});O.append(L,ie);let ae=Y(`g`,{class:`ints-verdict`}),R=Y(`rect`,{class:`ints-verdict__box`,x:(g-240)/2,y:ma-18,width:240,height:36,rx:18}),z=Y(`text`,{class:`ints-verdict__text`,x:g/2,y:ma});ae.append(R,z),C.appendChild(ae);let B=document.createElement(`p`);B.className=`viz__desc`,B.setAttribute(`aria-live`,`polite`),x.appendChild(B);let oe=gt();x.appendChild(oe.root),e.textContent=``,e.appendChild(x);let se=null;for(let e of M)ce(e,b(e.from),b(e.to));{let e=N[0],t=b(e.slot),n=t.y+na/2,r=t.x+ta+3,i=_-14;e.line.setAttribute(`d`,`M ${r} ${n} L ${i-8} ${n}`),e.head.setAttribute(`d`,`M ${i} ${n} L ${i-9} ${n-5.5} L ${i-9} ${n+5.5} Z`)}function ce(e,t,n){if(t.y===n.y){let r=t.y+na/2,i=t.x+ta,a=n.x;e.line.setAttribute(`d`,`M ${i+3} ${r} L ${a-9} ${r}`),e.head.setAttribute(`d`,`M ${a} ${r} L ${a-9} ${r-5.5} L ${a-9} ${r+5.5} Z`);return}let r=t.x+ta,i=t.y+na/2,a=n.x,o=n.y+na/2,s=r+3,c=a-9,l=Math.max(26,(c-s)*.45);e.line.setAttribute(`d`,`M ${s} ${i} C ${s+l} ${i}, ${c-l} ${o}, ${c} ${o}`),e.head.setAttribute(`d`,`M ${a} ${o} L ${a-9} ${o-5.5} L ${a-9} ${o+5.5} Z`)}function V(e,t,n){let r=P[e];if(r.g.classList.toggle(`is-on`,n),!n)return;let i=e===`a`?t.fromA:t.fromB,s=(e===`a`?t.onA:t.onB)===`A`?a:o;if(i==null)return;let c=b(i),l=b(s[0]),u=c.x+ta/2,d=e===`a`?c.y+na:c.y,f=l.x+ta/2,p=e===`a`?l.y:l.y+na,m=la;r.line.setAttribute(`d`,`M ${u} ${d} L ${u} ${m} L ${f} ${m} L ${f} ${p}`);let h=p<m;r.head.setAttribute(`d`,h?`M ${f} ${p} L ${f-5.5} ${p+9} L ${f+5.5} ${p+9} Z`:`M ${f} ${p} L ${f-5.5} ${p-9} L ${f+5.5} ${p-9} Z`);let g=(u+f)/2;r.tagBg.setAttribute(`x`,g-76),r.tagBg.setAttribute(`y`,m-9),r.tag.setAttribute(`x`,g),r.tag.setAttribute(`y`,m),r.tag.textContent=e===`a`?`pA 走完 A → 换到 B 的头`:`pB 走完 B → 换到 A 的头`}function le(e,t){let n=t===`A`?e.onA:e.onB,r=t===`A`?e.iA:e.iB,i=n===`A`?a:o;if(r>=i.length){let e=n===`A`?aa:oa;return{x:_-ta/2,y:e,onNull:!0}}return{...b(i[r]),onNull:!1}}function ue(e,t){let n=(()=>{let e=t.onA===`A`?a:o;return t.iA>=e.length?null:e[t.iA]})(),r=(()=>{let e=t.onB===`A`?a:o;return t.iB>=e.length?null:e[t.iB]})();for(let[e,i]of j)i.classList.toggle(`is-cursor-a`,e===n),i.classList.toggle(`is-cursor-b`,e===r&&e!==n),i.classList.toggle(`is-meet`,t.meet!==null&&e===t.meet);if(t.answer!==null&&t.answer!==void 0){let e=b(t.answer);A.setAttribute(`x`,e.x-7),A.setAttribute(`y`,e.y-7),k.style.opacity=`1`}else k.style.opacity=`0`;if(t.answer!==null&&t.answer!==void 0&&l>0){let e=b(t.answer).x+ta/2;E.textContent=`公共段从这里开始（两条链共用这 ${l} 个节点）`,T.setAttribute(`x1`,e),T.setAttribute(`x2`,e),T.setAttribute(`y1`,55),T.setAttribute(`y2`,aa-12),w.style.opacity=`1`}else w.style.opacity=`0`;let s=le(t,`A`),c=le(t,`B`),u=n!==null&&n===r,d=s.onNull?aa:s.y,f=c.onNull?oa:c.y,p=d===oa?ca:sa,m=f===aa?sa:ca,h=u?p-14:p,g=u?m+14:m;I.setAttribute(`transform`,`translate(${s.x+ta/2} ${h})`),re.setAttribute(`transform`,`translate(${c.x+ta/2} ${g})`),I.style.opacity=`1`,re.style.opacity=`1`;let _=(e,t)=>{let n=e<t.y;return{x:t.x+ta/2,y1:n?e+da/2:e-da/2,y2:n?t.y-2:t.y+na+2}},v=_(h,s),y=_(g,c);L.setAttribute(`x1`,v.x),L.setAttribute(`x2`,v.x),L.setAttribute(`y1`,v.y1),L.setAttribute(`y2`,v.y2),ie.setAttribute(`x1`,y.x),ie.setAttribute(`x2`,y.x),ie.setAttribute(`y1`,y.y1),ie.setAttribute(`y2`,y.y2),V(`a`,t,t.phase===`jump`&&t.jumpsA),V(`b`,t,t.phase===`jump`&&t.jumpsB),ae.setAttribute(`class`,`ints-verdict`);let x=`准备开始`;t.phase===`found`?(ae.classList.add(`is-ok`),x=`✓ 相交于节点 ${i[t.meet]}`):t.phase===`none`?(ae.classList.add(`is-bad`),x=`✗ 两条链表不相交`):t.phase===`jump`?x=`换头中…`:t.phase===`walk`?x=`同步前进中…`:t.phase===`init`&&(x=`待判定`),z.textContent=x,X(B,t.desc)}let de=_t({steps:n,controls:oe,intervalMs:_a,onRender:ue});de.jumpTo(Math.trunc(t.initialStep)||0);let fe=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches;return r&&!fe&&typeof IntersectionObserver==`function`&&(se=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){se.disconnect(),se=null,de.play();return}},{threshold:.35}),se.observe(x)),{destroy(){se&&=(se.disconnect(),null),de.destroy(),e.textContent=``,delete e.dataset.intsMounted,document.getElementById(ea)?.remove()}}}var xa=[`innerHTML`],Sa=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,Ca=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,wa=`0.16.21`,Ta=`11.4.1`,Ea=y({__name:`MarkdownView`,props:{html:{type:String,default:``},title:{type:String,default:``}},setup(e){let t=e,n=w(null),r=v(()=>ct(st.sanitize(t.html,{ADD_ATTR:[`target`,`rel`],FORBID_TAGS:[`style`,`iframe`,`object`,`embed`,`form`],FORBID_ATTR:[`onerror`,`onload`,`onclick`]}),t.title));function i(e){e.classList.add(`copied`),e.innerHTML=Ca,setTimeout(()=>{e.classList.remove(`copied`),e.innerHTML=Sa},2e3)}function s(){n.value&&n.value.querySelectorAll(`table`).forEach(e=>{if(e.parentElement?.classList.contains(`table-scroll`))return;let t=document.createElement(`div`);t.className=`table-scroll`,e.parentNode.insertBefore(t,e),t.appendChild(e)})}function l(){n.value&&n.value.querySelectorAll(`pre`).forEach(e=>{if(e.parentElement?.classList.contains(`code-block-wrapper`))return;let t=document.createElement(`div`);t.className=`code-block-wrapper`,e.parentNode.insertBefore(t,e),t.appendChild(e);let n=document.createElement(`button`);n.className=`copy-btn`,n.title=`复制代码`,n.innerHTML=Sa,n.addEventListener(`click`,()=>{let t=(e.querySelector(`code`)||e).textContent||``;navigator.clipboard.writeText(t).then(()=>{i(n)}).catch(()=>{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),i(n)})}),t.appendChild(n)})}function u(e,t){return new Promise((n,r)=>{if(document.querySelector(`link[data-lib-href="${e}"]`))return n();let i=document.createElement(`link`);i.rel=`stylesheet`,i.href=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libHref=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load stylesheet `+e)),document.head.appendChild(i)})}function d(e,t){return new Promise((n,r)=>{if(document.querySelector(`script[data-lib-src="${e}"]`))return n();let i=document.createElement(`script`);i.src=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libSrc=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load script `+e)),document.head.appendChild(i)})}let f=null;async function m(){return f||=Promise.all([u(`https://cdn.jsdelivr.net/npm/katex@${wa}/dist/katex.min.css`,`sha384-zh0CIslj+VczCZtlzBcjt5ppRcsAmDnRem7ESsYwWwg3m/OaJ2l4x7YBZl9Kxxib`),d(`https://cdn.jsdelivr.net/npm/katex@${wa}/dist/katex.min.js`,`sha384-Rma6DA2IPUwhNxmrB/7S3Tno0YY7sFu9WSYMCuulLhIqYSGZ2gKCJWIqhBWqMQfh`)]).then(()=>window.katex),f}let h=null;async function g(){return h||=d(`https://cdn.jsdelivr.net/npm/mermaid@${Ta}/dist/mermaid.min.js`,`sha384-rbtjAdnIQE/aQJGEgXrVUlMibdfTSa4PQju4HDhN3sR2PmaKFzhEafuePsl9H/9I`).then(()=>window.mermaid),h}async function _(){if(!n.value)return;let e=n.value.querySelectorAll(`code.language-mermaid`);if(e.length)try{let t=await g();e.forEach(e=>{let n=e.closest(`pre`);if(!n||n.dataset.mermaidRendered)return;n.dataset.mermaidRendered=`1`;let r=document.createElement(`div`);r.className=`mermaid-container`,r.textContent=e.textContent,n.parentNode.replaceChild(r,n),t.run({nodes:[r]})})}catch(e){console.warn(`Mermaid failed to load/render:`,e?.message||e)}n.value.querySelectorAll(`img`).forEach(e=>{let t=e.getAttribute(`src`)||``;e.getAttribute(`alt`);let n=t.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([\w-]+)/);if(n){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://www.youtube.com/embed/${n[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}let r=t.match(/bilibili\.com\/video\/(BV[\w]+)/);if(r){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://player.bilibili.com/player.html?bvid=${r[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}});let t=/(\$\$[\s\S]+?\$\$|\$[^\s$](?:[^$]*[^\s$])?\$)/,r=document.createTreeWalker(n.value,NodeFilter.SHOW_TEXT),i=[],a;for(;a=r.nextNode();)!a.nodeValue||!t.test(a.nodeValue)||a.parentElement?.closest(`pre, code`)||i.push(a);if(i.length)try{let e=await m();for(let n of i){let r=document.createDocumentFragment();for(let i of n.nodeValue.split(t)){if(!i)continue;let t=i.startsWith(`$$`)&&i.endsWith(`$$`)&&i.length>3,n=!t&&i.startsWith(`$`)&&i.endsWith(`$`)&&i.length>2;if(!t&&!n){r.appendChild(document.createTextNode(i));continue}let a=i.slice(t?2:1,t?-2:-1),o=document.createElement(`span`);o.innerHTML=e.renderToString(a,{displayMode:t,throwOnError:!1}),r.appendChild(o)}n.parentNode.replaceChild(r,n)}}catch(e){console.warn(`KaTeX failed to load/render:`,e?.message||e)}}let y={"algo-viz--lc206":It,"algo-viz--lc21":nn,"algo-viz--lc23":Pn,"algo-viz--lc23dc":$n,"algo-viz--lc141":Er,"algo-viz--lc142":Br,"algo-viz--lc19":ai,"algo-viz--lc143":Ei,"algo-viz--lc234":Yi,"algo-viz--lc160":ba},b=[];function x(){b.forEach(e=>{try{e?.destroy?.()}catch(e){console.warn(`Algo viz teardown failed:`,e?.message||e)}}),b=[]}function T(){n.value&&(x(),n.value.querySelectorAll(`.algo-viz`).forEach(e=>{let t=Object.keys(y).find(t=>e.classList.contains(t));if(t)try{b.push(y[t](e))}catch(e){console.warn(`Algo viz failed to mount:`,t,e?.message||e)}}))}return a(()=>{o(()=>{T(),_(),s(),l()})}),C(x),p(()=>t.html,()=>{o(()=>{T(),_(),s(),l()})}),(e,t)=>(S(),c(`div`,{ref_key:`bodyRef`,ref:n,class:`markdown-body`,innerHTML:r.value},null,8,xa))}},[[`__scopeId`,`data-v-005843a1`]]);function Da(e){return T.get(`/articles/${e}/comments/`)}function Oa(e,t){return T.post(`/articles/${e}/comments/`,t)}var ka={key:0,class:`form-title`},Aa={key:1,class:`form-title`},ja={class:`form-field`},Ma={key:0,class:`field-error`},Na={class:`form-field`},Pa={key:0,class:`field-error`},Fa={class:`hp-field`,"aria-hidden":`true`},Ia={class:`form-field`},La={key:0,class:`field-error`},Ra={key:0,class:`submit-error`},za={key:1,class:`submit-success`},Ba={class:`form-actions`},Va=[`disabled`],Ha={key:0,class:`spinner`},Ua={key:1},Wa=y({__name:`CommentForm`,props:{articleSlug:{type:String,required:!0},parentId:{type:[Number,String],default:null}},emits:[`submitted`,`cancel`],setup(e,{emit:t}){let n=e,r=t,a=i({author_name:``,author_email:``,content:``,website:``}),o=i({author_name:``,author_email:``,content:``}),u=w(!1),d=w(null),p=w(!1);function m(){let e=!0;return o.author_name=``,o.author_email=``,o.content=``,a.author_name.trim()||(o.author_name=`请输入昵称`,e=!1),a.author_email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.author_email)||(o.author_email=`邮箱格式不正确`,e=!1):(o.author_email=`请输入邮箱`,e=!1),a.content.trim()?a.content.trim().length<3&&(o.content=`评论内容至少3个字符`,e=!1):(o.content=`请输入评论内容`,e=!1),e}function g(e){o[e]&&(o[e]=``),d.value=null}async function _(){if(m()){u.value=!0,d.value=null;try{let e={author_name:a.author_name.trim(),author_email:a.author_email.trim(),content:a.content.trim(),website:a.website};n.parentId&&(e.parent=n.parentId),await Oa(n.articleSlug,e),p.value=!0,setTimeout(()=>{p.value=!1},3e3),r(`submitted`),a.author_name=``,a.author_email=``,a.content=``}catch(e){let t=e?.response?.data;if(typeof t==`object`&&t){let e=t;e.author_name&&(o.author_name=Array.isArray(e.author_name)?e.author_name[0]:e.author_name),e.author_email&&(o.author_email=Array.isArray(e.author_email)?e.author_email[0]:e.author_email),e.content&&(o.content=Array.isArray(e.content)?e.content[0]:e.content),e.detail&&(d.value=e.detail),e.non_field_errors&&(d.value=Array.isArray(e.non_field_errors)?e.non_field_errors[0]:e.non_field_errors)}else typeof t==`string`?d.value=t:d.value=e.message||`提交失败，请稍后重试`}finally{u.value=!1}}}return(t,n)=>(S(),c(`div`,{class:h([`comment-form`,{"reply-form":!!e.parentId}])},[e.parentId?(S(),c(`h4`,ka,`回复评论`)):(S(),c(`h4`,Aa,`发表评论`)),s(`form`,{onSubmit:k(_,[`prevent`]),class:`form-body`},[s(`div`,ja,[f(s(`input`,{"onUpdate:modelValue":n[0]||=e=>a.author_name=e,type:`text`,placeholder:`昵称 *`,class:h([`form-input`,{"input-error":o.author_name}]),onInput:n[1]||=e=>g(`author_name`)},null,34),[[O,a.author_name]]),o.author_name?(S(),c(`p`,Ma,l(o.author_name),1)):b(``,!0)]),s(`div`,Na,[f(s(`input`,{"onUpdate:modelValue":n[2]||=e=>a.author_email=e,type:`email`,placeholder:`邮箱 *`,class:h([`form-input`,{"input-error":o.author_email}]),onInput:n[3]||=e=>g(`author_email`)},null,34),[[O,a.author_email]]),o.author_email?(S(),c(`p`,Pa,l(o.author_email),1)):b(``,!0)]),s(`div`,Fa,[f(s(`input`,{"onUpdate:modelValue":n[4]||=e=>a.website=e,type:`text`,tabindex:`-1`,autocomplete:`off`},null,512),[[O,a.website]])]),s(`div`,Ia,[f(s(`textarea`,{"onUpdate:modelValue":n[5]||=e=>a.content=e,placeholder:`说点什么...`,rows:`4`,class:h([`form-textarea`,{"input-error":o.content}]),onInput:n[6]||=e=>g(`content`)},null,34),[[O,a.content]]),o.content?(S(),c(`p`,La,l(o.content),1)):b(``,!0)]),d.value?(S(),c(`p`,Ra,l(d.value),1)):b(``,!0),p.value?(S(),c(`p`,za,`评论已提交！`)):b(``,!0),s(`div`,Ba,[e.parentId?(S(),c(`button`,{key:0,type:`button`,class:`cancel-btn`,onClick:n[7]||=e=>t.$emit(`cancel`)},` 取消回复 `)):b(``,!0),s(`button`,{type:`submit`,class:`submit-btn`,disabled:u.value},[u.value?(S(),c(`span`,Ha)):(S(),c(`span`,Ua,`提交`))],8,Va)])],32)],2))}},[[`__scopeId`,`data-v-49410be9`]]),Ga={class:`comment-list`},Ka={class:`comments-title`},qa={key:0,class:`comments-count`},Ja={key:0,class:`skeleton-comments`},Ya={key:1,class:`empty-comments`},Xa={key:2,class:`comments-tree`},Za={class:`comment-main`},Qa={class:`comment-content`},$a={class:`comment-header`},eo={class:`comment-author`},to={class:`comment-time`},no={class:`comment-text`},ro=[`onClick`],io={key:1,class:`replies`},ao={class:`comment-main`},oo={class:`comment-content`},so={class:`comment-header`},co={class:`comment-author`},lo={class:`comment-time`},uo={class:`comment-text`},fo=y({__name:`CommentList`,props:{articleSlug:{type:String,required:!0}},setup(e){let t=e,n=w([]),i=w(!0),o=w(null),u=v(()=>n.value.filter(e=>!e.parent));function f(e){o.value=o.value===e?null:e}async function p(){i.value=!0;try{let e=await Da(t.articleSlug);n.value=e.data.results||e.data||[]}catch{n.value=[]}finally{i.value=!1}}function h(){o.value=null,p()}function y(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<1?`刚刚`:n<60?`${n}分钟前`:r<24?`${r}小时前`:i<30?`${i}天前`:i<365?`${Math.floor(i/30)}个月前`:`${Math.floor(i/365)}年前`}function C(e){let t=[`#3f6b57`,`#a45f45`,`#8a6c3f`,`#637b68`,`#7b6757`,`#4f7477`,`#8a635f`,`#6b7250`,`#536b5d`,`#9b704e`,`#65706a`,`#7b6a83`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}return a(p),(t,a)=>(S(),c(`div`,Ga,[s(`h3`,Ka,[a[1]||=g(` 评论 `,-1),n.value.length?(S(),c(`span`,qa,`(`+l(n.value.length)+`)`,1)):b(``,!0)]),i.value?(S(),c(`div`,Ja,[(S(),c(d,null,r(3,e=>s(`div`,{key:e,class:`skeleton-comment`},[...a[2]||=[_(`<div class="skeleton-avatar" data-v-98dfce57></div><div class="skeleton-body" data-v-98dfce57><div class="skeleton-line w-30" data-v-98dfce57></div><div class="skeleton-line w-50" data-v-98dfce57></div><div class="skeleton-line w-80" data-v-98dfce57></div></div>`,2)]])),64))])):u.value.length?(S(),c(`div`,Xa,[(S(!0),c(d,null,r(u.value,t=>(S(),c(`div`,{key:t.id,class:`comment-item`},[s(`div`,Za,[s(`div`,{class:`comment-avatar`,style:x({background:C(t.author_name)})},l(t.author_name?t.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,Qa,[s(`div`,$a,[s(`span`,eo,l(t.author_name),1),s(`span`,to,l(y(t.created_at)),1)]),s(`p`,no,l(t.content),1),s(`button`,{class:`reply-btn`,onClick:e=>f(t.id)},[...a[4]||=[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 17 4 12 9 7`}),s(`path`,{d:`M20 18v-2a4 4 0 0 0-4-4H4`})],-1),g(` 回复 `,-1)]],8,ro)])]),o.value===t.id?(S(),m(Wa,{key:0,"article-slug":e.articleSlug,"parent-id":t.id,onSubmitted:h,onCancel:a[0]||=e=>o.value=null,class:`reply-form-wrapper`},null,8,[`article-slug`,`parent-id`])):b(``,!0),t.replies&&t.replies.length?(S(),c(`div`,io,[(S(!0),c(d,null,r(t.replies,e=>(S(),c(`div`,{key:e.id,class:`comment-item reply-item`},[s(`div`,ao,[s(`div`,{class:`comment-avatar comment-avatar-sm`,style:x({background:C(e.author_name)})},l(e.author_name?e.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,oo,[s(`div`,so,[s(`span`,co,l(e.author_name),1),s(`span`,lo,l(y(e.created_at)),1)]),s(`p`,uo,l(e.content),1)])])]))),128))])):b(``,!0)]))),128))])):(S(),c(`div`,Ya,[...a[3]||=[s(`svg`,{width:`40`,height:`40`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z`})],-1),s(`p`,null,`暂无评论，来说点什么吧`,-1)]]))]))}},[[`__scopeId`,`data-v-98dfce57`]]),po={key:0,class:`toc-list-wrapper`},mo={class:`toc-list`},ho=[`href`,`title`,`onClick`],go={class:`toc-text`},_o={key:1,class:`toc-empty-state`},vo=y({__name:`TocNav`,props:{html:{type:String,default:``}},setup(e){let t=e,n=w([]),i=w(null),u=null,f=[];function m(){if(!t.html){n.value=[];return}try{let e=new DOMParser().parseFromString(t.html,`text/html`),r=[];e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let n=e.id||`toc-heading-${t}`;r.push({id:n,tag:e.tagName.toLowerCase(),text:e.textContent||``})}),n.value=r}catch{n.value=[]}}function g(){if(!n.value.length)return;let e=document.querySelector(`.markdown-body`);e&&e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let r=n.value[t];r&&!e.id&&(e.id=r.id)})}function _(){u&&=(u.disconnect(),null),f=[],n.value.length&&(u=new IntersectionObserver(e=>{let t=e.filter(e=>e.isIntersecting);t.length?i.value=t[0].target.id:window.scrollY<100&&(i.value=n.value[0]?.id||null)},{rootMargin:`-80px 0px -60% 0px`,threshold:0}),o(()=>{n.value.forEach(e=>{let t=document.getElementById(e.id);t&&(u.observe(t),f.push(t))})}))}function v(e){let t=document.getElementById(e);t&&(t.scrollIntoView({behavior:`smooth`,block:`start`}),i.value=e)}return p(()=>t.html,()=>{m(),o(()=>{g(),_()})}),a(()=>{m(),o(()=>{g(),_()})}),C(()=>{u&&u.disconnect()}),(e,t)=>(S(),c(`nav`,{class:h([`toc-nav`,{"toc-empty":!n.value.length}])},[t[2]||=s(`h4`,{class:`toc-title`},`目录`,-1),n.value.length?(S(),c(`div`,po,[s(`ul`,mo,[(S(!0),c(d,null,r(n.value,e=>(S(),c(`li`,{key:e.id,class:h([`toc-item`,[`toc-depth-${e.tag}`,{"toc-active":i.value===e.id}]])},[s(`a`,{href:`#`+e.id,class:`toc-link`,title:e.text,onClick:k(t=>v(e.id),[`prevent`])},[t[0]||=s(`span`,{class:`toc-dot`},null,-1),s(`span`,go,l(e.text),1)],8,ho)],2))),128))])])):(S(),c(`div`,_o,[...t[1]||=[s(`p`,null,`无目录`,-1)]]))],2))}},[[`__scopeId`,`data-v-21d21cb1`]]),yo={class:`share-buttons`},bo={key:0,class:`copy-feedback`},xo=y({__name:`ShareButtons`,props:{title:{type:String,default:``},url:{type:String,default:``}},setup(e){let t=e,n=w(!1);function r(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://service.weibo.com/share/share.php?url=${e}&title=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function i(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://twitter.com/intent/tweet?url=${e}&text=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function a(){alert(`请复制链接后在微信中粘贴发送`)}async function o(){try{await navigator.clipboard.writeText(t.url||window.location.href),n.value=!0,setTimeout(()=>n.value=!1,2e3)}catch{let e=document.createElement(`textarea`);e.value=t.url||window.location.href,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),n.value=!0,setTimeout(()=>n.value=!1,2e3)}}return(e,t)=>(S(),c(`div`,yo,[t[4]||=s(`span`,{class:`share-label`},`分享：`,-1),s(`button`,{class:`share-btn wechat`,title:`微信`,onClick:a},[...t[0]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178A1.17 1.17 0 0 1 4.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178 1.17 1.17 0 0 1-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229.826 0 1.622-.12 2.361-.336a.722.722 0 0 1 .598.082l1.584.926a.272.272 0 0 0 .14.045c.136 0 .241-.11.241-.245 0-.06-.024-.12-.04-.178l-.325-1.233a.49.49 0 0 1 .178-.554C23.028 18.48 24 16.82 24 14.98c0-3.21-2.931-5.952-7.062-6.122zm-2.18 2.769c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982zm4.844 0c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982z`})],-1)]]),s(`button`,{class:`share-btn weibo`,title:`微博`,onClick:r},[...t[1]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M10.098 20.323c-3.977.391-7.414-1.406-7.672-4.02-.259-2.609 2.759-5.047 6.74-5.441 3.979-.394 7.413 1.404 7.671 4.018.259 2.6-2.759 5.049-6.739 5.443zm-7.317-6.781c-1.059-.2-1.911.419-1.903 1.383.008.964.87 1.907 1.93 2.107 1.058.2 1.91-.419 1.903-1.383-.008-.964-.87-1.907-1.93-2.107zm2.13 3.68c-.563-.249-.754-.766-.428-1.153.326-.388 1.019-.523 1.58-.275.56.248.753.764.429 1.153-.326.386-1.018.524-1.581.275zm.992-3.808c-2.07-.028-4.538.537-7.344 2.641C-.405 17.1-.279 19.15.35 20.49c.528 1.123 1.494 1.773 2.43 2.144 4.878 1.935 10.857.606 13.679-1.35 2.934-2.035 4.033-4.771 3.157-7.165-.516-1.405-1.797-2.398-3.31-2.882l.06-.05c2.485-2.08 4.213-4.585 4.213-7.146 0-5.213-7.11-7.735-10.966-5.371-1.742 1.07-2.772 2.788-3.064 4.72.422-.12.865-.197 1.323-.23 3.271-.241 7.273.776 7.273 3.86 0 3.502-3.823 4.667-6.721 4.667-.89 0-1.785-.215-2.595-.598z`})],-1)]]),s(`button`,{class:`share-btn twitter`,title:`Twitter`,onClick:i},[...t[2]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z`})],-1)]]),s(`button`,{class:`share-btn copy`,title:`复制链接`,onClick:o},[...t[3]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71`}),s(`path`,{d:`M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71`})],-1)]]),n.value?(S(),c(`span`,bo,`已复制`)):b(``,!0)]))}},[[`__scopeId`,`data-v-857c6fb5`]]),So={key:0,class:`related-section`},Co={class:`related-grid`},wo={key:0,class:`related-cover`},To=[`src`,`alt`],Eo={class:`related-card-title`},Do=y({__name:`RelatedArticles`,props:{articles:{type:Array,default:()=>[]}},setup(t){return(i,a)=>{let o=n(`router-link`);return t.articles.length?(S(),c(`section`,So,[a[0]||=s(`h3`,{class:`related-title`},`相关文章`,-1),s(`div`,Co,[(S(!0),c(d,null,r(t.articles,t=>(S(),m(o,{key:t.slug,to:`/article/`+t.slug,class:`related-card`},{default:e(()=>[t.cover_image?(S(),c(`div`,wo,[s(`img`,{src:t.cover_image,alt:t.title,loading:`lazy`},null,8,To)])):b(``,!0),s(`span`,Eo,l(t.title),1)]),_:2},1032,[`to`]))),128))])])):b(``,!0)}}},[[`__scopeId`,`data-v-e3d8298c`]]),Oo={class:`newsletter glass-card`},ko=[`disabled`],Ao=[`disabled`],jo={key:0},Mo={key:1},No={key:2},Po=y({__name:`NewsletterForm`,setup(e){let t=w(``),n=w(!1),r=w(!1),i=w(``),a=w(``);async function o(){if(t.value.trim()){n.value=!0,i.value=``;try{let e=await T.post(`/subscribe/`,{email:t.value.trim()});r.value=!0,i.value=e.data.detail||`订阅成功！`,a.value=`msg-success`}catch(e){let t=e?.response?.data?.error||e?.response?.data?.detail||`订阅失败`;i.value=typeof t==`string`?t:`订阅失败，请稍后重试`,a.value=`msg-error`}finally{n.value=!1}}}return(e,u)=>(S(),c(`div`,Oo,[u[1]||=_(`<h4 class="newsletter-title" data-v-54a32a66><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-54a32a66><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" data-v-54a32a66></path><polyline points="22,6 12,13 2,6" data-v-54a32a66></polyline></svg> 订阅更新 </h4><p class="newsletter-desc" data-v-54a32a66>新文章发布时，通过邮件通知你</p>`,2),s(`form`,{onSubmit:k(o,[`prevent`]),class:`newsletter-form`},[f(s(`input`,{"onUpdate:modelValue":u[0]||=e=>t.value=e,type:`email`,placeholder:`your@email.com`,class:`newsletter-input`,disabled:r.value,required:``},null,8,ko),[[O,t.value]]),s(`button`,{type:`submit`,class:`newsletter-btn`,disabled:n.value||r.value},[n.value?(S(),c(`span`,jo,`...`)):r.value?(S(),c(`span`,Mo,`✓`)):(S(),c(`span`,No,`订阅`))],8,Ao)],32),i.value?(S(),c(`p`,{key:0,class:h(a.value)},l(i.value),3)):b(``,!0)]))}},[[`__scopeId`,`data-v-54a32a66`]]),Fo=`个人博客Blog`,Io=`Zhou Jun 的个人博客 — 技术、编程、AI 与科学`;function Lo(e={}){let{title:t=Fo,description:n=Io,image:r=``,url:i=window.location.href}=e,a=t===`个人博客Blog`?t:`${t} | ${Fo}`;document.title=a;let o=(e,t,n=!1)=>{if(!t)return;let r=n?`name`:`property`,i=document.querySelector(`meta[${r}="${e}"]`);i||(i=document.createElement(`meta`),i.setAttribute(r,e),document.head.appendChild(i)),i.setAttribute(`content`,t)};o(`description`,n,!0),o(`og:title`,a),o(`og:description`,n),o(`og:image`,r),o(`og:url`,i),o(`og:type`,`article`),o(`twitter:card`,r?`summary_large_image`:`summary`),o(`twitter:title`,a),o(`twitter:description`,n),o(`twitter:image`,r),((e,t)=>{if(!t)return;let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement(`link`),n.setAttribute(`rel`,e),document.head.appendChild(n)),n.setAttribute(`href`,t)})(`canonical`,i)}var Ro={title:Fo,description:Io,image:``,url:``};function zo(){Lo({...Ro,url:window.location.origin+`/`});let e=document.querySelector(`meta[property="og:type"]`);e&&e.setAttribute(`content`,`website`);let t=document.querySelector(`link[rel="canonical"]`);t&&t.setAttribute(`href`,window.location.origin+`/`)}function Bo(e){if(!e)return 1;let t=(e.match(/[一-鿿㐀-䶿]/g)||[]).length+(e.match(/[a-zA-Z]+/g)||[]).length;return Math.max(1,Math.ceil(t/250))}function Vo(e){return e?e.replace(/```[\s\S]*?```/g,``).replace(/`[^`]*`/g,``).replace(/!\[.*?\]\(.*?\)/g,``).replace(/\[([^\]]*)\]\(.*?\)/g,`$1`).replace(/[#*>`~\-+|_:]/g,` `).replace(/\s+/g,` `).trim():``}var Ho={class:`page page-article-detail`},Uo={key:0,class:`detail-skeleton`},Wo={key:1,class:`error-state`},Go={key:2,class:`detail-layout`},Ko={class:`detail-main`},qo={class:`article-header`},Jo={class:`article-title`},Yo={class:`article-meta`},Xo={class:`meta-item meta-author`},Zo={class:`meta-item meta-date`},Qo={key:0,class:`meta-item meta-category neon-text-pink`},$o={class:`meta-item meta-reading-time`},es={class:`meta-item meta-views`},ts={key:0,class:`article-tags`},ns={key:0,class:`article-cover`},rs=[`src`,`alt`],is={key:1,class:`article-nav`},as={class:`nav-title`},os={class:`nav-title`},ss={class:`article-actions`},cs=[`disabled`],ls={class:`comment-section`},us={class:`detail-sidebar`},ds=y({__name:`ArticleDetail`,setup(i){let o=E();D();let f=te(),y=w(null),x=w(!0),C=w(null),O=w(null),k=w(0),M=0,N=v(()=>y.value?.created_at?new Date(y.value.created_at).toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}):``),P=v(()=>ee(y.value?.author)),ne=v(()=>j(y.value?.category)),F=v(()=>{let e=y.value?.tags;return!e||!Array.isArray(e)?[]:e.map(A).filter(Boolean)}),I=w(!1),re=w(!1),L=v(()=>window.location.origin+o.fullPath),ie=v(()=>y.value?y.value.reading_time?y.value.reading_time:Bo(Vo(y.value.content||``)):1),ae=v(()=>y.value?JSON.stringify({"@context":`https://schema.org`,"@type":`Article`,headline:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||void 0,datePublished:y.value.created_at,dateModified:y.value.updated_at,author:{"@type":`Person`,name:`Zhou Jun`},publisher:{"@type":`Person`,name:`Zhou Jun`}}):``),R=null;p(ae,e=>{if(!e){R?.remove(),R=null;return}R||(R=document.createElement(`script`),R.type=`application/ld+json`,R.dataset.articleJsonLd=`1`,document.head.appendChild(R)),R.textContent=e},{immediate:!0});async function z(){if(!(I.value||re.value)){re.value=!0;try{let e=await T.post(`/articles/${y.value.slug}/like/`);y.value&&(y.value.likes_count=e.data.likes_count),I.value=!0}catch{}finally{re.value=!1}}}async function B(){let e=o.params.slug,t=++M;if(!e){C.value=`缺少文章标识`,O.value=null,x.value=!1;return}x.value=!0,C.value=null,O.value=null,y.value=null,I.value=!1;try{let n=f.getArticleBySlug(e);if(n){if(t!==M)return;y.value=n,x.value=!1,oe();return}let r=await f.fetchArticleBySlug(e);if(t!==M)return;y.value=r,y.value?oe():C.value=`文章不存在`}catch(e){if(t!==M)return;O.value=e?.response?.status??null,O.value===404?C.value=`文章不存在`:C.value=e?.response?.data?.detail||e.message||`加载文章失败`}finally{t===M&&(x.value=!1)}}function oe(){y.value&&Lo({title:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||``,url:window.location.origin+o.fullPath})}return a(B),p(()=>o.params.slug,()=>{window.scrollTo({top:0,behavior:`instant`}),k.value++,B()}),t(()=>{zo(),R?.remove(),R=null}),(t,i)=>{let a=n(`router-link`);return S(),c(`div`,Ho,[x.value?(S(),c(`div`,Uo,[...i[1]||=[_(`<div class="skeleton-header" data-v-c0862088><div class="skeleton-line w-80 skeleton-lg" data-v-c0862088></div><div class="skeleton-meta-row" data-v-c0862088><div class="skeleton-line w-20" data-v-c0862088></div><div class="skeleton-line w-15" data-v-c0862088></div><div class="skeleton-line w-10" data-v-c0862088></div></div></div><div class="skeleton-body" data-v-c0862088><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-90" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-70" data-v-c0862088></div></div>`,2)]])):C.value?(S(),c(`div`,Wo,[i[3]||=s(`svg`,{width:`48`,height:`48`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`line`,{x1:`12`,y1:`8`,x2:`12`,y2:`12`}),s(`line`,{x1:`12`,y1:`16`,x2:`12.01`,y2:`16`})],-1),s(`h2`,null,l(O.value===404?`文章不存在`:`加载失败`),1),s(`p`,null,l(C.value),1),u(a,{to:`/articles`,class:`back-link`},{default:e(()=>[...i[2]||=[g(`返回首页`,-1)]]),_:1})])):y.value?(S(),c(`div`,Go,[s(`article`,Ko,[s(`header`,qo,[s(`h1`,Jo,l(y.value.title),1),s(`div`,Yo,[s(`span`,Xo,[i[4]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2`}),s(`circle`,{cx:`12`,cy:`7`,r:`4`})],-1),g(` `+l(P.value),1)]),s(`span`,Zo,[i[5]||=_(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-c0862088><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-c0862088></rect><line x1="16" y1="2" x2="16" y2="6" data-v-c0862088></line><line x1="8" y1="2" x2="8" y2="6" data-v-c0862088></line><line x1="3" y1="10" x2="21" y2="10" data-v-c0862088></line></svg>`,1),g(` `+l(N.value),1)]),y.value.category?(S(),c(`span`,Qo,[i[6]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z`})],-1),g(` `+l(ne.value),1)])):b(``,!0),s(`span`,$o,[i[7]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`polyline`,{points:`12 6 12 12 16 14`})],-1),g(` 约 `+l(ie.value)+` 分钟 `,1)]),s(`span`,es,[i[8]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z`}),s(`circle`,{cx:`12`,cy:`12`,r:`3`})],-1),g(` `+l(y.value.views_count||0),1)])]),F.value.length?(S(),c(`div`,ts,[(S(!0),c(d,null,r(F.value,(e,t)=>(S(),c(`span`,{key:t,class:`tag-pill`},l(e),1))),128))])):b(``,!0)]),y.value.cover_image?(S(),c(`div`,ns,[s(`img`,{src:y.value.cover_image,alt:y.value.title},null,8,rs)])):b(``,!0),u(Ea,{html:y.value.html_content||y.value.content||``,title:y.value.title},null,8,[`html`,`title`]),y.value.prev_article||y.value.next_article?(S(),c(`nav`,is,[y.value.prev_article?(S(),m(a,{key:0,to:`/article/`+(y.value.prev_article.slug||y.value.prev_article),class:`nav-link prev-link`},{default:e(()=>[i[9]||=s(`span`,{class:`nav-direction`},[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`15 18 9 12 15 6`})]),g(` 上一篇 `)],-1),s(`span`,as,l(y.value.prev_article.title||y.value.prev_article),1)]),_:1},8,[`to`])):b(``,!0),y.value.next_article?(S(),m(a,{key:1,to:`/article/`+(y.value.next_article.slug||y.value.next_article),class:`nav-link next-link`},{default:e(()=>[i[10]||=s(`span`,{class:`nav-direction`},[g(` 下一篇 `),s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 18 15 12 9 6`})])],-1),s(`span`,os,l(y.value.next_article.title||y.value.next_article),1)]),_:1},8,[`to`])):b(``,!0)])):b(``,!0),s(`div`,ss,[u(xo,{title:y.value.title,url:L.value},null,8,[`title`,`url`]),s(`button`,{class:h([`like-btn`,{liked:I.value}]),disabled:re.value,onClick:z},[i[11]||=s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z`})],-1),s(`span`,null,l(y.value.likes_count||0),1)],10,cs)]),u(Do,{articles:y.value.related_articles||[]},null,8,[`articles`]),u(Po),s(`section`,ls,[(S(),m(fo,{"article-slug":y.value.slug,key:k.value},null,8,[`article-slug`])),u(Wa,{"article-slug":y.value.slug,onSubmitted:i[0]||=e=>k.value++},null,8,[`article-slug`])])]),s(`aside`,us,[u(vo,{html:y.value.html_content||y.value.content||``},null,8,[`html`])])])):b(``,!0)])}}},[[`__scopeId`,`data-v-c0862088`]]);export{ds as default};