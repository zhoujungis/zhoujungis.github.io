import{A as e,C as t,D as n,E as r,R as i,S as a,b as o,c as s,d as c,dt as l,h as u,i as d,j as f,k as p,l as m,lt as h,m as g,p as _,s as v,t as y,u as b,ut as x,w as S,x as C,z as w}from"./_plugin-vue_export-helper-BK47PYcU.js";import{t as T}from"./client-DyaaoQco.js";import{f as E,p as D,v as O,y as k}from"./index-CjAcrf9Y.js";import{i as A,n as j,t as M}from"./labels-H7OcNmBE.js";import{t as N}from"./article-Dfb0uW4y.js";function P(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function F(e){if(Array.isArray(e))return e}function I(e,t){var n=e==null?null:typeof Symbol<`u`&&e[Symbol.iterator]||e[`@@iterator`];if(n!=null){var r,i,a,o,s=[],c=!0,l=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(c=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);c=!0);}catch(e){l=!0,i=e}finally{try{if(!c&&n.return!=null&&(o=n.return(),Object(o)!==o))return}finally{if(l)throw i}}return s}}function L(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function R(e,t){return F(e)||I(e,t)||z(e,t)||L()}function z(e,t){if(e){if(typeof e==`string`)return P(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?P(e,t):void 0}}var B=Object.entries,V=Object.setPrototypeOf,H=Object.isFrozen,ee=Object.getPrototypeOf,te=Object.getOwnPropertyDescriptor,U=Object.freeze,W=Object.seal,G=Object.create,ne=typeof Reflect<`u`&&Reflect,re=ne.apply,K=ne.construct;U||=function(e){return e},W||=function(e){return e},re||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},K||=function(e){return new e(...[...arguments].slice(1))};var ie=Y(Array.prototype.forEach),ae=Y(Array.prototype.lastIndexOf),oe=Y(Array.prototype.pop),se=Y(Array.prototype.push),ce=Y(Array.prototype.splice),le=Array.isArray,ue=Y(String.prototype.toLowerCase),de=Y(String.prototype.toString),fe=Y(String.prototype.match),pe=Y(String.prototype.replace),me=Y(String.prototype.indexOf),he=Y(String.prototype.trim),ge=Y(Number.prototype.toString),q=Y(Boolean.prototype.toString),_e=typeof BigInt>`u`?null:Y(BigInt.prototype.toString),J=typeof Symbol>`u`?null:Y(Symbol.prototype.toString),ve=Y(Object.prototype.hasOwnProperty),ye=Y(Object.prototype.toString),be=Y(RegExp.prototype.test),xe=Se(TypeError);function Y(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return re(e,t,n)}}function Se(e){return function(){return K(e,[...arguments])}}function X(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:ue;if(V&&V(e,null),!le(t))return e;let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(H(t)||(t[r]=e),i=e)}e[i]=!0}return e}function Ce(e){for(let t=0;t<e.length;t++)ve(e,t)||(e[t]=null);return e}function we(e){let t=G(null);for(let r of B(e)){var n=R(r,2);let i=n[0],a=n[1];ve(e,i)&&(le(a)?t[i]=Ce(a):a&&typeof a==`object`&&a.constructor===Object?t[i]=we(a):t[i]=a)}return t}function Te(e){switch(typeof e){case`string`:return e;case`number`:return ge(e);case`boolean`:return q(e);case`bigint`:return _e?_e(e):`0`;case`symbol`:return J?J(e):`Symbol()`;case`undefined`:return ye(e);case`function`:case`object`:{if(e===null)return ye(e);let t=e,n=Ee(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:ye(e)}return ye(e)}default:return ye(e)}}function Ee(e,t){for(;e!==null;){let n=te(e,t);if(n){if(n.get)return Y(n.get);if(typeof n.value==`function`)return Y(n.value)}e=ee(e)}function n(){return null}return n}function De(e){try{return be(e,``),!0}catch{return!1}}var Oe=U(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),ke=U(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),Ae=U([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),je=U([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),Me=U(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),Ne=U([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),Pe=U([`#text`]),Fe=U(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),Ie=U(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dominant-baseline.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-orientation.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),Le=U(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),Re=U([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),ze=W(/{{[\w\W]*|^[\w\W]*}}/g),Be=W(/<%[\w\W]*|^[\w\W]*%>/g),Ve=W(/\${[\w\W]*/g),He=W(/^data-[\-\w.\u00B7-\uFFFF]+$/),Ue=W(/^aria-[\-\w]+$/),We=W(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ge=W(/^(?:\w+script|data):/i),Ke=W(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),qe=W(/^html$/i),Je=W(/^[a-z][.\w]*(-[.\w]+)+$/i),Ye=W(/<[/\w!]/g),Xe=W(/<[/\w]/g),Ze=W(/<\/no(script|embed|frames)/i),Qe=W(/\/>/i),$e={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},et=function(){return typeof window>`u`?null:window},tt=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},nt=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},rt=function(e,t,n,r){return ve(e,t)&&le(e[t])?X(r.base?we(r.base):{},e[t],r.transform):n};function it(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:et(),t=e=>it(e);if(t.version=`3.4.12`,t.removed=[],!e||!e.document||e.document.nodeType!==$e.document||!e.Element)return t.isSupported=!1,t;let n=e.document,r=n,i=r.currentScript;e.DocumentFragment;let a=e.HTMLTemplateElement,o=e.Node,s=e.Element,c=e.NodeFilter;e.NamedNodeMap===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;let l=e.DOMParser,u=e.trustedTypes,d=s.prototype,f=Ee(d,`cloneNode`),p=Ee(d,`remove`),m=Ee(d,`nextSibling`),h=Ee(d,`childNodes`),g=Ee(d,`parentNode`),_=Ee(d,`shadowRoot`),v=Ee(d,`attributes`),y=o&&o.prototype?Ee(o.prototype,`nodeType`):null,b=o&&o.prototype?Ee(o.prototype,`nodeName`):null;if(typeof a==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let x,S=``,C,w=!1,T=0,E=function(){if(T>0)throw xe(`A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.`)},D=function(e){E(),T++;try{return x.createHTML(e)}finally{T--}},O=function(e){E(),T++;try{return x.createScriptURL(e)}finally{T--}},k=function(){return w||=(C=tt(u,i),!0),C},A=n,j=A.implementation,M=A.createNodeIterator,N=A.createDocumentFragment,P=A.getElementsByTagName,F=r.importNode,I=nt();t.isSupported=typeof B==`function`&&typeof g==`function`&&j&&j.createHTMLDocument!==void 0;let L=ze,R=Be,z=Ve,V=He,H=Ue,ee=Ge,te=Ke,ne=Je,re=We,K=null,ge=X({},[...Oe,...ke,...Ae,...Me,...Pe]),q=null,_e=X({},[...Fe,...Ie,...Le,...Re]),J=Object.seal(G(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ye=null,Y=null,Se=Object.seal(G(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),Ce=!0,at=!0,ot=!1,st=!0,ct=!1,lt=!0,Z=!1,ut=!1,dt=null,ft=null,pt=!1,mt=!1,Q=!1,ht=!1,gt=!0,_t=!1,vt=`user-content-`,yt=!0,bt=!1,xt={},St=null,Ct=X({},`annotation-xml.audio.colgroup.desc.foreignobject.head.iframe.math.mi.mn.mo.ms.mtext.noembed.noframes.noscript.plaintext.script.selectedcontent.style.svg.template.thead.title.video.xmp`.split(`.`)),wt=null,Tt=X({},[`audio`,`video`,`img`,`source`,`image`,`track`]),Et=null,Dt=X({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),Ot=`http://www.w3.org/1998/Math/MathML`,kt=`http://www.w3.org/2000/svg`,At=`http://www.w3.org/1999/xhtml`,jt=At,Mt=!1,Nt=null,Pt=X({},[Ot,kt,At],de),Ft=U([`mi`,`mo`,`mn`,`ms`,`mtext`]),It=X({},Ft),Lt=U([`annotation-xml`]),Rt=X({},Lt),zt=X({},[`title`,`style`,`font`,`a`,`script`]),Bt=null,Vt=[`application/xhtml+xml`,`text/html`],$=null,Ht=null,Ut=n.createElement(`form`),Wt=function(e){return e instanceof RegExp||e instanceof Function},Gt=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ht&&Ht===e)return;(!e||typeof e!=`object`)&&(e={}),e=we(e),Bt=Vt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,$=Bt===`application/xhtml+xml`?de:ue,K=rt(e,`ALLOWED_TAGS`,ge,{transform:$}),q=rt(e,`ALLOWED_ATTR`,_e,{transform:$}),Nt=rt(e,`ALLOWED_NAMESPACES`,Pt,{transform:de}),Et=rt(e,`ADD_URI_SAFE_ATTR`,Dt,{transform:$,base:Dt}),wt=rt(e,`ADD_DATA_URI_TAGS`,Tt,{transform:$,base:Tt}),St=rt(e,`FORBID_CONTENTS`,Ct,{transform:$}),ye=rt(e,`FORBID_TAGS`,we({}),{transform:$}),Y=rt(e,`FORBID_ATTR`,we({}),{transform:$}),xt=ve(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?we(e.USE_PROFILES):e.USE_PROFILES:!1,Ce=e.ALLOW_ARIA_ATTR!==!1,at=e.ALLOW_DATA_ATTR!==!1,ot=e.ALLOW_UNKNOWN_PROTOCOLS||!1,st=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ct=e.SAFE_FOR_TEMPLATES||!1,lt=e.SAFE_FOR_XML!==!1,Z=e.WHOLE_DOCUMENT||!1,mt=e.RETURN_DOM||!1,Q=e.RETURN_DOM_FRAGMENT||!1,ht=e.RETURN_TRUSTED_TYPE||!1,pt=e.FORCE_BODY||!1,gt=e.SANITIZE_DOM!==!1,_t=e.SANITIZE_NAMED_PROPS||!1,yt=e.KEEP_CONTENT!==!1,bt=e.IN_PLACE||!1,re=De(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:We,jt=typeof e.NAMESPACE==`string`?e.NAMESPACE:At,It=ve(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?we(e.MATHML_TEXT_INTEGRATION_POINTS):X({},Ft),Rt=ve(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?we(e.HTML_INTEGRATION_POINTS):X({},Lt);let t=ve(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?we(e.CUSTOM_ELEMENT_HANDLING):G(null);if(J=G(null),ve(t,`tagNameCheck`)&&Wt(t.tagNameCheck)&&(J.tagNameCheck=t.tagNameCheck),ve(t,`attributeNameCheck`)&&Wt(t.attributeNameCheck)&&(J.attributeNameCheck=t.attributeNameCheck),ve(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(J.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),W(J),ct&&(at=!1),Q&&(mt=!0),xt&&(K=X({},Pe),q=G(null),xt.html===!0&&(X(K,Oe),X(q,Fe)),xt.svg===!0&&(X(K,ke),X(q,Ie),X(q,Re)),xt.svgFilters===!0&&(X(K,Ae),X(q,Ie),X(q,Re)),xt.mathMl===!0&&(X(K,Me),X(q,Le),X(q,Re))),Se.tagCheck=null,Se.attributeCheck=null,ve(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?Se.tagCheck=e.ADD_TAGS:le(e.ADD_TAGS)&&(K===ge&&(K=we(K)),X(K,e.ADD_TAGS,$))),ve(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?Se.attributeCheck=e.ADD_ATTR:le(e.ADD_ATTR)&&(q===_e&&(q=we(q)),X(q,e.ADD_ATTR,$))),ve(e,`ADD_URI_SAFE_ATTR`)&&le(e.ADD_URI_SAFE_ATTR)&&X(Et,e.ADD_URI_SAFE_ATTR,$),ve(e,`FORBID_CONTENTS`)&&le(e.FORBID_CONTENTS)&&(St===Ct&&(St=we(St)),X(St,e.FORBID_CONTENTS,$)),ve(e,`ADD_FORBID_CONTENTS`)&&le(e.ADD_FORBID_CONTENTS)&&(St===Ct&&(St=we(St)),X(St,e.ADD_FORBID_CONTENTS,$)),yt&&(K[`#text`]=!0),Z&&X(K,[`html`,`head`,`body`]),K.table&&(X(K,[`tbody`]),delete ye.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw xe(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw xe(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);let t=x;x=e.TRUSTED_TYPES_POLICY;try{S=D(``)}catch(e){throw x=t,e}}else e.TRUSTED_TYPES_POLICY===null?(x=void 0,S=``):(x===void 0&&(x=k()),x&&typeof S==`string`&&(S=D(``)));U&&U(e),Ht=e},Kt=X({},[...ke,...Ae,...je]),qt=X({},[...Me,...Ne]),Jt=function(e,t,n){return t.namespaceURI===At?e===`svg`:t.namespaceURI===Ot?e===`svg`&&(n===`annotation-xml`||It[n]):!!Kt[e]},Yt=function(e,t,n){return t.namespaceURI===At?e===`math`:t.namespaceURI===kt?e===`math`&&Rt[n]:!!qt[e]},Xt=function(e,t,n){return t.namespaceURI===kt&&!Rt[n]||t.namespaceURI===Ot&&!It[n]?!1:!qt[e]&&(zt[e]||!Kt[e])},Zt=function(e){let t=g(e);(!t||!t.tagName)&&(t={namespaceURI:jt,tagName:`template`});let n=ue(e.tagName),r=ue(t.tagName);return Nt[e.namespaceURI]?e.namespaceURI===kt?Jt(n,t,r):e.namespaceURI===Ot?Yt(n,t,r):e.namespaceURI===At?Xt(n,t,r):!!(Bt===`application/xhtml+xml`&&Nt[e.namespaceURI]):!1},Qt=function(e){se(t.removed,{element:e});try{g(e).removeChild(e)}catch{if(p(e),!g(e))throw xe(`a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place`)}},$t=function(e){nn(e);let t=h(e);if(t){let e=[];ie(t,t=>{se(e,t)}),ie(e,e=>{try{p(e)}catch{}})}let n=v(e);if(n)for(let t=n.length-1;t>=0;--t){let r=n[t],i=r&&r.name;if(typeof i==`string`)try{e.removeAttribute(i)}catch{}}},en=function(e,n){try{se(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{se(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(mt||Q)try{Qt(n)}catch{}else try{n.setAttribute(e,``)}catch{}},tn=function(e){let t=v(e);if(t)for(let n=t.length-1;n>=0;--n){let r=t[n],i=r&&r.name;if(!(typeof i!=`string`||q[$(i)]))try{e.removeAttribute(i)}catch{}}},nn=function(e){let t=[e];for(;t.length>0;){let e=t.pop();(y?y(e):e.nodeType)===$e.element&&tn(e);let n=h(e);if(n)for(let e=n.length-1;e>=0;--e)t.push(n[e])}},rn=function(e){if(!lt)return;let t=[e];for(;t.length>0;){let e=t.pop(),n=y?y(e):e.nodeType;if(n===$e.processingInstruction||n===$e.comment&&be(Xe,e.data)){try{p(e)}catch{}continue}if(n===$e.element){let t=e,n=$(b?b(e):e.nodeName);try{t.hasAttribute&&t.hasAttribute(`patchsrc`)&&t.removeAttribute(`patchsrc`),t.hasAttribute&&t.hasAttribute(`for`)&&n!==`label`&&n!==`output`&&t.removeAttribute(`for`)}catch{}}let r=h(e);if(r)for(let e=r.length-1;e>=0;--e)t.push(r[e])}},an=function(e){let t=null,r=null;if(pt)e=`<remove></remove>`+e;else{let t=fe(e,/^[\r\n\t ]+/);r=t&&t[0]}Bt===`application/xhtml+xml`&&jt===At&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=x?D(e):e;if(jt===At)try{t=new l().parseFromString(i,Bt)}catch{}if(!t||!t.documentElement){t=j.createDocument(jt,`template`,null);try{t.documentElement.innerHTML=Mt?S:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),jt===At?P.call(t,Z?`html`:`body`)[0]:Z?t.documentElement:a},on=function(e){return M.call(e.ownerDocument||e,e,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},sn=function(e){return e=pe(e,L,` `),e=pe(e,R,` `),e=pe(e,z,` `),e},cn=function(e){e.normalize();let t=M.call(e.ownerDocument||e,e,c.SHOW_TEXT|c.SHOW_COMMENT|c.SHOW_CDATA_SECTION|c.SHOW_PROCESSING_INSTRUCTION,null),n=t.nextNode();for(;n;)n.data=sn(n.data),n=t.nextNode();let r=e.querySelectorAll?.call(e,`template`);r&&ie(r,e=>{un(e.content)&&cn(e.content)})},ln=function(e){let t=b?b(e):null;return typeof t!=`string`||$(t)!==`form`?!1:typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||e.attributes!==v(e)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`||e.nodeType!==y(e)||e.childNodes!==h(e)},un=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return y(e)===$e.documentFragment}catch{return!1}},dn=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return typeof y(e)==`number`}catch{return!1}};function fn(e,n,r){e.length!==0&&ie(e,e=>{e.call(t,n,r,Ht)})}let pn=function(e,t){return!!(lt&&e.hasChildNodes()&&!dn(e.firstElementChild)&&be(Ye,e.textContent)&&be(Ye,e.innerHTML)||lt&&e.namespaceURI===At&&t===`style`&&dn(e.firstElementChild)||e.nodeType===$e.processingInstruction||lt&&e.nodeType===$e.comment&&be(Xe,e.data))},mn=function(e,t){if(!ye[t]&&vn(t)&&(J.tagNameCheck instanceof RegExp&&be(J.tagNameCheck,t)||J.tagNameCheck instanceof Function&&J.tagNameCheck(t)))return!1;if(yt&&!St[t]){let t=g(e),n=h(e);if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=bt?n[i]:f(n[i],!0);t.insertBefore(r,m(e))}}}return Qt(e),!0},hn=function(e,n){if(fn(I.beforeSanitizeElements,e,null),e!==n&&g(e)===null)return!0;if(ln(e))return Qt(e),!0;let r=$(b?b(e):e.nodeName);if(fn(I.uponSanitizeElement,e,{tagName:r,allowedTags:K}),e!==n&&g(e)===null)return!0;if(pn(e,r))return Qt(e),!0;if(ye[r]||!(Se.tagCheck instanceof Function&&Se.tagCheck(r))&&!K[r]){let t=mn(e,r);return t===!1&&fn(I.afterSanitizeElements,e,null),t}if((y?y(e):e.nodeType)===$e.element&&!Zt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&be(Ze,e.innerHTML))return Qt(e),!0;if(ct&&e.nodeType===$e.text){let n=sn(e.textContent);e.textContent!==n&&(se(t.removed,{element:e.cloneNode()}),e.textContent=n)}return fn(I.afterSanitizeElements,e,null),!1},gn=function(e,t,r){if(Y[t]||lt&&t===`patchsrc`||lt&&t===`for`&&e!==`label`&&e!==`output`||gt&&(t===`id`||t===`name`)&&(r in n||r in Ut))return!1;let i=q[t]||Se.attributeCheck instanceof Function&&Se.attributeCheck(t,e);if(!(at&&be(V,t))&&!(Ce&&be(H,t))){if(!i){if(!(vn(e)&&(J.tagNameCheck instanceof RegExp&&be(J.tagNameCheck,e)||J.tagNameCheck instanceof Function&&J.tagNameCheck(e))&&(J.attributeNameCheck instanceof RegExp&&be(J.attributeNameCheck,t)||J.attributeNameCheck instanceof Function&&J.attributeNameCheck(t,e))||t===`is`&&J.allowCustomizedBuiltInElements&&(J.tagNameCheck instanceof RegExp&&be(J.tagNameCheck,r)||J.tagNameCheck instanceof Function&&J.tagNameCheck(r))))return!1}else if(!Et[t]&&!be(re,pe(r,te,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&me(r,`data:`)===0&&wt[e])&&!(ot&&!be(ee,pe(r,te,``)))&&r)return!1}return!0},_n=X({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),vn=function(e){return!_n[ue(e)]&&be(ne,e)},yn=function(e,t,n,r){if(x&&typeof u==`object`&&typeof u.getAttributeType==`function`&&!n)switch(u.getAttributeType(e,t)){case`TrustedHTML`:return D(r);case`TrustedScriptURL`:return O(r)}return r},bn=function(e,n,r,i){try{r?e.setAttributeNS(r,n,i):e.setAttribute(n,i),ln(e)?Qt(e):oe(t.removed)}catch{en(n,e)}},xn=function(e){fn(I.beforeSanitizeAttributes,e,null);let t=e.attributes;if(!t||ln(e))return;let n={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:q,forceKeepAttr:void 0},r=t.length,i=$(e.nodeName);for(;r--;){let a=t[r],o=a.name,s=a.namespaceURI,c=a.value,l=$(o),u=c,d=o===`value`?u:he(u);if(n.attrName=l,n.attrValue=d,n.keepAttr=!0,n.forceKeepAttr=void 0,fn(I.uponSanitizeAttribute,e,n),d=n.attrValue,_t&&(l===`id`||l===`name`)&&me(d,vt)!==0&&(en(o,e),d=vt+d),lt&&be(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){en(o,e);continue}if(l===`attributename`&&fe(d,`href`)){en(o,e);continue}if(!n.forceKeepAttr){if(!n.keepAttr){en(o,e);continue}if(!st&&be(Qe,d)){en(o,e);continue}if(ct&&(d=sn(d)),!gn(i,l,d)){en(o,e);continue}d=yn(i,l,s,d),d!==u&&bn(e,o,s,d)}}fn(I.afterSanitizeAttributes,e,null)},Sn=function(e){let t=null,n=on(e);for(fn(I.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)if(fn(I.uponSanitizeShadowNode,t,null),hn(t,e),xn(t),un(t.content)&&Sn(t.content),(y?y(t):t.nodeType)===$e.element){let e=_(t);un(e)&&(Cn(e),Sn(e))}fn(I.afterSanitizeShadowDOM,e,null)},Cn=function(e){let t=[{node:e,shadow:null}];for(;t.length>0;){let e=t.pop();if(e.shadow){Sn(e.shadow);continue}let n=e.node,r=(y?y(n):n.nodeType)===$e.element,i=h(n);if(i)for(let e=i.length-1;e>=0;--e)t.push({node:i[e],shadow:null});if(r){let e=b?b(n):null;if(typeof e==`string`&&$(e)===`template`){let e=n.content;un(e)&&t.push({node:e,shadow:null})}}if(r){let e=_(n);un(e)&&t.push({node:null,shadow:e},{node:e,shadow:null})}}};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,a=null,o=null,s=null;if(Mt=!e,Mt&&(e=`<!-->`),typeof e!=`string`&&!dn(e)&&(e=Te(e),typeof e!=`string`))throw xe(`dirty is not a string, aborting`);if(!t.isSupported)return e;ut?(K=dt,q=ft):Gt(n),(I.uponSanitizeElement.length>0||I.uponSanitizeAttribute.length>0)&&(K=we(K)),I.uponSanitizeAttribute.length>0&&(q=we(q)),t.removed=[];let c=bt&&typeof e!=`string`&&dn(e);if(c){rn(e);let t=b?b(e):e.nodeName;if(typeof t==`string`){let n=$(t);if(!K[n]||ye[n])throw $t(e),xe(`root node is forbidden and cannot be sanitized in-place`)}if(ln(e))throw $t(e),xe(`root node is clobbered and cannot be sanitized in-place`);try{Cn(e)}catch(t){throw $t(e),t}}else if(dn(e))i=an(`<!---->`),a=i.ownerDocument.importNode(e,!0),a.nodeType===$e.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?i=a:i.appendChild(a),Cn(a);else{if(!mt&&!ct&&!Z&&e.indexOf(`<`)===-1)return x&&ht?D(e):e;if(i=an(e),!i)return mt?null:ht?S:``}i&&pt&&Qt(i.firstChild);let l=c?e:i,u=on(l);try{for(;o=u.nextNode();)hn(o,l),xn(o),un(o.content)&&Sn(o.content)}catch(n){throw c&&($t(e),ie(t.removed,e=>{e.element&&nn(e.element)})),n}if(c)return ie(t.removed,e=>{e.element&&nn(e.element)}),ct&&cn(e),e;if(mt){if(ct&&cn(i),Q)for(s=N.call(i.ownerDocument);i.firstChild;)s.appendChild(i.firstChild);else s=i;return(q.shadowroot||q.shadowrootmode)&&(s=F.call(r,s,!0)),s}let d=Z?i.outerHTML:i.innerHTML;return Z&&K[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&be(qe,i.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+d),ct&&(d=sn(d)),x&&ht?D(d):d},t.setConfig=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Gt(e),ut=!0,dt=K,ft=q},t.clearConfig=function(){Ht=null,ut=!1,dt=null,ft=null,x=C,S=``},t.isValidAttribute=function(e,t,n){Ht||Gt({});let r=$(e),i=$(t);return gn(r,i,n)},t.addHook=function(e,t){typeof t==`function`&&ve(I,e)&&se(I[e],t)},t.removeHook=function(e,t){if(ve(I,e)){if(t!==void 0){let n=ae(I[e],t);return n===-1?void 0:ce(I[e],n,1)[0]}return oe(I[e])}},t.removeHooks=function(e){ve(I,e)&&(I[e]=[])},t.removeAllHooks=function(){I=nt()},t}var at=it();function ot(e,t){let n=String(e??``),r=n.match(/^\s*<h1\b[^>]*>([\s\S]*?)<\/h1>\s*/i);if(!r)return n;let i=r[1].replace(/<[^>]*>/g,``).replace(/\s+/g,` `).trim(),a=String(t??``).replace(/\s+/g,` `).trim();return!a||i!==a?n:n.slice(r[0].length)}function st(e){let t=e.length,n=Array.from({length:t},(e,n)=>n+1<t?n+1:null),r=[],i=null,a=t>0?0:null,o=null,s=(e,t)=>r.push({phase:e,desc:t,prev:i,curr:a,next:o,nextOf:[...n],done:!1}),c=t=>t===null?`∅`:String(e[t]);if(t===0)return s(`init`,"空链表。`head` 本身就是 ∅，直接返回 ∅ —— 这是必须单独处理的第一种边界。"),r[0].done=!0,r;for(s(`init`,`初始状态：\`prev\` 先站在 ∅（反转后头节点会变成尾节点，它的 \`next\` 必须指向空），\`curr\` 指向头节点 ${c(a)}。`);a!==null;)o=n[a],s(`read-next`,`① \`next = curr.next\`，先记住 ${c(o)}。这一步看着多余，其实是整个算法的命门：一旦 ② 把 \`curr\` 的指针掉头，通往后面节点的唯一线索就断了，所以必须提前存好。`),n[a]=i,s(`flip`,`② \`curr.next = prev\`，把 ${c(a)} 的箭头掉个头，指向 ${c(i)}。`+(i===null?` 因为 \`prev\` 还是 ∅，${c(a)} 就成了新的尾节点。`:``)),i=a,a=o,s(`advance`,a===null?`③ \`prev = curr\`，\`curr = next\` = ∅。curr 走出了链表，循环结束 —— 返回 \`prev\`（${c(i)}），它就是反转后的新头节点。`:`③ \`prev\` 和 \`curr\` 一起右移：\`prev\` 指向 ${c(i)}，\`curr\` 指向 ${c(a)}。准备处理下一个节点。`);return r[r.length-1].done=!0,r}var ct=`viz-chrome-styles`,lt=`http://www.w3.org/2000/svg`;function Z(e,t){let n=document.createElementNS(lt,e);if(t)for(let e in t)n.setAttribute(e,t[e]);return n}function ut(e,t,n,r,i=`viz-arrow`){let a=Z(`g`,{class:i}),o=r>0?t:e,s=r>0?e:t;return a.appendChild(Z(`line`,{class:`${i}__line`,x1:s,y1:n,x2:o-r*9,y2:n})),a.appendChild(Z(`path`,{class:`${i}__head`,d:`M ${o} ${n} L ${o-r*9} ${n-5.5} L ${o-r*9} ${n+5.5} Z`})),a}var dt=`
.viz {
  margin: 1.6em 0;
...
`;function Mn(){if(ft(),document.getElementById(on))return;let e=document.createElement(`style`);e.id=on,e.textContent=jn,document.head.appendChild(e)}function Nn(e){let t=Math.floor(Math.log2(e+1));return{x:(e-(2**t-1)+.5)/2**t*xn,y:t*Cn}}function Pn(e,t={}){if(!e||e.dataset.mklMounted===`1`)return{destroy(){}};e.dataset.mklMounted=`1`,Mn(),On+=1;let n=Array.isArray(t.lists)&&t.lists.length?t.lists:[[1,4],[2,5],[3,6],[0,7]],r=t.autoplay!==!1,i=an(n),a=n.length,o=Math.max(1,a),s=n.reduce((e,t)=>Math.max(e,t.length),0),c=1+n.reduce((e,t)=>e+t.length,0),l=e=>un+e*ln,u=e=>l(e)+sn/2,d=e=>e<=0?un:un+(e-1)*ln+sn,f=e=>d(e)+fn,p=o*gn-(gn-cn),m=wn+(Math.floor(Math.log2(o))*Cn+bn),h=Math.max(p,m),g=_n+h+vn,_=g+cn+hn+20,v=f(s)+dn,y=v+Tn+En,b=f(c)+dn+12,x=Math.max(y+36,b),S=Math.round((x-y)/2),C=S+v+Tn,w=e=>C+Sn+Nn(e).x,T=e=>_n+Math.max(0,Math.round((h-m)/2))+wn+Nn(e).y,E=document.createElement(`div`);E.className=`viz mkl`;let D=document.createElement(`div`);D.className=`viz__stage`,E.appendChild(D);let O=Z(`svg`,{class:`viz__svg mkl__svg`,viewBox:`0 0 ${x} ${_}`,role:`img`,"aria-label":`合并 ${a} 个升序链表的小顶堆推演动画`});D.appendChild(O);function k(e,t,n,r,i){let a=Z(`g`,{class:i});return a.appendChild(Z(`line`,{class:`mkl-edge__line`,x1:t,y1:r,x2:n-9,y2:r})),a.appendChild(Z(`path`,{class:`mkl-edge__head`,d:`M ${n} ${r} L ${n-9} ${r-5.5} L ${n-9} ${r+5.5} Z`})),e.appendChild(a),a}function A(e,t,n){e.appendChild(Z(`circle`,{class:`mkl-null__ring`,cx:t,cy:n,r:dn}));let r=Z(`text`,{class:`mkl-null__text`,x:t,y:n});r.textContent=`∅`,e.appendChild(r)}function j(e,t,n,r,i){let a=Z(`g`,{class:`mkl-node ${i}`});a.appendChild(Z(`rect`,{class:`mkl-node__box`,x:n,y:r,width:sn,height:cn,rx:8}));let o=Z(`text`,{class:`mkl-node__value`,x:n+sn/2,y:r+cn/2});return o.textContent=String(t),a.appendChild(o),e.appendChild(a),a}let M=n.map((e,t)=>{let n=_n+t*gn,r=n+cn/2,i=Z(`g`,{class:`mkl-src ${An(t)}`}),a=Z(`text`,{class:`mkl-row-label`,x:S+un/2-6,y:r});a.textContent=String.fromCharCode(65+t),i.appendChild(a);let o=e.map((e,t)=>j(i,e,S+un+t*ln,n,``));for(let t=0;t<e.length-1;t+=1)k(i,S+un+t*ln+sn,S+un+(t+1)*ln,r,``);return e.length>0&&k(i,S+d(e.length),S+f(e.length)-dn,r,``),A(i,S+f(e.length),r),O.appendChild(i),{g:i,labelEl:a,nodes:o,values:e}}),N=Z(`g`,{class:`mkl-heap`});O.appendChild(N);let P=Z(`text`,{class:`mkl-heap__caption`,x:C+Sn+xn/2,y:_n+Math.max(0,Math.round((h-m)/2))+wn/2});N.appendChild(P);let F=[];for(let e=1;e<o;e+=1){let t=e-1>>1,n=Z(`g`,{class:`mkl-hedge`});n.appendChild(Z(`line`,{class:`mkl-hedge__line`,x1:w(t),y1:T(t)+bn,x2:w(e),y2:T(e)})),N.appendChild(n),F.push({g:n,child:e})}let I=[];for(let e=0;e<o;e+=1){let t=Z(`g`,{class:`mkl-hslot is-off`});t.appendChild(Z(`rect`,{class:`mkl-hnode__box`,x:w(e)-yn/2,y:T(e),width:yn,height:bn,rx:7}));let n=Z(`text`,{class:`mkl-hnode__value`,x:w(e),y:T(e)+bn/2});t.appendChild(n),N.appendChild(t),I.push({g:t,textEl:n})}let L=Z(`text`,{class:`mkl-heap__root-tag`,x:w(0)+yn/2+24,y:T(0)+bn/2});L.textContent=`堆顶`,N.appendChild(L);let R=Z(`g`,{class:`mkl-result`});O.appendChild(R);let z=g+cn/2,B=Z(`text`,{class:`mkl-row-label`,x:26,y:z});B.textContent=`结果`,R.appendChild(B);let V=Z(`g`,{class:`mkl-dummy`});V.appendChild(Z(`rect`,{class:`mkl-dummy__box`,x:l(0),y:g,width:sn,height:cn,rx:8}));let H=Z(`text`,{class:`mkl-dummy__text`,x:u(0),y:z});H.textContent=`dummy`,V.appendChild(H),R.appendChild(V);let ee=[];for(let e=1;e<c;e+=1)ee.push(k(R,l(e-1)+sn,l(e),z,`mkl-redge`));A(R,f(c),z);let te=k(R,d(c),f(c)-dn,z,`mkl-redge`),U=i[i.length-1].taken.map((e,t)=>j(R,n[e.list][e.i],l(t+1),g,`mkl-rslot ${An(e.list)}`)),W=Z(`g`,{class:`mkl-chip mkl-chip--tail`});W.appendChild(Z(`rect`,{class:`mkl-chip__box`,x:-40/2,y:-22/2,width:pn,height:mn}));let G=Z(`text`,{class:`mkl-chip__text`,x:0,y:0});G.textContent=`tail`,W.appendChild(G),R.appendChild(W);let ne=document.createElement(`p`);ne.className=`viz__desc`,ne.setAttribute(`aria-live`,`polite`),E.appendChild(ne);let re=Q();E.appendChild(re.root),e.textContent=``,e.appendChild(E);let K=null;function ie(e,t){let r=t.heap.length,i=new Set(t.moved);M.forEach((e,n)=>{let r=t.cursors[n];e.g.classList.toggle(`is-dead`,r===null),e.labelEl.classList.toggle(`is-live`,r!==null),e.labelEl.classList.toggle(`is-dead`,r===null),e.nodes.forEach((e,t)=>{e.classList.toggle(`is-taken`,r===null||t<r),e.classList.toggle(`is-head`,r===t)})}),I.forEach((e,a)=>{if(a>=r){e.g.setAttribute(`class`,`mkl-hslot is-off`);return}let o=t.heap[a];e.textEl.textContent=String(n[o.list][o.i]),e.g.setAttribute(`class`,`mkl-hslot ${An(o.list)}${i.has(a)?` is-moved`:``}`+(a===0?` is-root`:``))}),F.forEach(e=>{e.g.style.display=e.child<r?``:`none`}),P.textContent=r===0?`堆：空了 —— 全部节点已取出`:`堆：只有 ${r} 个候选（每条链表当前的头部）`,L.classList.toggle(`is-off`,r===0);let a=t.phase===`take`?t.taken.length:1/0;U.forEach((e,n)=>{let r=n+1,i=r<=t.taken.length;e.classList.toggle(`is-filled`,i),e.classList.toggle(`is-new`,i&&r>=a)}),ee.forEach((e,n)=>e.classList.toggle(`is-on`,n+1<=t.taken.length)),te.classList.toggle(`is-on`,t.done);let o=Math.min(t.taken.length,c-1);W.style.transform=`translate(${u(o)}px, ${g+cn+hn}px)`,mt(ne,t.desc)}let ae=ht({steps:i,controls:re,intervalMs:Dn,onRender:ie});ae.jumpTo(Math.trunc(t.initialStep)||0);let oe=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches;return r&&!oe&&typeof IntersectionObserver==`function`&&(K=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){K.disconnect(),K=null,ae.play();return}},{threshold:.35}),K.observe(E)),{destroy(){K&&=(K.disconnect(),null),ae.destroy(),e.textContent=``,delete e.dataset.mklMounted,--On,On<=0&&(document.getElementById(on)?.remove(),pt())}}}function Fn(e,t){let n=[],r=0,i=0;for(;r<e.length&&i<t.length;)e[r]<=t[i]?(n.push(e[r]),r+=1):(n.push(t[i]),i+=1);for(;r<e.length;)n.push(e[r++]);for(;i<t.length;)n.push(t[i++]);return n}var In=e=>e.length?e.join(`、`):`∅`;function Ln(e){let t=(Array.isArray(e)?e:[]).map(e=>Array.isArray(e)?e.slice():[]),n=t.length,r=[],i=t.reduce((e,t)=>e+t.length,0),a=e=>e.map(e=>({lists:e.lists.map(e=>e.slice()),from:e.from?e.from.map(e=>[e[0],e[1]]):null}));if(n===0)return r.push({phase:`init`,desc:"`lists` 是个空数组，一条链表都没有，直接返回 ∅。",levels:[],activeLevel:-1,rounds:0,done:!0}),r;let o=[{lists:t.map(e=>e.slice()),from:null}];if(n===1)return r.push({phase:`init`,desc:`只有 1 条链表，**一次合并都不用做** —— 分治的轮数是 ⌈log₂1⌉ = 0，直接返回它自己（${In(t[0])}）。`,levels:a(o),activeLevel:0,rounds:0,done:!0}),r;r.push({phase:`init`,desc:`分治的起手：${n} 条链表一字排开，一共 ${i} 个节点。接下来每一轮**两两配对合并**，链表条数每次减半 —— ${n} → ${Math.ceil(n/2)} → … → 1，一共 ⌈log₂${n}⌉ = ${Math.ceil(Math.log2(n))} 轮。`,levels:a(o),activeLevel:0,rounds:0,done:!1});let s=t,c=0;for(;s.length>1;){let e=[],t=[];for(let n=0;n<s.length;n+=2)n+1<s.length?(e.push(Fn(s[n],s[n+1])),t.push([n,n+1])):(e.push(s[n].slice()),t.push([n,-1]));c+=1,o.push({lists:e,from:t});let n=s.length,i=e.length,l=t.reduce((e,[t,n])=>e+(n>=0?s[t].length+s[n].length:0),0),u=t.filter(e=>e[1]>=0).length,d=t.find(e=>e[1]<0);r.push({phase:`merge`,desc:`第 ${c} 轮：把 ${n} 条两两配对，做 ${u} 次「合并两个有序链表」，得到 ${i} 条。本轮被摸到的节点一共 ${l} 个，不超过 N —— 每轮都是 O(N) 的工作量。`+(d?`注意第 ${d[0]+1} 条这轮**轮空**了，原样进下一轮（不是丢掉）。`:`链表条数 ${n} → ${i}。`),levels:a(o),activeLevel:o.length-1,rounds:c,done:!1}),s=e}return r.push({phase:`done`,desc:`一共 ${c} 轮，每轮 O(N)，所以总时间是 **O(N log K)** —— 和最小堆同阶。结果链表是 ${In(s[0])}。分治的隐藏优势：它不需要堆，每一轮都是纯粹的指针比较，常数更小。`,levels:a(o),activeLevel:o.length-1,rounds:c,done:!0}),r}var Rn=`mkc-styles`,zn=44,Bn=36,Vn=18,Hn=38,Un=68,Wn=76,Gn=34,Kn=54,qn=30,Jn=1400,Yn=0,Xn=`
.mkc {
  --mkc-lv1: #3f6b57;
  --mkc-lv2: #a45f45;
  --mkc-lv3: #3f5f8a;
...
`;function as(){if(document.getElementById(Jo))return;let e=document.createElement(`style`);e.id=Jo,e.textContent=is,document.head.appendChild(e)}function os(e,t={}){if(!e||e.dataset.itMounted===`1`)return{destroy(){}};e.dataset.itMounted=`1`,as();let n=qo(t),r=t.autoplay!==!1,{nodes:i,root:a}=Ga(Array.isArray(t.values)?t.values:[4,2,7,1,3,6,9]),o=e=>e==null||!i[e]?null:i[e].value,s=Z,c=document.createElement(`div`);c.className=`viz it`;let l=document.createElement(`div`);l.className=`viz__stage`,c.appendChild(l);function u(){let e=document.createElement(`p`);return e.className=`viz__desc`,e.setAttribute(`aria-live`,`polite`),e}if(a===-1){let t=s(`svg`,{class:`viz__svg it__svg`,viewBox:`0 0 620 120`,role:`img`}),n=s(`text`,{class:`it-empty__text`,x:620/2,y:120/2});return n.textContent=`空树 —— 没什么可翻的，直接返回 None`,t.appendChild(n),l.appendChild(t),c.appendChild(u()),c.appendChild(Q().root),e.textContent=``,e.appendChild(c),{destroy(){e.textContent=``,delete e.dataset.itMounted,document.getElementById(Jo)?.remove()}}}let d=i.reduce((e,t)=>Math.max(e,t.depth),0),f=Math.min(120,Math.max(58,Math.round(470/2**d))),p=e=>f*2**Math.max(0,d-e),m=2**d*f,h=Math.max(660,es+m+68),g=(h-m)/2,_=e=>Zo+e*Xo,v=(e,t)=>{let n=0,r=1,a=t;for(;i[a].parent!==-1;)e[a]===`R`&&(n+=r),r*=2,a=i[a].parent;return{x:g+(n+.5)*p(i[t].depth),y:_(i[t].depth)}},y=Zo+d*Xo+Yo+ts,b=Math.min(620,h-es*2),x=s(`svg`,{class:`viz__svg it__svg`,viewBox:`0 0 ${h} ${y+ns+26}`,role:`img`,"aria-label":`翻转二叉树推演动画`});l.appendChild(x);let S=s(`g`,{class:`it-edges`}),C=s(`g`,{class:`it-nodes`}),w=s(`g`,{class:`it-swap`});x.appendChild(S),x.appendChild(w),x.appendChild(C);let T=new Map;for(let e of i){if(e.parent===-1)continue;let t=s(`path`,{class:`it-edge`,d:`M 0 0 L 0 0`});S.appendChild(t),T.set(e.id,t)}let E=[];for(let e of i){let t=s(`g`,{class:`it-node`});t.appendChild(s(`circle`,{class:`it-node__ring`,r:31})),t.appendChild(s(`circle`,{class:`it-node__circle`,cx:0,cy:0,r:Yo}));let n=s(`text`,{class:`it-node__value`,x:0,y:0});n.textContent=String(e.value),t.appendChild(n),C.appendChild(t),E.push({g:t,value:e.value,id:e.id})}let D=s(`path`,{class:`it-swap__arc`,d:`M 0 0`}),O=s(`path`,{class:`it-swap__head`,d:`M 0 0`}),k=s(`path`,{class:`it-swap__head`,d:`M 0 0`}),A=s(`text`,{class:`it-swap__mark`,x:0,y:0});A.textContent=`⇄`,w.appendChild(D),w.appendChild(O),w.appendChild(k),w.appendChild(A);let j=s(`rect`,{class:`it-banner__box`,x:es,y,width:b,height:ns,rx:9});x.appendChild(j);let M=s(`text`,{class:`it-banner__lead`,x:42,y:y+ns/2});x.appendChild(M);let N=s(`text`,{class:`it-banner__count`,x:es+b-16,y:y+ns/2});x.appendChild(N);let P=u();function F(e,t){if(!t)return;let n=t.sideOf??{},r=e=>v(n,e),s=t.current,c=new Set(t.swapped??[]),l=t.swapPair??[],u=new Set(l.filter(e=>e!=null)),d=new Set;for(let e=0;e+1<t.stack.length;e+=1)d.add(t.stack[e+1].id);for(let e of E){let{id:n,g:i}=e,a=r(n);i.setAttribute(`transform`,`translate(${a.x} ${a.y})`);let o=[`it-node`];c.has(n)&&o.push(`is-done`),n===s&&t.phase!==`done`&&o.push(`is-visit`),u.has(n)&&o.push(`is-swapping`),i.setAttribute(`class`,o.join(` `))}for(let e of i){if(e.parent===-1)continue;let t=r(e.parent),n=r(e.id),i=T.get(e.id);i.setAttribute(`d`,`M ${t.x} ${t.y+Yo} L ${n.x} ${n.y-Yo}`),i.setAttribute(`class`,d.has(e.id)?`it-edge is-onstack`:`it-edge`)}let f=l.filter(e=>e!=null);if(t.phase===`swap`&&f.length===2){let e=r(f[0]),t=r(f[1]),n=e.y-Yo-Qo,i=(e.x+t.x)/2,a=e.y-Yo-$o;D.setAttribute(`d`,`M ${e.x} ${n} Q ${i} ${a} ${t.x} ${n}`),D.style.opacity=`1`,O.setAttribute(`d`,`M ${e.x} ${n} l 9 -4 l 0 8 z`),k.setAttribute(`d`,`M ${t.x} ${n} l -9 -4 l 0 8 z`),O.style.opacity=`1`,k.style.opacity=`1`,A.setAttribute(`x`,i),A.setAttribute(`y`,a-9),A.style.opacity=`1`}else D.style.opacity=`0`,O.style.opacity=`0`,k.style.opacity=`0`,A.style.opacity=`0`;let p=i.filter(e=>e.left!==null||e.right!==null).length;t.phase===`init`?M.textContent=`从根 ${o(a)} 开始，逐层交换两个孩子`:t.phase===`swap`?M.textContent=f.length===2?`交换 ${o(f[0])} 和 ${o(f[1])}`:`单侧孩子移位：${o(f[0]??f[1])}`:t.phase===`leaf`?M.textContent=`${o(s)} 是叶子，交换空操作 → 直接返回`:M.textContent=`继续递归进子树 ${o(s)}`,t.phase===`done`?(M.textContent=`翻转完成 —— 每个节点的路径都逐位取反过了`,j.setAttribute(`class`,`it-banner__box is-done`),N.setAttribute(`class`,`it-banner__count is-done`)):(j.setAttribute(`class`,`it-banner__box`),N.setAttribute(`class`,`it-banner__count`)),N.textContent=`已换 ${t.swapped.length}/${p} 个非叶节点`,mt(P,t.desc)}c.appendChild(P);let I=Q();c.appendChild(I.root),e.textContent=``,e.appendChild(c),ft();let L=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches,R=ht({steps:n,controls:I,intervalMs:rs,onRender:F});R.jumpTo(Math.trunc(t.initialStep)||0);let z=null;return r&&!L&&typeof IntersectionObserver==`function`&&(z=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){z.disconnect(),z=null,R.play();return}},{threshold:.35}),z.observe(c)),{destroy(){z&&=(z.disconnect(),null),R.destroy(),e.textContent=``,delete e.dataset.itMounted,document.getElementById(Jo)?.remove()}}}var ss=[`innerHTML`],cs=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,ls=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,us=`0.16.21`,ds=`11.4.1`,fs=y({__name:`MarkdownView`,props:{html:{type:String,default:``},title:{type:String,default:``}},setup(e){let t=e,n=w(null),r=v(()=>ot(at.sanitize(t.html,{ADD_ATTR:[`target`,`rel`],FORBID_TAGS:[`style`,`iframe`,`object`,`embed`,`form`],FORBID_ATTR:[`onerror`,`onload`,`onclick`]}),t.title));function i(e){e.classList.add(`copied`),e.innerHTML=ls,setTimeout(()=>{e.classList.remove(`copied`),e.innerHTML=cs},2e3)}function s(){n.value&&n.value.querySelectorAll(`table`).forEach(e=>{if(e.parentElement?.classList.contains(`table-scroll`))return;let t=document.createElement(`div`);t.className=`table-scroll`,e.parentNode.insertBefore(t,e),t.appendChild(e)})}function l(){n.value&&n.value.querySelectorAll(`pre`).forEach(e=>{if(e.parentElement?.classList.contains(`code-block-wrapper`))return;let t=document.createElement(`div`);t.className=`code-block-wrapper`,e.parentNode.insertBefore(t,e),t.appendChild(e);let n=document.createElement(`button`);n.className=`copy-btn`,n.title=`复制代码`,n.innerHTML=cs,n.addEventListener(`click`,()=>{let t=(e.querySelector(`code`)||e).textContent||``;navigator.clipboard.writeText(t).then(()=>{i(n)}).catch(()=>{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),i(n)})}),t.appendChild(n)})}function u(e,t){return new Promise((n,r)=>{if(document.querySelector(`link[data-lib-href="${e}"]`))return n();let i=document.createElement(`link`);i.rel=`stylesheet`,i.href=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libHref=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load stylesheet `+e)),document.head.appendChild(i)})}function d(e,t){return new Promise((n,r)=>{if(document.querySelector(`script[data-lib-src="${e}"]`))return n();let i=document.createElement(`script`);i.src=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libSrc=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load script `+e)),document.head.appendChild(i)})}let f=null;async function m(){return f||=Promise.all([u(`https://cdn.jsdelivr.net/npm/katex@${us}/dist/katex.min.css`,`sha384-zh0CIslj+VczCZtlzBcjt5ppRcsAmDnRem7ESsYwWwg3m/OaJ2l4x7YBZl9Kxxib`),d(`https://cdn.jsdelivr.net/npm/katex@${us}/dist/katex.min.js`,`sha384-Rma6DA2IPUwhNxmrB/7S3Tno0YY7sFu9WSYMCuulLhIqYSGZ2gKCJWIqhBWqMQfh`)]).then(()=>window.katex),f}let h=null;async function g(){return h||=d(`https://cdn.jsdelivr.net/npm/mermaid@${ds}/dist/mermaid.min.js`,`sha384-rbtjAdnIQE/aQJGEgXrVUlMibdfTSa4PQju4HDhN3sR2PmaKFzhEafuePsl9H/9I`).then(()=>window.mermaid),h}async function _(){if(!n.value)return;let e=n.value.querySelectorAll(`code.language-mermaid`);if(e.length)try{let t=await g();e.forEach(e=>{let n=e.closest(`pre`);if(!n||n.dataset.mermaidRendered)return;n.dataset.mermaidRendered=`1`;let r=document.createElement(`div`);r.className=`mermaid-container`,r.textContent=e.textContent,n.parentNode.replaceChild(r,n),t.run({nodes:[r]})})}catch(e){console.warn(`Mermaid failed to load/render:`,e?.message||e)}n.value.querySelectorAll(`img`).forEach(e=>{let t=e.getAttribute(`src`)||``;e.getAttribute(`alt`);let n=t.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([\w-]+)/);if(n){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://www.youtube.com/embed/${n[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}let r=t.match(/bilibili\.com\/video\/(BV[\w]+)/);if(r){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://player.bilibili.com/player.html?bvid=${r[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}});let t=/(\$\$[\s\S]+?\$\$|\$[^\s$](?:[^$]*[^\s$])?\$)/,r=document.createTreeWalker(n.value,NodeFilter.SHOW_TEXT),i=[],a;for(;a=r.nextNode();)!a.nodeValue||!t.test(a.nodeValue)||a.parentElement?.closest(`pre, code`)||i.push(a);if(i.length)try{let e=await m();for(let n of i){let r=document.createDocumentFragment();for(let i of n.nodeValue.split(t)){if(!i)continue;let t=i.startsWith(`$$`)&&i.endsWith(`$$`)&&i.length>3,n=!t&&i.startsWith(`$`)&&i.endsWith(`$`)&&i.length>2;if(!t&&!n){r.appendChild(document.createTextNode(i));continue}let a=i.slice(t?2:1,t?-2:-1),o=document.createElement(`span`);o.innerHTML=e.renderToString(a,{displayMode:t,throwOnError:!1}),r.appendChild(o)}n.parentNode.replaceChild(r,n)}}catch(e){console.warn(`KaTeX failed to load/render:`,e?.message||e)}}let y={"algo-viz--lc206":Ft,"algo-viz--lc21":nn,"algo-viz--lc23":Pn,"algo-viz--lc23dc":$n,"algo-viz--lc141":Er,"algo-viz--lc142":Br,"algo-viz--lc19":ai,"algo-viz--lc143":Ei,"algo-viz--lc234":Yi,"algo-viz--lc160":ba,"algo-viz--lc82":Wa,"algo-viz--lc102":ao,"algo-viz--lc236":bo,"algo-viz--lc124":No,"algo-viz--lc104":Ko,"algo-viz--lc226":os},b=[];function x(){b.forEach(e=>{try{e?.destroy?.()}catch(e){console.warn(`Algo viz teardown failed:`,e?.message||e)}}),b=[]}function T(){n.value&&(x(),n.value.querySelectorAll(`.algo-viz`).forEach(e=>{let t=Object.keys(y).find(t=>e.classList.contains(t));if(t)try{b.push(y[t](e))}catch(e){console.warn(`Algo viz failed to mount:`,t,e?.message||e)}}))}return a(()=>{o(()=>{T(),_(),s(),l()})}),C(x),p(()=>t.html,()=>{o(()=>{T(),_(),s(),l()})}),(e,t)=>(S(),c(`div`,{ref_key:`bodyRef`,ref:n,class:`markdown-body`,innerHTML:r.value},null,8,ss))}},[[`__scopeId`,`data-v-a7047795`]]);function ps(e){return T.get(`/articles/${e}/comments/`)}function ms(e,t){return T.post(`/articles/${e}/comments/`,t)}var hs={key:0,class:`form-title`},gs={key:1,class:`form-title`},_s={class:`form-field`},vs={key:0,class:`field-error`},ys={class:`form-field`},bs={key:0,class:`field-error`},xs={class:`hp-field`,"aria-hidden":`true`},Ss={class:`form-field`},Cs={key:0,class:`field-error`},ws={key:0,class:`submit-error`},Ts={key:1,class:`submit-success`},Es={class:`form-actions`},Ds=[`disabled`],Os={key:0,class:`spinner`},ks={key:1},As=y({__name:`CommentForm`,props:{articleSlug:{type:String,required:!0},parentId:{type:[Number,String],default:null}},emits:[`submitted`,`cancel`],setup(e,{emit:t}){let n=e,r=t,a=i({author_name:``,author_email:``,content:``,website:``}),o=i({author_name:``,author_email:``,content:``}),u=w(!1),d=w(null),p=w(!1);function m(){let e=!0;return o.author_name=``,o.author_email=``,o.content=``,a.author_name.trim()||(o.author_name=`请输入昵称`,e=!1),a.author_email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.author_email)||(o.author_email=`邮箱格式不正确`,e=!1):(o.author_email=`请输入邮箱`,e=!1),a.content.trim()?a.content.trim().length<3&&(o.content=`评论内容至少3个字符`,e=!1):(o.content=`请输入评论内容`,e=!1),e}function g(e){o[e]&&(o[e]=``),d.value=null}async function _(){if(m()){u.value=!0,d.value=null;try{let e={author_name:a.author_name.trim(),author_email:a.author_email.trim(),content:a.content.trim(),website:a.website};n.parentId&&(e.parent=n.parentId),await ms(n.articleSlug,e),p.value=!0,setTimeout(()=>{p.value=!1},3e3),r(`submitted`),a.author_name=``,a.author_email=``,a.content=``}catch(e){let t=e?.response?.data;if(typeof t==`object`&&t){let e=t;e.author_name&&(o.author_name=Array.isArray(e.author_name)?e.author_name[0]:e.author_name),e.author_email&&(o.author_email=Array.isArray(e.author_email)?e.author_email[0]:e.author_email),e.content&&(o.content=Array.isArray(e.content)?e.content[0]:e.content),e.detail&&(d.value=e.detail),e.non_field_errors&&(d.value=Array.isArray(e.non_field_errors)?e.non_field_errors[0]:e.non_field_errors)}else typeof t==`string`?d.value=t:d.value=e.message||`提交失败，请稍后重试`}finally{u.value=!1}}}return(t,n)=>(S(),c(`div`,{class:h([`comment-form`,{"reply-form":!!e.parentId}])},[e.parentId?(S(),c(`h4`,hs,`回复评论`)):(S(),c(`h4`,gs,`发表评论`)),s(`form`,{onSubmit:k(_,[`prevent`]),class:`form-body`},[s(`div`,_s,[f(s(`input`,{"onUpdate:modelValue":n[0]||=e=>a.author_name=e,type:`text`,placeholder:`昵称 *`,class:h([`form-input`,{"input-error":o.author_name}]),onInput:n[1]||=e=>g(`author_name`)},null,34),[[O,a.author_name]]),o.author_name?(S(),c(`p`,vs,l(o.author_name),1)):b(``,!0)]),s(`div`,ys,[f(s(`input`,{"onUpdate:modelValue":n[2]||=e=>a.author_email=e,type:`email`,placeholder:`邮箱 *`,class:h([`form-input`,{"input-error":o.author_email}]),onInput:n[3]||=e=>g(`author_email`)},null,34),[[O,a.author_email]]),o.author_email?(S(),c(`p`,bs,l(o.author_email),1)):b(``,!0)]),s(`div`,xs,[f(s(`input`,{"onUpdate:modelValue":n[4]||=e=>a.website=e,type:`text`,tabindex:`-1`,autocomplete:`off`},null,512),[[O,a.website]])]),s(`div`,Ss,[f(s(`textarea`,{"onUpdate:modelValue":n[5]||=e=>a.content=e,placeholder:`说点什么...`,rows:`4`,class:h([`form-textarea`,{"input-error":o.content}]),onInput:n[6]||=e=>g(`content`)},null,34),[[O,a.content]]),o.content?(S(),c(`p`,Cs,l(o.content),1)):b(``,!0)]),d.value?(S(),c(`p`,ws,l(d.value),1)):b(``,!0),p.value?(S(),c(`p`,Ts,`评论已提交！`)):b(``,!0),s(`div`,Es,[e.parentId?(S(),c(`button`,{key:0,type:`button`,class:`cancel-btn`,onClick:n[7]||=e=>t.$emit(`cancel`)},` 取消回复 `)):b(``,!0),s(`button`,{type:`submit`,class:`submit-btn`,disabled:u.value},[u.value?(S(),c(`span`,Os)):(S(),c(`span`,ks,`提交`))],8,Ds)])],32)],2))}},[[`__scopeId`,`data-v-49410be9`]]),js={class:`comment-list`},Ms={class:`comments-title`},Ns={key:0,class:`comments-count`},Ps={key:0,class:`skeleton-comments`},Fs={key:1,class:`empty-comments`},Is={key:2,class:`comments-tree`},Ls={class:`comment-main`},Rs={class:`comment-content`},zs={class:`comment-header`},Bs={class:`comment-author`},Vs={class:`comment-time`},Hs={class:`comment-text`},Us=[`onClick`],Ws={key:1,class:`replies`},Gs={class:`comment-main`},Ks={class:`comment-content`},qs={class:`comment-header`},Js={class:`comment-author`},Ys={class:`comment-time`},Xs={class:`comment-text`},Zs=y({__name:`CommentList`,props:{articleSlug:{type:String,required:!0}},setup(e){let t=e,n=w([]),i=w(!0),o=w(null),u=v(()=>n.value.filter(e=>!e.parent));function f(e){o.value=o.value===e?null:e}async function p(){i.value=!0;try{let e=await ps(t.articleSlug);n.value=e.data.results||e.data||[]}catch{n.value=[]}finally{i.value=!1}}function h(){o.value=null,p()}function y(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<1?`刚刚`:n<60?`${n}分钟前`:r<24?`${r}小时前`:i<30?`${i}天前`:i<365?`${Math.floor(i/30)}个月前`:`${Math.floor(i/365)}年前`}function C(e){let t=[`#3f6b57`,`#a45f45`,`#8a6c3f`,`#637b68`,`#7b6757`,`#4f7477`,`#8a635f`,`#6b7250`,`#536b5d`,`#9b704e`,`#65706a`,`#7b6a83`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}return a(p),(t,a)=>(S(),c(`div`,js,[s(`h3`,Ms,[a[1]||=g(` 评论 `,-1),n.value.length?(S(),c(`span`,Ns,`(`+l(n.value.length)+`)`,1)):b(``,!0)]),i.value?(S(),c(`div`,Ps,[(S(),c(d,null,r(3,e=>s(`div`,{key:e,class:`skeleton-comment`},[...a[2]||=[_(`<div class="skeleton-avatar" data-v-98dfce57></div><div class="skeleton-body" data-v-98dfce57><div class="skeleton-line w-30" data-v-98dfce57></div><div class="skeleton-line w-50" data-v-98dfce57></div><div class="skeleton-line w-80" data-v-98dfce57></div></div>`,2)]])),64))])):u.value.length?(S(),c(`div`,Is,[(S(!0),c(d,null,r(u.value,t=>(S(),c(`div`,{key:t.id,class:`comment-item`},[s(`div`,Ls,[s(`div`,{class:`comment-avatar`,style:x({background:C(t.author_name)})},l(t.author_name?t.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,Rs,[s(`div`,zs,[s(`span`,Bs,l(t.author_name),1),s(`span`,Vs,l(y(t.created_at)),1)]),s(`p`,Hs,l(t.content),1),s(`button`,{class:`reply-btn`,onClick:e=>f(t.id)},[...a[4]||=[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 17 4 12 9 7`}),s(`path`,{d:`M20 18v-2a4 4 0 0 0-4-4H4`})],-1),g(` 回复 `,-1)]],8,Us)])]),o.value===t.id?(S(),m(As,{key:0,"article-slug":e.articleSlug,"parent-id":t.id,onSubmitted:h,onCancel:a[0]||=e=>o.value=null,class:`reply-form-wrapper`},null,8,[`article-slug`,`parent-id`])):b(``,!0),t.replies&&t.replies.length?(S(),c(`div`,Ws,[(S(!0),c(d,null,r(t.replies,e=>(S(),c(`div`,{key:e.id,class:`comment-item reply-item`},[s(`div`,Gs,[s(`div`,{class:`comment-avatar comment-avatar-sm`,style:x({background:C(e.author_name)})},l(e.author_name?e.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,Ks,[s(`div`,qs,[s(`span`,Js,l(e.author_name),1),s(`span`,Ys,l(y(e.created_at)),1)]),s(`p`,Xs,l(e.content),1)])])]))),128))])):b(``,!0)]))),128))])):(S(),c(`div`,Fs,[...a[3]||=[s(`svg`,{width:`40`,height:`40`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z`})],-1),s(`p`,null,`暂无评论，来说点什么吧`,-1)]]))]))}},[[`__scopeId`,`data-v-98dfce57`]]),Qs={key:0,class:`toc-list-wrapper`},$s={class:`toc-list`},ec=[`href`,`title`,`onClick`],tc={class:`toc-text`},nc={key:1,class:`toc-empty-state`},rc=y({__name:`TocNav`,props:{html:{type:String,default:``}},setup(e){let t=e,n=w([]),i=w(null),u=null,f=[];function m(){if(!t.html){n.value=[];return}try{let e=new DOMParser().parseFromString(t.html,`text/html`),r=[];e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let n=e.id||`toc-heading-${t}`;r.push({id:n,tag:e.tagName.toLowerCase(),text:e.textContent||``})}),n.value=r}catch{n.value=[]}}function g(){if(!n.value.length)return;let e=document.querySelector(`.markdown-body`);e&&e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let r=n.value[t];r&&!e.id&&(e.id=r.id)})}function _(){u&&=(u.disconnect(),null),f=[],n.value.length&&(u=new IntersectionObserver(e=>{let t=e.filter(e=>e.isIntersecting);t.length?i.value=t[0].target.id:window.scrollY<100&&(i.value=n.value[0]?.id||null)},{rootMargin:`-80px 0px -60% 0px`,threshold:0}),o(()=>{n.value.forEach(e=>{let t=document.getElementById(e.id);t&&(u.observe(t),f.push(t))})}))}function v(e){let t=document.getElementById(e);t&&(t.scrollIntoView({behavior:`smooth`,block:`start`}),i.value=e)}return p(()=>t.html,()=>{m(),o(()=>{g(),_()})}),a(()=>{m(),o(()=>{g(),_()})}),C(()=>{u&&u.disconnect()}),(e,t)=>(S(),c(`nav`,{class:h([`toc-nav`,{"toc-empty":!n.value.length}])},[t[2]||=s(`h4`,{class:`toc-title`},`目录`,-1),n.value.length?(S(),c(`div`,Qs,[s(`ul`,$s,[(S(!0),c(d,null,r(n.value,e=>(S(),c(`li`,{key:e.id,class:h([`toc-item`,[`toc-depth-${e.tag}`,{"toc-active":i.value===e.id}]])},[s(`a`,{href:`#`+e.id,class:`toc-link`,title:e.text,onClick:k(t=>v(e.id),[`prevent`])},[t[0]||=s(`span`,{class:`toc-dot`},null,-1),s(`span`,tc,l(e.text),1)],8,ec)],2))),128))])])):(S(),c(`div`,nc,[...t[1]||=[s(`p`,null,`无目录`,-1)]]))],2))}},[[`__scopeId`,`data-v-21d21cb1`]]),ic={class:`share-buttons`},ac={key:0,class:`copy-feedback`},oc=y({__name:`ShareButtons`,props:{title:{type:String,default:``},url:{type:String,default:``}},setup(e){let t=e,n=w(!1);function r(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://service.weibo.com/share/share.php?url=${e}&title=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function i(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://twitter.com/intent/tweet?url=${e}&text=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function a(){alert(`请复制链接后在微信中粘贴发送`)}async function o(){try{await navigator.clipboard.writeText(t.url||window.location.href),n.value=!0,setTimeout(()=>n.value=!1,2e3)}catch{let e=document.createElement(`textarea`);e.value=t.url||window.location.href,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),n.value=!0,setTimeout(()=>n.value=!1,2e3)}}return(e,t)=>(S(),c(`div`,ic,[t[4]||=s(`span`,{class:`share-label`},`分享：`,-1),s(`button`,{class:`share-btn wechat`,title:`微信`,onClick:a},[...t[0]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178A1.17 1.17 0 0 1 4.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178 1.17 1.17 0 0 1-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229.826 0 1.622-.12 2.361-.336a.722.722 0 0 1 .598.082l1.584.926a.272.272 0 0 0 .14.045c.136 0 .241-.11.241-.245 0-.06-.024-.12-.04-.178l-.325-1.233a.49.49 0 0 1 .178-.554C23.028 18.48 24 16.82 24 14.98c0-3.21-2.931-5.952-7.062-6.122zm-2.18 2.769c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982zm4.844 0c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982z`})],-1)]]),s(`button`,{class:`share-btn weibo`,title:`微博`,onClick:r},[...t[1]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M10.098 20.323c-3.977.391-7.414-1.406-7.672-4.02-.259-2.609 2.759-5.047 6.74-5.441 3.979-.394 7.413 1.404 7.671 4.018.259 2.6-2.759 5.049-6.739 5.443zm-7.317-6.781c-1.059-.2-1.911.419-1.903 1.383.008.964.87 1.907 1.93 2.107 1.058.2 1.91-.419 1.903-1.383-.008-.964-.87-1.907-1.93-2.107zm2.13 3.68c-.563-.249-.754-.766-.428-1.153.326-.388 1.019-.523 1.58-.275.56.248.753.764.429 1.153-.326.386-1.018.524-1.581.275zm.992-3.808c-2.07-.028-4.538.537-7.344 2.641C-.405 17.1-.279 19.15.35 20.49c.528 1.123 1.494 1.773 2.43 2.144 4.878 1.935 10.857.606 13.679-1.35 2.934-2.035 4.033-4.771 3.157-7.165-.516-1.405-1.797-2.398-3.31-2.882l.06-.05c2.485-2.08 4.213-4.585 4.213-7.146 0-5.213-7.11-7.735-10.966-5.371-1.742 1.07-2.772 2.788-3.064 4.72.422-.12.865-.197 1.323-.23 3.271-.241 7.273.776 7.273 3.86 0 3.502-3.823 4.667-6.721 4.667-.89 0-1.785-.215-2.595-.598z`})],-1)]]),s(`button`,{class:`share-btn twitter`,title:`Twitter`,onClick:i},[...t[2]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z`})],-1)]]),s(`button`,{class:`share-btn copy`,title:`复制链接`,onClick:o},[...t[3]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71`}),s(`path`,{d:`M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71`})],-1)]]),n.value?(S(),c(`span`,ac,`已复制`)):b(``,!0)]))}},[[`__scopeId`,`data-v-857c6fb5`]]),sc={key:0,class:`related-section`},cc={class:`related-grid`},lc={key:0,class:`related-cover`},uc=[`src`,`alt`],dc={class:`related-card-title`},fc=y({__name:`RelatedArticles`,props:{articles:{type:Array,default:()=>[]}},setup(t){return(i,a)=>{let o=n(`router-link`);return t.articles.length?(S(),c(`section`,sc,[a[0]||=s(`h3`,{class:`related-title`},`相关文章`,-1),s(`div`,cc,[(S(!0),c(d,null,r(t.articles,t=>(S(),m(o,{key:t.slug,to:`/article/`+t.slug,class:`related-card`},{default:e(()=>[t.cover_image?(S(),c(`div`,lc,[s(`img`,{src:t.cover_image,alt:t.title,loading:`lazy`},null,8,uc)])):b(``,!0),s(`span`,dc,l(t.title),1)]),_:2},1032,[`to`]))),128))])])):b(``,!0)}}},[[`__scopeId`,`data-v-e3d8298c`]]),pc={class:`newsletter glass-card`},mc=[`disabled`],hc=[`disabled`],gc={key:0},_c={key:1},vc={key:2},yc=y({__name:`NewsletterForm`,setup(e){let t=w(``),n=w(!1),r=w(!1),i=w(``),a=w(``);async function o(){if(t.value.trim()){n.value=!0,i.value=``;try{let e=await T.post(`/subscribe/`,{email:t.value.trim()});r.value=!0,i.value=e.data.detail||`订阅成功！`,a.value=`msg-success`}catch(e){let t=e?.response?.data?.error||e?.response?.data?.detail||`订阅失败`;i.value=typeof t==`string`?t:`订阅失败，请稍后重试`,a.value=`msg-error`}finally{n.value=!1}}}return(e,u)=>(S(),c(`div`,pc,[u[1]||=_(`<h4 class="newsletter-title" data-v-54a32a66><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-54a32a66><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" data-v-54a32a66></path><polyline points="22,6 12,13 2,6" data-v-54a32a66></polyline></svg> 订阅更新 </h4><p class="newsletter-desc" data-v-54a32a66>新文章发布时，通过邮件通知你</p>`,2),s(`form`,{onSubmit:k(o,[`prevent`]),class:`newsletter-form`},[f(s(`input`,{"onUpdate:modelValue":u[0]||=e=>t.value=e,type:`email`,placeholder:`your@email.com`,class:`newsletter-input`,disabled:r.value,required:``},null,8,mc),[[O,t.value]]),s(`button`,{type:`submit`,class:`newsletter-btn`,disabled:n.value||r.value},[n.value?(S(),c(`span`,gc,`...`)):r.value?(S(),c(`span`,_c,`✓`)):(S(),c(`span`,vc,`订阅`))],8,hc)],32),i.value?(S(),c(`p`,{key:0,class:h(a.value)},l(i.value),3)):b(``,!0)]))}},[[`__scopeId`,`data-v-54a32a66`]]),bc=`个人博客Blog`,xc=`Zhou Jun 的个人博客 — 技术、编程、AI 与科学`;function Sc(e={}){let{title:t=bc,description:n=xc,image:r=``,url:i=window.location.href}=e,a=t===`个人博客Blog`?t:`${t} | ${bc}`;document.title=a;let o=(e,t,n=!1)=>{if(!t)return;let r=n?`name`:`property`,i=document.querySelector(`meta[${r}="${e}"]`);i||(i=document.createElement(`meta`),i.setAttribute(r,e),document.head.appendChild(i)),i.setAttribute(`content`,t)};o(`description`,n,!0),o(`og:title`,a),o(`og:description`,n),o(`og:image`,r),o(`og:url`,i),o(`og:type`,`article`),o(`twitter:card`,r?`summary_large_image`:`summary`),o(`twitter:title`,a),o(`twitter:description`,n),o(`twitter:image`,r),((e,t)=>{if(!t)return;let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement(`link`),n.setAttribute(`rel`,e),document.head.appendChild(n)),n.setAttribute(`href`,t)})(`canonical`,i)}var Cc={title:bc,description:xc,image:``,url:``};function wc(){Sc({...Cc,url:window.location.origin+`/`});let e=document.querySelector(`meta[property="og:type"]`);e&&e.setAttribute(`content`,`website`);let t=document.querySelector(`link[rel="canonical"]`);t&&t.setAttribute(`href`,window.location.origin+`/`)}function Tc(e){if(!e)return 1;let t=(e.match(/[一-鿿㐀-䶿]/g)||[]).length+(e.match(/[a-zA-Z]+/g)||[]).length;return Math.max(1,Math.ceil(t/250))}function Ec(e){return e?e.replace(/```[\s\S]*?```/g,``).replace(/`[^`]*`/g,``).replace(/!\[.*?\]\(.*?\)/g,``).replace(/\[([^\]]*)\]\(.*?\)/g,`$1`).replace(/[#*>`~\-+|_:]/g,` `).replace(/\s+/g,` `).trim():``}var Dc={class:`page page-article-detail`},Oc={key:0,class:`detail-skeleton`},kc={key:1,class:`error-state`},Ac={key:2,class:`detail-layout`},jc={class:`detail-main`},Mc={class:`article-header`},Nc={class:`article-title`},Pc={class:`article-meta`},Fc={class:`meta-item meta-author`},Ic={class:`meta-item meta-date`},Lc={key:0,class:`meta-item meta-category neon-text-pink`},Rc={class:`meta-item meta-reading-time`},zc={class:`meta-item meta-views`},Bc={key:0,class:`article-tags`},Vc={key:0,class:`article-cover`},Hc=[`src`,`alt`],Uc={key:1,class:`article-nav`},Wc={class:`nav-title`},Gc={class:`nav-title`},Kc={class:`article-actions`},qc=[`disabled`],Jc={class:`comment-section`},Yc={class:`detail-sidebar`},Xc=y({__name:`ArticleDetail`,setup(i){let o=E();D();let f=N(),y=w(null),x=w(!0),C=w(null),O=w(null),k=w(0),P=0,F=v(()=>y.value?.created_at?new Date(y.value.created_at).toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}):``),I=v(()=>M(y.value?.author)),L=v(()=>j(y.value?.category)),R=v(()=>{let e=y.value?.tags;return!e||!Array.isArray(e)?[]:e.map(A).filter(Boolean)}),z=w(!1),B=w(!1),V=v(()=>window.location.origin+o.fullPath),H=v(()=>y.value?y.value.reading_time?y.value.reading_time:Tc(Ec(y.value.content||``)):1),ee=v(()=>y.value?JSON.stringify({"@context":`https://schema.org`,"@type":`Article`,headline:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||void 0,datePublished:y.value.created_at,dateModified:y.value.updated_at,author:{"@type":`Person`,name:`Zhou Jun`},publisher:{"@type":`Person`,name:`Zhou Jun`}}):``),te=null;p(ee,e=>{if(!e){te?.remove(),te=null;return}te||(te=document.createElement(`script`),te.type=`application/ld+json`,te.dataset.articleJsonLd=`1`,document.head.appendChild(te)),te.textContent=e},{immediate:!0});async function U(){if(!(z.value||B.value)){B.value=!0;try{let e=await T.post(`/articles/${y.value.slug}/like/`);y.value&&(y.value.likes_count=e.data.likes_count),z.value=!0}catch{}finally{B.value=!1}}}async function W(){let e=o.params.slug,t=++P;if(!e){C.value=`缺少文章标识`,O.value=null,x.value=!1;return}x.value=!0,C.value=null,O.value=null,y.value=null,z.value=!1;try{let n=f.getArticleBySlug(e);if(n){if(t!==P)return;y.value=n,x.value=!1,G();return}let r=await f.fetchArticleBySlug(e);if(t!==P)return;y.value=r,y.value?G():C.value=`文章不存在`}catch(e){if(t!==P)return;O.value=e?.response?.status??null,O.value===404?C.value=`文章不存在`:C.value=e?.response?.data?.detail||e.message||`加载文章失败`}finally{t===P&&(x.value=!1)}}function G(){y.value&&Sc({title:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||``,url:window.location.origin+o.fullPath})}return a(W),p(()=>o.params.slug,()=>{window.scrollTo({top:0,behavior:`instant`}),k.value++,W()}),t(()=>{wc(),te?.remove(),te=null}),(t,i)=>{let a=n(`router-link`);return S(),c(`div`,Dc,[x.value?(S(),c(`div`,Oc,[...i[1]||=[_(`<div class="skeleton-header" data-v-c0862088><div class="skeleton-line w-80 skeleton-lg" data-v-c0862088></div><div class="skeleton-meta-row" data-v-c0862088><div class="skeleton-line w-20" data-v-c0862088></div><div class="skeleton-line w-15" data-v-c0862088></div><div class="skeleton-line w-10" data-v-c0862088></div></div></div><div class="skeleton-body" data-v-c0862088><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-90" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-70" data-v-c0862088></div></div>`,2)]])):C.value?(S(),c(`div`,kc,[i[3]||=s(`svg`,{width:`48`,height:`48`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`line`,{x1:`12`,y1:`8`,x2:`12`,y2:`12`}),s(`line`,{x1:`12`,y1:`16`,x2:`12.01`,y2:`16`})],-1),s(`h2`,null,l(O.value===404?`文章不存在`:`加载失败`),1),s(`p`,null,l(C.value),1),u(a,{to:`/articles`,class:`back-link`},{default:e(()=>[...i[2]||=[g(`返回首页`,-1)]]),_:1})])):y.value?(S(),c(`div`,Ac,[s(`article`,jc,[s(`header`,Mc,[s(`h1`,Nc,l(y.value.title),1),s(`div`,Pc,[s(`span`,Fc,[i[4]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2`}),s(`circle`,{cx:`12`,cy:`7`,r:`4`})],-1),g(` `+l(I.value),1)]),s(`span`,Ic,[i[5]||=_(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-c0862088><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-c0862088></rect><line x1="16" y1="2" x2="16" y2="6" data-v-c0862088></line><line x1="8" y1="2" x2="8" y2="6" data-v-c0862088></line><line x1="3" y1="10" x2="21" y2="10" data-v-c0862088></line></svg>`,1),g(` `+l(F.value),1)]),y.value.category?(S(),c(`span`,Lc,[i[6]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z`})],-1),g(` `+l(L.value),1)])):b(``,!0),s(`span`,Rc,[i[7]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`polyline`,{points:`12 6 12 12 16 14`})],-1),g(` 约 `+l(H.value)+` 分钟 `,1)]),s(`span`,zc,[i[8]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z`}),s(`circle`,{cx:`12`,cy:`12`,r:`3`})],-1),g(` `+l(y.value.views_count||0),1)])]),R.value.length?(S(),c(`div`,Bc,[(S(!0),c(d,null,r(R.value,(e,t)=>(S(),c(`span`,{key:t,class:`tag-pill`},l(e),1))),128))])):b(``,!0)]),y.value.cover_image?(S(),c(`div`,Vc,[s(`img`,{src:y.value.cover_image,alt:y.value.title},null,8,Hc)])):b(``,!0),u(fs,{html:y.value.html_content||y.value.content||``,title:y.value.title},null,8,[`html`,`title`]),y.value.prev_article||y.value.next_article?(S(),c(`nav`,Uc,[y.value.prev_article?(S(),m(a,{key:0,to:`/article/`+(y.value.prev_article.slug||y.value.prev_article),class:`nav-link prev-link`},{default:e(()=>[i[9]||=s(`span`,{class:`nav-direction`},[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`15 18 9 12 15 6`})]),g(` 上一篇 `)],-1),s(`span`,Wc,l(y.value.prev_article.title||y.value.prev_article),1)]),_:1},8,[`to`])):b(``,!0),y.value.next_article?(S(),m(a,{key:1,to:`/article/`+(y.value.next_article.slug||y.value.next_article),class:`nav-link next-link`},{default:e(()=>[i[10]||=s(`span`,{class:`nav-direction`},[g(` 下一篇 `),s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 18 15 12 9 6`})])],-1),s(`span`,Gc,l(y.value.next_article.title||y.value.next_article),1)]),_:1},8,[`to`])):b(``,!0)])):b(``,!0),s(`div`,Kc,[u(oc,{title:y.value.title,url:V.value},null,8,[`title`,`url`]),s(`button`,{class:h([`like-btn`,{liked:z.value}]),disabled:B.value,onClick:U},[i[11]||=s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z`})],-1),s(`span`,null,l(y.value.likes_count||0),1)],10,qc)]),u(fc,{articles:y.value.related_articles||[]},null,8,[`articles`]),u(yc),s(`section`,Jc,[(S(),m(Zs,{"article-slug":y.value.slug,key:k.value},null,8,[`article-slug`])),u(As,{"article-slug":y.value.slug,onSubmitted:i[0]||=e=>k.value++},null,8,[`article-slug`])])]),s(`aside`,Yc,[u(rc,{html:y.value.html_content||y.value.content||``},null,8,[`html`])])])):b(``,!0)])}}},[[`__scopeId`,`data-v-c0862088`]]);export{Xc as default};