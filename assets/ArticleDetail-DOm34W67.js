import{A as e,C as t,D as n,E as r,R as i,S as a,b as o,c as s,d as c,dt as l,h as u,i as d,j as f,k as p,l as m,lt as h,m as g,p as _,s as v,t as y,u as b,ut as x,w as S,x as C,z as w}from"./_plugin-vue_export-helper-BK47PYcU.js";import{t as T}from"./client-DyaaoQco.js";import{f as E,p as D,v as O,y as k}from"./index-QCsxm8ZK.js";import{i as A,n as j,t as ee}from"./labels-H7OcNmBE.js";import{t as te}from"./article-DGXJ8j-d.js";function M(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function ne(e){if(Array.isArray(e))return e}function N(e,t){var n=e==null?null:typeof Symbol<`u`&&e[Symbol.iterator]||e[`@@iterator`];if(n!=null){var r,i,a,o,s=[],c=!0,l=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(c=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);c=!0);}catch(e){l=!0,i=e}finally{try{if(!c&&n.return!=null&&(o=n.return(),Object(o)!==o))return}finally{if(l)throw i}}return s}}function re(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function P(e,t){return ne(e)||N(e,t)||F(e,t)||re()}function F(e,t){if(e){if(typeof e==`string`)return M(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?M(e,t):void 0}}var ie=Object.entries,ae=Object.setPrototypeOf,oe=Object.isFrozen,se=Object.getPrototypeOf,I=Object.getOwnPropertyDescriptor,L=Object.freeze,R=Object.seal,ce=Object.create,le=typeof Reflect<`u`&&Reflect,ue=le.apply,z=le.construct;L||=function(e){return e},R||=function(e){return e},ue||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},z||=function(e){return new e(...[...arguments].slice(1))};var de=W(Array.prototype.forEach),fe=W(Array.prototype.lastIndexOf),pe=W(Array.prototype.pop),me=W(Array.prototype.push),he=W(Array.prototype.splice),ge=Array.isArray,_e=W(String.prototype.toLowerCase),ve=W(String.prototype.toString),ye=W(String.prototype.match),be=W(String.prototype.replace),xe=W(String.prototype.indexOf),Se=W(String.prototype.trim),Ce=W(Number.prototype.toString),B=W(Boolean.prototype.toString),we=typeof BigInt>`u`?null:W(BigInt.prototype.toString),V=typeof Symbol>`u`?null:W(Symbol.prototype.toString),H=W(Object.prototype.hasOwnProperty),Te=W(Object.prototype.toString),U=W(RegExp.prototype.test),Ee=De(TypeError);function W(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return ue(e,t,n)}}function De(e){return function(){return z(e,[...arguments])}}function G(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:_e;if(ae&&ae(e,null),!ge(t))return e;let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(oe(t)||(t[r]=e),i=e)}e[i]=!0}return e}function Oe(e){for(let t=0;t<e.length;t++)H(e,t)||(e[t]=null);return e}function K(e){let t=ce(null);for(let r of ie(e)){var n=P(r,2);let i=n[0],a=n[1];H(e,i)&&(ge(a)?t[i]=Oe(a):a&&typeof a==`object`&&a.constructor===Object?t[i]=K(a):t[i]=a)}return t}function ke(e){switch(typeof e){case`string`:return e;case`number`:return Ce(e);case`boolean`:return B(e);case`bigint`:return we?we(e):`0`;case`symbol`:return V?V(e):`Symbol()`;case`undefined`:return Te(e);case`function`:case`object`:{if(e===null)return Te(e);let t=e,n=Ae(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:Te(e)}return Te(e)}default:return Te(e)}}function Ae(e,t){for(;e!==null;){let n=I(e,t);if(n){if(n.get)return W(n.get);if(typeof n.value==`function`)return W(n.value)}e=se(e)}function n(){return null}return n}function je(e){try{return U(e,``),!0}catch{return!1}}var Me=L(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),Ne=L(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),Pe=L([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),Fe=L([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),Ie=L(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),Le=L([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),Re=L([`#text`]),ze=L(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),Be=L(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dominant-baseline.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-orientation.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),Ve=L(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),He=L([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),Ue=R(/{{[\w\W]*|^[\w\W]*}}/g),We=R(/<%[\w\W]*|^[\w\W]*%>/g),Ge=R(/\${[\w\W]*/g),Ke=R(/^data-[\-\w.\u00B7-\uFFFF]+$/),qe=R(/^aria-[\-\w]+$/),Je=R(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ye=R(/^(?:\w+script|data):/i),Xe=R(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ze=R(/^html$/i),Qe=R(/^[a-z][.\w]*(-[.\w]+)+$/i),$e=R(/<[/\w!]/g),et=R(/<[/\w]/g),tt=R(/<\/no(script|embed|frames)/i),nt=R(/\/>/i),q={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},rt=function(){return typeof window>`u`?null:window},it=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},at=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},ot=function(e,t,n,r){return H(e,t)&&ge(e[t])?G(r.base?K(r.base):{},e[t],r.transform):n};function st(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:rt(),t=e=>st(e);if(t.version=`3.4.12`,t.removed=[],!e||!e.document||e.document.nodeType!==q.document||!e.Element)return t.isSupported=!1,t;let n=e.document,r=n,i=r.currentScript;e.DocumentFragment;let a=e.HTMLTemplateElement,o=e.Node,s=e.Element,c=e.NodeFilter;e.NamedNodeMap===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;let l=e.DOMParser,u=e.trustedTypes,d=s.prototype,f=Ae(d,`cloneNode`),p=Ae(d,`remove`),m=Ae(d,`nextSibling`),h=Ae(d,`childNodes`),g=Ae(d,`parentNode`),_=Ae(d,`shadowRoot`),v=Ae(d,`attributes`),y=o&&o.prototype?Ae(o.prototype,`nodeType`):null,b=o&&o.prototype?Ae(o.prototype,`nodeName`):null;if(typeof a==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let x,S=``,C,w=!1,T=0,E=function(){if(T>0)throw Ee(`A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.`)},D=function(e){E(),T++;try{return x.createHTML(e)}finally{T--}},O=function(e){E(),T++;try{return x.createScriptURL(e)}finally{T--}},k=function(){return w||=(C=it(u,i),!0),C},A=n,j=A.implementation,ee=A.createNodeIterator,te=A.createDocumentFragment,M=A.getElementsByTagName,ne=r.importNode,N=at();t.isSupported=typeof ie==`function`&&typeof g==`function`&&j&&j.createHTMLDocument!==void 0;let re=Ue,P=We,F=Ge,ae=Ke,oe=qe,se=Ye,I=Xe,le=Qe,ue=Je,z=null,Ce=G({},[...Me,...Ne,...Pe,...Ie,...Re]),B=null,we=G({},[...ze,...Be,...Ve,...He]),V=Object.seal(ce(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Te=null,W=null,De=Object.seal(ce(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),Oe=!0,ct=!0,lt=!1,ut=!0,dt=!1,ft=!0,J=!1,pt=!1,mt=null,ht=null,gt=!1,Y=!1,_t=!1,vt=!1,yt=!0,bt=!1,xt=`user-content-`,St=!0,Ct=!1,wt={},X=null,Tt=G({},`annotation-xml.audio.colgroup.desc.foreignobject.head.iframe.math.mi.mn.mo.ms.mtext.noembed.noframes.noscript.plaintext.script.selectedcontent.style.svg.template.thead.title.video.xmp`.split(`.`)),Et=null,Dt=G({},[`audio`,`video`,`img`,`source`,`image`,`track`]),Ot=null,kt=G({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),At=`http://www.w3.org/1998/Math/MathML`,jt=`http://www.w3.org/2000/svg`,Mt=`http://www.w3.org/1999/xhtml`,Nt=Mt,Pt=!1,Ft=null,It=G({},[At,jt,Mt],ve),Lt=L([`mi`,`mo`,`mn`,`ms`,`mtext`]),Z=G({},Lt),Rt=L([`annotation-xml`]),zt=G({},Rt),Bt=G({},[`title`,`style`,`font`,`a`,`script`]),Vt=null,Ht=[`application/xhtml+xml`,`text/html`],Q=null,Ut=null,Wt=n.createElement(`form`),Gt=function(e){return e instanceof RegExp||e instanceof Function},Kt=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ut&&Ut===e)return;(!e||typeof e!=`object`)&&(e={}),e=K(e),Vt=Ht.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,Q=Vt===`application/xhtml+xml`?ve:_e,z=ot(e,`ALLOWED_TAGS`,Ce,{transform:Q}),B=ot(e,`ALLOWED_ATTR`,we,{transform:Q}),Ft=ot(e,`ALLOWED_NAMESPACES`,It,{transform:ve}),Ot=ot(e,`ADD_URI_SAFE_ATTR`,kt,{transform:Q,base:kt}),Et=ot(e,`ADD_DATA_URI_TAGS`,Dt,{transform:Q,base:Dt}),X=ot(e,`FORBID_CONTENTS`,Tt,{transform:Q}),Te=ot(e,`FORBID_TAGS`,K({}),{transform:Q}),W=ot(e,`FORBID_ATTR`,K({}),{transform:Q}),wt=H(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?K(e.USE_PROFILES):e.USE_PROFILES:!1,Oe=e.ALLOW_ARIA_ATTR!==!1,ct=e.ALLOW_DATA_ATTR!==!1,lt=e.ALLOW_UNKNOWN_PROTOCOLS||!1,ut=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,dt=e.SAFE_FOR_TEMPLATES||!1,ft=e.SAFE_FOR_XML!==!1,J=e.WHOLE_DOCUMENT||!1,Y=e.RETURN_DOM||!1,_t=e.RETURN_DOM_FRAGMENT||!1,vt=e.RETURN_TRUSTED_TYPE||!1,gt=e.FORCE_BODY||!1,yt=e.SANITIZE_DOM!==!1,bt=e.SANITIZE_NAMED_PROPS||!1,St=e.KEEP_CONTENT!==!1,Ct=e.IN_PLACE||!1,ue=je(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:Je,Nt=typeof e.NAMESPACE==`string`?e.NAMESPACE:Mt,Z=H(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?K(e.MATHML_TEXT_INTEGRATION_POINTS):G({},Lt),zt=H(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?K(e.HTML_INTEGRATION_POINTS):G({},Rt);let t=H(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?K(e.CUSTOM_ELEMENT_HANDLING):ce(null);if(V=ce(null),H(t,`tagNameCheck`)&&Gt(t.tagNameCheck)&&(V.tagNameCheck=t.tagNameCheck),H(t,`attributeNameCheck`)&&Gt(t.attributeNameCheck)&&(V.attributeNameCheck=t.attributeNameCheck),H(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(V.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),R(V),dt&&(ct=!1),_t&&(Y=!0),wt&&(z=G({},Re),B=ce(null),wt.html===!0&&(G(z,Me),G(B,ze)),wt.svg===!0&&(G(z,Ne),G(B,Be),G(B,He)),wt.svgFilters===!0&&(G(z,Pe),G(B,Be),G(B,He)),wt.mathMl===!0&&(G(z,Ie),G(B,Ve),G(B,He))),De.tagCheck=null,De.attributeCheck=null,H(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?De.tagCheck=e.ADD_TAGS:ge(e.ADD_TAGS)&&(z===Ce&&(z=K(z)),G(z,e.ADD_TAGS,Q))),H(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?De.attributeCheck=e.ADD_ATTR:ge(e.ADD_ATTR)&&(B===we&&(B=K(B)),G(B,e.ADD_ATTR,Q))),H(e,`ADD_URI_SAFE_ATTR`)&&ge(e.ADD_URI_SAFE_ATTR)&&G(Ot,e.ADD_URI_SAFE_ATTR,Q),H(e,`FORBID_CONTENTS`)&&ge(e.FORBID_CONTENTS)&&(X===Tt&&(X=K(X)),G(X,e.FORBID_CONTENTS,Q)),H(e,`ADD_FORBID_CONTENTS`)&&ge(e.ADD_FORBID_CONTENTS)&&(X===Tt&&(X=K(X)),G(X,e.ADD_FORBID_CONTENTS,Q)),St&&(z[`#text`]=!0),J&&G(z,[`html`,`head`,`body`]),z.table&&(G(z,[`tbody`]),delete Te.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw Ee(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw Ee(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);let t=x;x=e.TRUSTED_TYPES_POLICY;try{S=D(``)}catch(e){throw x=t,e}}else e.TRUSTED_TYPES_POLICY===null?(x=void 0,S=``):(x===void 0&&(x=k()),x&&typeof S==`string`&&(S=D(``)));L&&L(e),Ut=e},qt=G({},[...Ne,...Pe,...Fe]),Jt=G({},[...Ie,...Le]),Yt=function(e,t,n){return t.namespaceURI===Mt?e===`svg`:t.namespaceURI===At?e===`svg`&&(n===`annotation-xml`||Z[n]):!!qt[e]},Xt=function(e,t,n){return t.namespaceURI===Mt?e===`math`:t.namespaceURI===jt?e===`math`&&zt[n]:!!Jt[e]},Zt=function(e,t,n){return t.namespaceURI===jt&&!zt[n]||t.namespaceURI===At&&!Z[n]?!1:!Jt[e]&&(Bt[e]||!qt[e])},Qt=function(e){let t=g(e);(!t||!t.tagName)&&(t={namespaceURI:Nt,tagName:`template`});let n=_e(e.tagName),r=_e(t.tagName);return Ft[e.namespaceURI]?e.namespaceURI===jt?Yt(n,t,r):e.namespaceURI===At?Xt(n,t,r):e.namespaceURI===Mt?Zt(n,t,r):!!(Vt===`application/xhtml+xml`&&Ft[e.namespaceURI]):!1},$t=function(e){me(t.removed,{element:e});try{g(e).removeChild(e)}catch{if(p(e),!g(e))throw Ee(`a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place`)}},en=function(e){rn(e);let t=h(e);if(t){let e=[];de(t,t=>{me(e,t)}),de(e,e=>{try{p(e)}catch{}})}let n=v(e);if(n)for(let t=n.length-1;t>=0;--t){let r=n[t],i=r&&r.name;if(typeof i==`string`)try{e.removeAttribute(i)}catch{}}},tn=function(e,n){try{me(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{me(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(Y||_t)try{$t(n)}catch{}else try{n.setAttribute(e,``)}catch{}},nn=function(e){let t=v(e);if(t)for(let n=t.length-1;n>=0;--n){let r=t[n],i=r&&r.name;if(!(typeof i!=`string`||B[Q(i)]))try{e.removeAttribute(i)}catch{}}},rn=function(e){let t=[e];for(;t.length>0;){let e=t.pop();(y?y(e):e.nodeType)===q.element&&nn(e);let n=h(e);if(n)for(let e=n.length-1;e>=0;--e)t.push(n[e])}},an=function(e){if(!ft)return;let t=[e];for(;t.length>0;){let e=t.pop(),n=y?y(e):e.nodeType;if(n===q.processingInstruction||n===q.comment&&U(et,e.data)){try{p(e)}catch{}continue}if(n===q.element){let t=e,n=Q(b?b(e):e.nodeName);try{t.hasAttribute&&t.hasAttribute(`patchsrc`)&&t.removeAttribute(`patchsrc`),t.hasAttribute&&t.hasAttribute(`for`)&&n!==`label`&&n!==`output`&&t.removeAttribute(`for`)}catch{}}let r=h(e);if(r)for(let e=r.length-1;e>=0;--e)t.push(r[e])}},on=function(e){let t=null,r=null;if(gt)e=`<remove></remove>`+e;else{let t=ye(e,/^[\r\n\t ]+/);r=t&&t[0]}Vt===`application/xhtml+xml`&&Nt===Mt&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=x?D(e):e;if(Nt===Mt)try{t=new l().parseFromString(i,Vt)}catch{}if(!t||!t.documentElement){t=j.createDocument(Nt,`template`,null);try{t.documentElement.innerHTML=Pt?S:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),Nt===Mt?M.call(t,J?`html`:`body`)[0]:J?t.documentElement:a},sn=function(e){return ee.call(e.ownerDocument||e,e,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},cn=function(e){return e=be(e,re,` `),e=be(e,P,` `),e=be(e,F,` `),e},ln=function(e){e.normalize();let t=ee.call(e.ownerDocument||e,e,c.SHOW_TEXT|c.SHOW_COMMENT|c.SHOW_CDATA_SECTION|c.SHOW_PROCESSING_INSTRUCTION,null),n=t.nextNode();for(;n;)n.data=cn(n.data),n=t.nextNode();let r=e.querySelectorAll?.call(e,`template`);r&&de(r,e=>{$(e.content)&&ln(e.content)})},un=function(e){let t=b?b(e):null;return typeof t!=`string`||Q(t)!==`form`?!1:typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||e.attributes!==v(e)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`||e.nodeType!==y(e)||e.childNodes!==h(e)},$=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return y(e)===q.documentFragment}catch{return!1}},dn=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return typeof y(e)==`number`}catch{return!1}};function fn(e,n,r){e.length!==0&&de(e,e=>{e.call(t,n,r,Ut)})}let pn=function(e,t){return!!(ft&&e.hasChildNodes()&&!dn(e.firstElementChild)&&U($e,e.textContent)&&U($e,e.innerHTML)||ft&&e.namespaceURI===Mt&&t===`style`&&dn(e.firstElementChild)||e.nodeType===q.processingInstruction||ft&&e.nodeType===q.comment&&U(et,e.data))},mn=function(e,t){if(!Te[t]&&vn(t)&&(V.tagNameCheck instanceof RegExp&&U(V.tagNameCheck,t)||V.tagNameCheck instanceof Function&&V.tagNameCheck(t)))return!1;if(St&&!X[t]){let t=g(e),n=h(e);if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=Ct?n[i]:f(n[i],!0);t.insertBefore(r,m(e))}}}return $t(e),!0},hn=function(e,n){if(fn(N.beforeSanitizeElements,e,null),e!==n&&g(e)===null)return!0;if(un(e))return $t(e),!0;let r=Q(b?b(e):e.nodeName);if(fn(N.uponSanitizeElement,e,{tagName:r,allowedTags:z}),e!==n&&g(e)===null)return!0;if(pn(e,r))return $t(e),!0;if(Te[r]||!(De.tagCheck instanceof Function&&De.tagCheck(r))&&!z[r]){let t=mn(e,r);return t===!1&&fn(N.afterSanitizeElements,e,null),t}if((y?y(e):e.nodeType)===q.element&&!Qt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&U(tt,e.innerHTML))return $t(e),!0;if(dt&&e.nodeType===q.text){let n=cn(e.textContent);e.textContent!==n&&(me(t.removed,{element:e.cloneNode()}),e.textContent=n)}return fn(N.afterSanitizeElements,e,null),!1},gn=function(e,t,r){if(W[t]||ft&&t===`patchsrc`||ft&&t===`for`&&e!==`label`&&e!==`output`||yt&&(t===`id`||t===`name`)&&(r in n||r in Wt))return!1;let i=B[t]||De.attributeCheck instanceof Function&&De.attributeCheck(t,e);if(!(ct&&U(ae,t))&&!(Oe&&U(oe,t))){if(!i){if(!(vn(e)&&(V.tagNameCheck instanceof RegExp&&U(V.tagNameCheck,e)||V.tagNameCheck instanceof Function&&V.tagNameCheck(e))&&(V.attributeNameCheck instanceof RegExp&&U(V.attributeNameCheck,t)||V.attributeNameCheck instanceof Function&&V.attributeNameCheck(t,e))||t===`is`&&V.allowCustomizedBuiltInElements&&(V.tagNameCheck instanceof RegExp&&U(V.tagNameCheck,r)||V.tagNameCheck instanceof Function&&V.tagNameCheck(r))))return!1}else if(!Ot[t]&&!U(ue,be(r,I,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&xe(r,`data:`)===0&&Et[e])&&!(lt&&!U(se,be(r,I,``)))&&r)return!1}return!0},_n=G({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),vn=function(e){return!_n[_e(e)]&&U(le,e)},yn=function(e,t,n,r){if(x&&typeof u==`object`&&typeof u.getAttributeType==`function`&&!n)switch(u.getAttributeType(e,t)){case`TrustedHTML`:return D(r);case`TrustedScriptURL`:return O(r)}return r},bn=function(e,n,r,i){try{r?e.setAttributeNS(r,n,i):e.setAttribute(n,i),un(e)?$t(e):pe(t.removed)}catch{tn(n,e)}},xn=function(e){fn(N.beforeSanitizeAttributes,e,null);let t=e.attributes;if(!t||un(e))return;let n={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:B,forceKeepAttr:void 0},r=t.length,i=Q(e.nodeName);for(;r--;){let a=t[r],o=a.name,s=a.namespaceURI,c=a.value,l=Q(o),u=c,d=o===`value`?u:Se(u);if(n.attrName=l,n.attrValue=d,n.keepAttr=!0,n.forceKeepAttr=void 0,fn(N.uponSanitizeAttribute,e,n),d=n.attrValue,bt&&(l===`id`||l===`name`)&&xe(d,xt)!==0&&(tn(o,e),d=xt+d),ft&&U(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){tn(o,e);continue}if(l===`attributename`&&ye(d,`href`)){tn(o,e);continue}if(!n.forceKeepAttr){if(!n.keepAttr){tn(o,e);continue}if(!ut&&U(nt,d)){tn(o,e);continue}if(dt&&(d=cn(d)),!gn(i,l,d)){tn(o,e);continue}d=yn(i,l,s,d),d!==u&&bn(e,o,s,d)}}fn(N.afterSanitizeAttributes,e,null)},Sn=function(e){let t=null,n=sn(e);for(fn(N.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)if(fn(N.uponSanitizeShadowNode,t,null),hn(t,e),xn(t),$(t.content)&&Sn(t.content),(y?y(t):t.nodeType)===q.element){let e=_(t);$(e)&&(Cn(e),Sn(e))}fn(N.afterSanitizeShadowDOM,e,null)},Cn=function(e){let t=[{node:e,shadow:null}];for(;t.length>0;){let e=t.pop();if(e.shadow){Sn(e.shadow);continue}let n=e.node,r=(y?y(n):n.nodeType)===q.element,i=h(n);if(i)for(let e=i.length-1;e>=0;--e)t.push({node:i[e],shadow:null});if(r){let e=b?b(n):null;if(typeof e==`string`&&Q(e)===`template`){let e=n.content;$(e)&&t.push({node:e,shadow:null})}}if(r){let e=_(n);$(e)&&t.push({node:null,shadow:e},{node:e,shadow:null})}}};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,a=null,o=null,s=null;if(Pt=!e,Pt&&(e=`<!-->`),typeof e!=`string`&&!dn(e)&&(e=ke(e),typeof e!=`string`))throw Ee(`dirty is not a string, aborting`);if(!t.isSupported)return e;pt?(z=mt,B=ht):Kt(n),(N.uponSanitizeElement.length>0||N.uponSanitizeAttribute.length>0)&&(z=K(z)),N.uponSanitizeAttribute.length>0&&(B=K(B)),t.removed=[];let c=Ct&&typeof e!=`string`&&dn(e);if(c){an(e);let t=b?b(e):e.nodeName;if(typeof t==`string`){let n=Q(t);if(!z[n]||Te[n])throw en(e),Ee(`root node is forbidden and cannot be sanitized in-place`)}if(un(e))throw en(e),Ee(`root node is clobbered and cannot be sanitized in-place`);try{Cn(e)}catch(t){throw en(e),t}}else if(dn(e))i=on(`<!---->`),a=i.ownerDocument.importNode(e,!0),a.nodeType===q.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?i=a:i.appendChild(a),Cn(a);else{if(!Y&&!dt&&!J&&e.indexOf(`<`)===-1)return x&&vt?D(e):e;if(i=on(e),!i)return Y?null:vt?S:``}i&&gt&&$t(i.firstChild);let l=c?e:i,u=sn(l);try{for(;o=u.nextNode();)hn(o,l),xn(o),$(o.content)&&Sn(o.content)}catch(n){throw c&&(en(e),de(t.removed,e=>{e.element&&rn(e.element)})),n}if(c)return de(t.removed,e=>{e.element&&rn(e.element)}),dt&&ln(e),e;if(Y){if(dt&&ln(i),_t)for(s=te.call(i.ownerDocument);i.firstChild;)s.appendChild(i.firstChild);else s=i;return(B.shadowroot||B.shadowrootmode)&&(s=ne.call(r,s,!0)),s}let d=J?i.outerHTML:i.innerHTML;return J&&z[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&U(Ze,i.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+d),dt&&(d=cn(d)),x&&vt?D(d):d},t.setConfig=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Kt(e),pt=!0,mt=z,ht=B},t.clearConfig=function(){Ut=null,pt=!1,mt=null,ht=null,x=C,S=``},t.isValidAttribute=function(e,t,n){Ut||Kt({});let r=Q(e),i=Q(t);return gn(r,i,n)},t.addHook=function(e,t){typeof t==`function`&&H(N,e)&&me(N[e],t)},t.removeHook=function(e,t){if(H(N,e)){if(t!==void 0){let n=fe(N[e],t);return n===-1?void 0:he(N[e],n,1)[0]}return pe(N[e])}},t.removeHooks=function(e){H(N,e)&&(N[e]=[])},t.removeAllHooks=function(){N=at()},t}var ct=st();function lt(e,t){let n=String(e??``),r=n.match(/^\s*<h1\b[^>]*>([\s\S]*?)<\/h1>\s*/i);if(!r)return n;let i=r[1].replace(/<[^>]*>/g,``).replace(/\s+/g,` `).trim(),a=String(t??``).replace(/\s+/g,` `).trim();return!a||i!==a?n:n.slice(r[0].length)}function ut(e){let t=e.length,n=Array.from({length:t},(e,n)=>n+1<t?n+1:null),r=[],i=null,a=t>0?0:null,o=null,s=(e,t)=>r.push({phase:e,desc:t,prev:i,curr:a,next:o,nextOf:[...n],done:!1}),c=t=>t===null?`∅`:String(e[t]);if(t===0)return s(`init`,"空链表。`head` 本身就是 ∅，直接返回 ∅ —— 这是必须单独处理的第一种边界。"),r[0].done=!0,r;for(s(`init`,`初始状态：\`prev\` 先站在 ∅（反转后头节点会变成尾节点，它的 \`next\` 必须指向空），\`curr\` 指向头节点 ${c(a)}。`);a!==null;)o=n[a],s(`read-next`,`① \`next = curr.next\`，先记住 ${c(o)}。这一步看着多余，其实是整个算法的命门：一旦 ② 把 \`curr\` 的指针掉头，通往后面节点的唯一线索就断了，所以必须提前存好。`),n[a]=i,s(`flip`,`② \`curr.next = prev\`，把 ${c(a)} 的箭头掉个头，指向 ${c(i)}。`+(i===null?` 因为 \`prev\` 还是 ∅，${c(a)} 就成了新的尾节点。`:``)),i=a,a=o,s(`advance`,a===null?`③ \`prev = curr\`，\`curr = next\` = ∅。curr 走出了链表，循环结束 —— 返回 \`prev\`（${c(i)}），它就是反转后的新头节点。`:`③ \`prev\` 和 \`curr\` 一起右移：\`prev\` 指向 ${c(i)}，\`curr\` 指向 ${c(a)}。准备处理下一个节点。`);return r[r.length-1].done=!0,r}var dt=`viz-chrome-styles`,ft=`http://www.w3.org/2000/svg`;function J(e,t){let n=document.createElementNS(ft,e);if(t)for(let e in t)n.setAttribute(e,t[e]);return n}function pt(e,t,n,r,i=`viz-arrow`){let a=J(`g`,{class:i}),o=r>0?t:e,s=r>0?e:t;return a.appendChild(J(`line`,{class:`${i}__line`,x1:s,y1:n,x2:o-r*9,y2:n})),a.appendChild(J(`path`,{class:`${i}__head`,d:`M ${o} ${n} L ${o-r*9} ${n-5.5} L ${o-r*9} ${n+5.5} Z`})),a}var mt=`
.viz {
  margin: 1.6em 0;
...
`;function Mn(){if(ht(),document.getElementById(sn))return;let e=document.createElement(`style`);e.id=sn,e.textContent=jn,document.head.appendChild(e)}function Nn(e){let t=Math.floor(Math.log2(e+1));return{x:(e-(2**t-1)+.5)/2**t*xn,y:t*Cn}}function Pn(e,t={}){if(!e||e.dataset.mklMounted===`1`)return{destroy(){}};e.dataset.mklMounted=`1`,Mn(),On+=1;let n=Array.isArray(t.lists)&&t.lists.length?t.lists:[[1,4],[2,5],[3,6],[0,7]],r=t.autoplay!==!1,i=on(n),a=n.length,o=Math.max(1,a),s=n.reduce((e,t)=>Math.max(e,t.length),0),c=1+n.reduce((e,t)=>e+t.length,0),l=e=>$+e*un,u=e=>l(e)+cn/2,d=e=>e<=0?$:$+(e-1)*un+cn,f=e=>d(e)+fn,p=o*gn-(gn-ln),m=wn+(Math.floor(Math.log2(o))*Cn+bn),h=Math.max(p,m),g=_n+h+vn,_=g+ln+hn+20,v=f(s)+dn,y=v+Tn+En,b=f(c)+dn+12,x=Math.max(y+36,b),S=Math.round((x-y)/2),C=S+v+Tn,w=e=>C+Sn+Nn(e).x,T=e=>_n+Math.max(0,Math.round((h-m)/2))+wn+Nn(e).y,E=document.createElement(`div`);E.className=`viz mkl`;let D=document.createElement(`div`);D.className=`viz__stage`,E.appendChild(D);let O=J(`svg`,{class:`viz__svg mkl__svg`,viewBox:`0 0 ${x} ${_}`,role:`img`,"aria-label":`合并 ${a} 个升序链表的小顶堆推演动画`});D.appendChild(O);function k(e,t,n,r,i){let a=J(`g`,{class:i});return a.appendChild(J(`line`,{class:`mkl-edge__line`,x1:t,y1:r,x2:n-9,y2:r})),a.appendChild(J(`path`,{class:`mkl-edge__head`,d:`M ${n} ${r} L ${n-9} ${r-5.5} L ${n-9} ${r+5.5} Z`})),e.appendChild(a),a}function A(e,t,n){e.appendChild(J(`circle`,{class:`mkl-null__ring`,cx:t,cy:n,r:dn}));let r=J(`text`,{class:`mkl-null__text`,x:t,y:n});r.textContent=`∅`,e.appendChild(r)}function j(e,t,n,r,i){let a=J(`g`,{class:`mkl-node ${i}`});a.appendChild(J(`rect`,{class:`mkl-node__box`,x:n,y:r,width:cn,height:ln,rx:8}));let o=J(`text`,{class:`mkl-node__value`,x:n+cn/2,y:r+ln/2});return o.textContent=String(t),a.appendChild(o),e.appendChild(a),a}let ee=n.map((e,t)=>{let n=_n+t*gn,r=n+ln/2,i=J(`g`,{class:`mkl-src ${An(t)}`}),a=J(`text`,{class:`mkl-row-label`,x:S+$/2-6,y:r});a.textContent=String.fromCharCode(65+t),i.appendChild(a);let o=e.map((e,t)=>j(i,e,S+$+t*un,n,``));for(let t=0;t<e.length-1;t+=1)k(i,S+$+t*un+cn,S+$+(t+1)*un,r,``);return e.length>0&&k(i,S+d(e.length),S+f(e.length)-dn,r,``),A(i,S+f(e.length),r),O.appendChild(i),{g:i,labelEl:a,nodes:o,values:e}}),te=J(`g`,{class:`mkl-heap`});O.appendChild(te);let M=J(`text`,{class:`mkl-heap__caption`,x:C+Sn+xn/2,y:_n+Math.max(0,Math.round((h-m)/2))+wn/2});te.appendChild(M);let ne=[];for(let e=1;e<o;e+=1){let t=e-1>>1,n=J(`g`,{class:`mkl-hedge`});n.appendChild(J(`line`,{class:`mkl-hedge__line`,x1:w(t),y1:T(t)+bn,x2:w(e),y2:T(e)})),te.appendChild(n),ne.push({g:n,child:e})}let N=[];for(let e=0;e<o;e+=1){let t=J(`g`,{class:`mkl-hslot is-off`});t.appendChild(J(`rect`,{class:`mkl-hnode__box`,x:w(e)-yn/2,y:T(e),width:yn,height:bn,rx:7}));let n=J(`text`,{class:`mkl-hnode__value`,x:w(e),y:T(e)+bn/2});t.appendChild(n),te.appendChild(t),N.push({g:t,textEl:n})}let re=J(`text`,{class:`mkl-heap__root-tag`,x:w(0)+yn/2+24,y:T(0)+bn/2});re.textContent=`堆顶`,te.appendChild(re);let P=J(`g`,{class:`mkl-result`});O.appendChild(P);let F=g+ln/2,ie=J(`text`,{class:`mkl-row-label`,x:26,y:F});ie.textContent=`结果`,P.appendChild(ie);let ae=J(`g`,{class:`mkl-dummy`});ae.appendChild(J(`rect`,{class:`mkl-dummy__box`,x:l(0),y:g,width:cn,height:ln,rx:8}));let oe=J(`text`,{class:`mkl-dummy__text`,x:u(0),y:F});oe.textContent=`dummy`,ae.appendChild(oe),P.appendChild(ae);let se=[];for(let e=1;e<c;e+=1)se.push(k(P,l(e-1)+cn,l(e),F,`mkl-redge`));A(P,f(c),F);let I=k(P,d(c),f(c)-dn,F,`mkl-redge`),L=i[i.length-1].taken.map((e,t)=>j(P,n[e.list][e.i],l(t+1),g,`mkl-rslot ${An(e.list)}`)),R=J(`g`,{class:`mkl-chip mkl-chip--tail`});R.appendChild(J(`rect`,{class:`mkl-chip__box`,x:-40/2,y:-22/2,width:pn,height:mn}));let ce=J(`text`,{class:`mkl-chip__text`,x:0,y:0});ce.textContent=`tail`,R.appendChild(ce),P.appendChild(R);let le=document.createElement(`p`);le.className=`viz__desc`,le.setAttribute(`aria-live`,`polite`),E.appendChild(le);let ue=_t();E.appendChild(ue.root),e.textContent=``,e.appendChild(E);let z=null;function de(e,t){let r=t.heap.length,i=new Set(t.moved);ee.forEach((e,n)=>{let r=t.cursors[n];e.g.classList.toggle(`is-dead`,r===null),e.labelEl.classList.toggle(`is-live`,r!==null),e.labelEl.classList.toggle(`is-dead`,r===null),e.nodes.forEach((e,t)=>{e.classList.toggle(`is-taken`,r===null||t<r),e.classList.toggle(`is-head`,r===t)})}),N.forEach((e,a)=>{if(a>=r){e.g.setAttribute(`class`,`mkl-hslot is-off`);return}let o=t.heap[a];e.textEl.textContent=String(n[o.list][o.i]),e.g.setAttribute(`class`,`mkl-hslot ${An(o.list)}${i.has(a)?` is-moved`:``}`+(a===0?` is-root`:``))}),ne.forEach(e=>{e.g.style.display=e.child<r?``:`none`}),M.textContent=r===0?`堆：空了 —— 全部节点已取出`:`堆：只有 ${r} 个候选（每条链表当前的头部）`,re.classList.toggle(`is-off`,r===0);let a=t.phase===`take`?t.taken.length:1/0;L.forEach((e,n)=>{let r=n+1,i=r<=t.taken.length;e.classList.toggle(`is-filled`,i),e.classList.toggle(`is-new`,i&&r>=a)}),se.forEach((e,n)=>e.classList.toggle(`is-on`,n+1<=t.taken.length)),I.classList.toggle(`is-on`,t.done);let o=Math.min(t.taken.length,c-1);R.style.transform=`translate(${u(o)}px, ${g+ln+hn}px)`,Y(le,t.desc)}let fe=vt({steps:i,controls:ue,intervalMs:Dn,onRender:de});fe.jumpTo(Math.trunc(t.initialStep)||0);let pe=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches;return r&&!pe&&typeof IntersectionObserver==`function`&&(z=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){z.disconnect(),z=null,fe.play();return}},{threshold:.35}),z.observe(E)),{destroy(){z&&=(z.disconnect(),null),fe.destroy(),e.textContent=``,delete e.dataset.mklMounted,--On,On<=0&&(document.getElementById(sn)?.remove(),gt())}}}function Fn(e,t){let n=[],r=0,i=0;for(;r<e.length&&i<t.length;)e[r]<=t[i]?(n.push(e[r]),r+=1):(n.push(t[i]),i+=1);for(;r<e.length;)n.push(e[r++]);for(;i<t.length;)n.push(t[i++]);return n}var In=e=>e.length?e.join(`、`):`∅`;function Ln(e){let t=(Array.isArray(e)?e:[]).map(e=>Array.isArray(e)?e.slice():[]),n=t.length,r=[],i=t.reduce((e,t)=>e+t.length,0),a=e=>e.map(e=>({lists:e.lists.map(e=>e.slice()),from:e.from?e.from.map(e=>[e[0],e[1]]):null}));if(n===0)return r.push({phase:`init`,desc:"`lists` 是个空数组，一条链表都没有，直接返回 ∅。",levels:[],activeLevel:-1,rounds:0,done:!0}),r;let o=[{lists:t.map(e=>e.slice()),from:null}];if(n===1)return r.push({phase:`init`,desc:`只有 1 条链表，**一次合并都不用做** —— 分治的轮数是 ⌈log₂1⌉ = 0，直接返回它自己（${In(t[0])}）。`,levels:a(o),activeLevel:0,rounds:0,done:!0}),r;r.push({phase:`init`,desc:`分治的起手：${n} 条链表一字排开，一共 ${i} 个节点。接下来每一轮**两两配对合并**，链表条数每次减半 —— ${n} → ${Math.ceil(n/2)} → … → 1，一共 ⌈log₂${n}⌉ = ${Math.ceil(Math.log2(n))} 轮。`,levels:a(o),activeLevel:0,rounds:0,done:!1});let s=t,c=0;for(;s.length>1;){let e=[],t=[];for(let n=0;n<s.length;n+=2)n+1<s.length?(e.push(Fn(s[n],s[n+1])),t.push([n,n+1])):(e.push(s[n].slice()),t.push([n,-1]));c+=1,o.push({lists:e,from:t});let n=s.length,i=e.length,l=t.reduce((e,[t,n])=>e+(n>=0?s[t].length+s[n].length:0),0),u=t.filter(e=>e[1]>=0).length,d=t.find(e=>e[1]<0);r.push({phase:`merge`,desc:`第 ${c} 轮：把 ${n} 条两两配对，做 ${u} 次「合并两个有序链表」，得到 ${i} 条。本轮被摸到的节点一共 ${l} 个，不超过 N —— 每轮都是 O(N) 的工作量。`+(d?`注意第 ${d[0]+1} 条这轮**轮空**了，原样进下一轮（不是丢掉）。`:`链表条数 ${n} → ${i}。`),levels:a(o),activeLevel:o.length-1,rounds:c,done:!1}),s=e}return r.push({phase:`done`,desc:`一共 ${c} 轮，每轮 O(N)，所以总时间是 **O(N log K)** —— 和最小堆同阶。结果链表是 ${In(s[0])}。分治的隐藏优势：它不需要堆，每一轮都是纯粹的指针比较，常数更小。`,levels:a(o),activeLevel:o.length-1,rounds:c,done:!0}),r}var Rn=`mkc-styles`,zn=44,Bn=36,Vn=18,Hn=38,Un=68,Wn=76,Gn=34,Kn=54,qn=30,Jn=1400,Yn=0,Xn=`
.mkc {
  --mkc-lv1: #3f6b57;
  --mkc-lv2: #a45f45;
  --mkc-lv3: #3f5f8a;
...
`;function ii(){if(ht(),document.getElementById(Hr))return;let e=document.createElement(`style`);e.id=Hr,e.textContent=ri,document.head.appendChild(e)}function ai(e,t={}){if(!e||e.dataset.rnthMounted===`1`)return{destroy(){}};e.dataset.rnthMounted=`1`,ii();let n=Array.isArray(t.values)&&t.values.length?t.values:[1,2,3,4,5],r=Math.min(Math.max(Math.trunc(t.n)||2,1),n.length),i=t.autoplay!==!1,a=Vr(n,r),o=n.length,s=o+1,c=2*Kr+s*Ur+(s-1)*Gr,l=e=>Kr+e*106,u=e=>l(e)+Ur/2,d=c-ti,f=document.createElement(`div`);f.className=`viz rnth`;let p=document.createElement(`div`);p.className=`viz__stage`,f.appendChild(p);let m=J(`svg`,{class:`viz__svg rnth__svg`,viewBox:`0 0 ${c} ${ei}`,role:`img`,"aria-label":`删除倒数第 ${r} 个节点推演动画：${n.join(` → `)}`});p.appendChild(m),m.appendChild(J(`circle`,{class:`rnth-null__ring`,cx:d,cy:Jr,r:15}));let h=J(`text`,{class:`rnth-null__text`,x:d,y:Jr});h.textContent=`∅`,m.appendChild(h);let g=J(`line`,{class:`rnth-tick`}),_=J(`line`,{class:`rnth-tick`});m.append(g,_);let v=[];for(let e=0;e<o;e+=1){let t=pt(l(e)+Ur,l(e+1),Jr,1,`rnth-edge`);m.appendChild(t),v.push(t)}let y=pt(l(o)+Ur,d-15,Jr,1,`rnth-edge`);m.appendChild(y);let b=J(`path`,{class:`rnth-arc__line`}),x=J(`path`,{class:`rnth-arc__head`}),S=J(`g`,{class:`rnth-arc`});S.append(b,x),m.appendChild(S);let C=[];for(let e=0;e<s;e+=1){let t=J(`g`,{class:`rnth-node${e===0?` rnth-node--dummy`:``}`});t.appendChild(J(`rect`,{class:`rnth-node__box`,x:l(e),y:qr,width:Ur,height:Wr,rx:9}));let r=J(`text`,{class:`rnth-node__value`,x:u(e),y:Jr});r.textContent=e===0?`dummy`:String(n[e-1]),t.appendChild(r),m.appendChild(t),C.push(t)}let w=J(`g`,{class:`rnth-gapline`}),T=J(`line`,{class:`rnth-gapline__line`}),E=J(`path`,{class:`rnth-gapline__head`}),D=J(`path`,{class:`rnth-gapline__head`}),O=J(`rect`,{class:`rnth-gapline__tag-bg`,x:-26,y:-9,width:52,height:18,rx:6}),k=J(`text`,{class:`rnth-gapline__tag`,x:0,y:0});w.append(T,E,D,O,k),m.appendChild(w);function A(e,t){let n=J(`g`,{class:`rnth-chip rnth-chip--${e}`});n.appendChild(J(`rect`,{class:`rnth-chip__box`,x:-56/2,y:-26/2,width:Qr,height:$r}));let r=J(`text`,{class:`rnth-chip__text`,x:0,y:0});return r.textContent=t,n}let j=A(`fast`,`fast`),ee=A(`slow`,`slow`);m.append(j,ee);let te=document.createElement(`p`);te.className=`viz__desc`,te.setAttribute(`aria-live`,`polite`),f.appendChild(te);let M=_t();f.appendChild(M.root),e.textContent=``,e.appendChild(f);let ne=null,N=e=>e===null?d:u(e);function re(e,t,n,r){let i=N(n);e.style.transform=`translate(${i}px, ${r}px)`,e.style.opacity=`1`,t.setAttribute(`x1`,i),t.setAttribute(`x2`,i),t.setAttribute(`y1`,r-$r/2),t.setAttribute(`y2`,138),t.style.opacity=`0.65`}function P(e){let t=e.cutSlot;if(t===null||e.links[t-1]!==t+1){S.classList.remove(`is-on`);return}let n=l(t-1)+Ur,r=l(t+1),i=Jr,a=Jr,o=n+(r-n)*.3,s=n+(r-n)*.7;b.setAttribute(`d`,`M ${n} ${i} C ${o} ${i-44}, ${s} ${a-44}, ${r-8} ${a}`),x.setAttribute(`d`,`M ${r} ${a} L ${r-9} ${a-5.5} L ${r-9} 118.5 Z`),S.classList.add(`is-on`)}function F(e){let t=e.gap!==null&&e.gap>0&&e.fast!==null;if(w.classList.toggle(`is-on`,t),!t)return;let n=u(e.slow),r=u(e.fast);T.setAttribute(`x1`,n),T.setAttribute(`x2`,r),T.setAttribute(`y1`,Yr),T.setAttribute(`y2`,Yr),E.setAttribute(`d`,`M ${n} ${Yr} L ${n+7} ${Yr-4.5} L ${n+7} 44.5 Z`),D.setAttribute(`d`,`M ${r} ${Yr} L ${r-7} ${Yr-4.5} L ${r-7} 44.5 Z`),O.setAttribute(`x`,(n+r)/2-26),O.setAttribute(`y`,Yr-9),k.setAttribute(`x`,(n+r)/2),k.setAttribute(`y`,Yr),k.textContent=`间隔 ${e.gap}`}function ie(e,t){for(let e=0;e<s;e+=1)C[e].classList.toggle(`is-cut`,t.cutSlot!==null&&e===t.cutSlot);for(let e=0;e<o;e+=1)v[e].classList.toggle(`is-on`,t.links[e]===e+1);y.classList.toggle(`is-on`,t.links[o]===null),P(t),F(t),t.fast===null?(j.style.transform=`translate(${d}px, ${Xr}px)`,j.style.opacity=`1`,g.style.opacity=`0`):re(j,g,t.fast,Xr),re(ee,_,t.slow,Zr),Y(te,t.desc)}let ae=vt({steps:a,controls:M,intervalMs:ni,onRender:ie});ae.jumpTo(Math.trunc(t.initialStep)||0);let oe=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches;return i&&!oe&&typeof IntersectionObserver==`function`&&(ne=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){ne.disconnect(),ne=null,ae.play();return}},{threshold:.35}),ne.observe(f)),{destroy(){ne&&=(ne.disconnect(),null),ae.destroy(),e.textContent=``,delete e.dataset.rnthMounted,document.getElementById(Hr)?.remove()}}}var oi=[`innerHTML`],si=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,ci=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,li=`0.16.21`,ui=`11.4.1`,di=y({__name:`MarkdownView`,props:{html:{type:String,default:``},title:{type:String,default:``}},setup(e){let t=e,n=w(null),r=v(()=>lt(ct.sanitize(t.html,{ADD_ATTR:[`target`,`rel`],FORBID_TAGS:[`style`,`iframe`,`object`,`embed`,`form`],FORBID_ATTR:[`onerror`,`onload`,`onclick`]}),t.title));function i(e){e.classList.add(`copied`),e.innerHTML=ci,setTimeout(()=>{e.classList.remove(`copied`),e.innerHTML=si},2e3)}function s(){n.value&&n.value.querySelectorAll(`table`).forEach(e=>{if(e.parentElement?.classList.contains(`table-scroll`))return;let t=document.createElement(`div`);t.className=`table-scroll`,e.parentNode.insertBefore(t,e),t.appendChild(e)})}function l(){n.value&&n.value.querySelectorAll(`pre`).forEach(e=>{if(e.parentElement?.classList.contains(`code-block-wrapper`))return;let t=document.createElement(`div`);t.className=`code-block-wrapper`,e.parentNode.insertBefore(t,e),t.appendChild(e);let n=document.createElement(`button`);n.className=`copy-btn`,n.title=`复制代码`,n.innerHTML=si,n.addEventListener(`click`,()=>{let t=(e.querySelector(`code`)||e).textContent||``;navigator.clipboard.writeText(t).then(()=>{i(n)}).catch(()=>{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),i(n)})}),t.appendChild(n)})}function u(e,t){return new Promise((n,r)=>{if(document.querySelector(`link[data-lib-href="${e}"]`))return n();let i=document.createElement(`link`);i.rel=`stylesheet`,i.href=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libHref=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load stylesheet `+e)),document.head.appendChild(i)})}function d(e,t){return new Promise((n,r)=>{if(document.querySelector(`script[data-lib-src="${e}"]`))return n();let i=document.createElement(`script`);i.src=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libSrc=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load script `+e)),document.head.appendChild(i)})}let f=null;async function m(){return f||=Promise.all([u(`https://cdn.jsdelivr.net/npm/katex@${li}/dist/katex.min.css`,`sha384-zh0CIslj+VczCZtlzBcjt5ppRcsAmDnRem7ESsYwWwg3m/OaJ2l4x7YBZl9Kxxib`),d(`https://cdn.jsdelivr.net/npm/katex@${li}/dist/katex.min.js`,`sha384-Rma6DA2IPUwhNxmrB/7S3Tno0YY7sFu9WSYMCuulLhIqYSGZ2gKCJWIqhBWqMQfh`)]).then(()=>window.katex),f}let h=null;async function g(){return h||=d(`https://cdn.jsdelivr.net/npm/mermaid@${ui}/dist/mermaid.min.js`,`sha384-rbtjAdnIQE/aQJGEgXrVUlMibdfTSa4PQju4HDhN3sR2PmaKFzhEafuePsl9H/9I`).then(()=>window.mermaid),h}async function _(){if(!n.value)return;let e=n.value.querySelectorAll(`code.language-mermaid`);if(e.length)try{let t=await g();e.forEach(e=>{let n=e.closest(`pre`);if(!n||n.dataset.mermaidRendered)return;n.dataset.mermaidRendered=`1`;let r=document.createElement(`div`);r.className=`mermaid-container`,r.textContent=e.textContent,n.parentNode.replaceChild(r,n),t.run({nodes:[r]})})}catch(e){console.warn(`Mermaid failed to load/render:`,e?.message||e)}n.value.querySelectorAll(`img`).forEach(e=>{let t=e.getAttribute(`src`)||``;e.getAttribute(`alt`);let n=t.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([\w-]+)/);if(n){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://www.youtube.com/embed/${n[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}let r=t.match(/bilibili\.com\/video\/(BV[\w]+)/);if(r){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://player.bilibili.com/player.html?bvid=${r[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}});let t=/(\$\$[\s\S]+?\$\$|\$[^\s$](?:[^$]*[^\s$])?\$)/,r=document.createTreeWalker(n.value,NodeFilter.SHOW_TEXT),i=[],a;for(;a=r.nextNode();)!a.nodeValue||!t.test(a.nodeValue)||a.parentElement?.closest(`pre, code`)||i.push(a);if(i.length)try{let e=await m();for(let n of i){let r=document.createDocumentFragment();for(let i of n.nodeValue.split(t)){if(!i)continue;let t=i.startsWith(`$$`)&&i.endsWith(`$$`)&&i.length>3,n=!t&&i.startsWith(`$`)&&i.endsWith(`$`)&&i.length>2;if(!t&&!n){r.appendChild(document.createTextNode(i));continue}let a=i.slice(t?2:1,t?-2:-1),o=document.createElement(`span`);o.innerHTML=e.renderToString(a,{displayMode:t,throwOnError:!1}),r.appendChild(o)}n.parentNode.replaceChild(r,n)}}catch(e){console.warn(`KaTeX failed to load/render:`,e?.message||e)}}let y={"algo-viz--lc206":Lt,"algo-viz--lc21":rn,"algo-viz--lc23":Pn,"algo-viz--lc23dc":$n,"algo-viz--lc141":Er,"algo-viz--lc142":Br,"algo-viz--lc19":ai},b=[];function x(){b.forEach(e=>{try{e?.destroy?.()}catch(e){console.warn(`Algo viz teardown failed:`,e?.message||e)}}),b=[]}function T(){n.value&&(x(),n.value.querySelectorAll(`.algo-viz`).forEach(e=>{let t=Object.keys(y).find(t=>e.classList.contains(t));if(t)try{b.push(y[t](e))}catch(e){console.warn(`Algo viz failed to mount:`,t,e?.message||e)}}))}return a(()=>{o(()=>{T(),_(),s(),l()})}),C(x),p(()=>t.html,()=>{o(()=>{T(),_(),s(),l()})}),(e,t)=>(S(),c(`div`,{ref_key:`bodyRef`,ref:n,class:`markdown-body`,innerHTML:r.value},null,8,oi))}},[[`__scopeId`,`data-v-3ff4dff0`]]);function fi(e){return T.get(`/articles/${e}/comments/`)}function pi(e,t){return T.post(`/articles/${e}/comments/`,t)}var mi={key:0,class:`form-title`},hi={key:1,class:`form-title`},gi={class:`form-field`},_i={key:0,class:`field-error`},vi={class:`form-field`},yi={key:0,class:`field-error`},bi={class:`hp-field`,"aria-hidden":`true`},xi={class:`form-field`},Si={key:0,class:`field-error`},Ci={key:0,class:`submit-error`},wi={key:1,class:`submit-success`},Ti={class:`form-actions`},Ei=[`disabled`],Di={key:0,class:`spinner`},Oi={key:1},ki=y({__name:`CommentForm`,props:{articleSlug:{type:String,required:!0},parentId:{type:[Number,String],default:null}},emits:[`submitted`,`cancel`],setup(e,{emit:t}){let n=e,r=t,a=i({author_name:``,author_email:``,content:``,website:``}),o=i({author_name:``,author_email:``,content:``}),u=w(!1),d=w(null),p=w(!1);function m(){let e=!0;return o.author_name=``,o.author_email=``,o.content=``,a.author_name.trim()||(o.author_name=`请输入昵称`,e=!1),a.author_email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.author_email)||(o.author_email=`邮箱格式不正确`,e=!1):(o.author_email=`请输入邮箱`,e=!1),a.content.trim()?a.content.trim().length<3&&(o.content=`评论内容至少3个字符`,e=!1):(o.content=`请输入评论内容`,e=!1),e}function g(e){o[e]&&(o[e]=``),d.value=null}async function _(){if(m()){u.value=!0,d.value=null;try{let e={author_name:a.author_name.trim(),author_email:a.author_email.trim(),content:a.content.trim(),website:a.website};n.parentId&&(e.parent=n.parentId),await pi(n.articleSlug,e),p.value=!0,setTimeout(()=>{p.value=!1},3e3),r(`submitted`),a.author_name=``,a.author_email=``,a.content=``}catch(e){let t=e?.response?.data;if(typeof t==`object`&&t){let e=t;e.author_name&&(o.author_name=Array.isArray(e.author_name)?e.author_name[0]:e.author_name),e.author_email&&(o.author_email=Array.isArray(e.author_email)?e.author_email[0]:e.author_email),e.content&&(o.content=Array.isArray(e.content)?e.content[0]:e.content),e.detail&&(d.value=e.detail),e.non_field_errors&&(d.value=Array.isArray(e.non_field_errors)?e.non_field_errors[0]:e.non_field_errors)}else typeof t==`string`?d.value=t:d.value=e.message||`提交失败，请稍后重试`}finally{u.value=!1}}}return(t,n)=>(S(),c(`div`,{class:h([`comment-form`,{"reply-form":!!e.parentId}])},[e.parentId?(S(),c(`h4`,mi,`回复评论`)):(S(),c(`h4`,hi,`发表评论`)),s(`form`,{onSubmit:k(_,[`prevent`]),class:`form-body`},[s(`div`,gi,[f(s(`input`,{"onUpdate:modelValue":n[0]||=e=>a.author_name=e,type:`text`,placeholder:`昵称 *`,class:h([`form-input`,{"input-error":o.author_name}]),onInput:n[1]||=e=>g(`author_name`)},null,34),[[O,a.author_name]]),o.author_name?(S(),c(`p`,_i,l(o.author_name),1)):b(``,!0)]),s(`div`,vi,[f(s(`input`,{"onUpdate:modelValue":n[2]||=e=>a.author_email=e,type:`email`,placeholder:`邮箱 *`,class:h([`form-input`,{"input-error":o.author_email}]),onInput:n[3]||=e=>g(`author_email`)},null,34),[[O,a.author_email]]),o.author_email?(S(),c(`p`,yi,l(o.author_email),1)):b(``,!0)]),s(`div`,bi,[f(s(`input`,{"onUpdate:modelValue":n[4]||=e=>a.website=e,type:`text`,tabindex:`-1`,autocomplete:`off`},null,512),[[O,a.website]])]),s(`div`,xi,[f(s(`textarea`,{"onUpdate:modelValue":n[5]||=e=>a.content=e,placeholder:`说点什么...`,rows:`4`,class:h([`form-textarea`,{"input-error":o.content}]),onInput:n[6]||=e=>g(`content`)},null,34),[[O,a.content]]),o.content?(S(),c(`p`,Si,l(o.content),1)):b(``,!0)]),d.value?(S(),c(`p`,Ci,l(d.value),1)):b(``,!0),p.value?(S(),c(`p`,wi,`评论已提交！`)):b(``,!0),s(`div`,Ti,[e.parentId?(S(),c(`button`,{key:0,type:`button`,class:`cancel-btn`,onClick:n[7]||=e=>t.$emit(`cancel`)},` 取消回复 `)):b(``,!0),s(`button`,{type:`submit`,class:`submit-btn`,disabled:u.value},[u.value?(S(),c(`span`,Di)):(S(),c(`span`,Oi,`提交`))],8,Ei)])],32)],2))}},[[`__scopeId`,`data-v-49410be9`]]),Ai={class:`comment-list`},ji={class:`comments-title`},Mi={key:0,class:`comments-count`},Ni={key:0,class:`skeleton-comments`},Pi={key:1,class:`empty-comments`},Fi={key:2,class:`comments-tree`},Ii={class:`comment-main`},Li={class:`comment-content`},Ri={class:`comment-header`},zi={class:`comment-author`},Bi={class:`comment-time`},Vi={class:`comment-text`},Hi=[`onClick`],Ui={key:1,class:`replies`},Wi={class:`comment-main`},Gi={class:`comment-content`},Ki={class:`comment-header`},qi={class:`comment-author`},Ji={class:`comment-time`},Yi={class:`comment-text`},Xi=y({__name:`CommentList`,props:{articleSlug:{type:String,required:!0}},setup(e){let t=e,n=w([]),i=w(!0),o=w(null),u=v(()=>n.value.filter(e=>!e.parent));function f(e){o.value=o.value===e?null:e}async function p(){i.value=!0;try{let e=await fi(t.articleSlug);n.value=e.data.results||e.data||[]}catch{n.value=[]}finally{i.value=!1}}function h(){o.value=null,p()}function y(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<1?`刚刚`:n<60?`${n}分钟前`:r<24?`${r}小时前`:i<30?`${i}天前`:i<365?`${Math.floor(i/30)}个月前`:`${Math.floor(i/365)}年前`}function C(e){let t=[`#3f6b57`,`#a45f45`,`#8a6c3f`,`#637b68`,`#7b6757`,`#4f7477`,`#8a635f`,`#6b7250`,`#536b5d`,`#9b704e`,`#65706a`,`#7b6a83`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}return a(p),(t,a)=>(S(),c(`div`,Ai,[s(`h3`,ji,[a[1]||=g(` 评论 `,-1),n.value.length?(S(),c(`span`,Mi,`(`+l(n.value.length)+`)`,1)):b(``,!0)]),i.value?(S(),c(`div`,Ni,[(S(),c(d,null,r(3,e=>s(`div`,{key:e,class:`skeleton-comment`},[...a[2]||=[_(`<div class="skeleton-avatar" data-v-98dfce57></div><div class="skeleton-body" data-v-98dfce57><div class="skeleton-line w-30" data-v-98dfce57></div><div class="skeleton-line w-50" data-v-98dfce57></div><div class="skeleton-line w-80" data-v-98dfce57></div></div>`,2)]])),64))])):u.value.length?(S(),c(`div`,Fi,[(S(!0),c(d,null,r(u.value,t=>(S(),c(`div`,{key:t.id,class:`comment-item`},[s(`div`,Ii,[s(`div`,{class:`comment-avatar`,style:x({background:C(t.author_name)})},l(t.author_name?t.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,Li,[s(`div`,Ri,[s(`span`,zi,l(t.author_name),1),s(`span`,Bi,l(y(t.created_at)),1)]),s(`p`,Vi,l(t.content),1),s(`button`,{class:`reply-btn`,onClick:e=>f(t.id)},[...a[4]||=[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 17 4 12 9 7`}),s(`path`,{d:`M20 18v-2a4 4 0 0 0-4-4H4`})],-1),g(` 回复 `,-1)]],8,Hi)])]),o.value===t.id?(S(),m(ki,{key:0,"article-slug":e.articleSlug,"parent-id":t.id,onSubmitted:h,onCancel:a[0]||=e=>o.value=null,class:`reply-form-wrapper`},null,8,[`article-slug`,`parent-id`])):b(``,!0),t.replies&&t.replies.length?(S(),c(`div`,Ui,[(S(!0),c(d,null,r(t.replies,e=>(S(),c(`div`,{key:e.id,class:`comment-item reply-item`},[s(`div`,Wi,[s(`div`,{class:`comment-avatar comment-avatar-sm`,style:x({background:C(e.author_name)})},l(e.author_name?e.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,Gi,[s(`div`,Ki,[s(`span`,qi,l(e.author_name),1),s(`span`,Ji,l(y(e.created_at)),1)]),s(`p`,Yi,l(e.content),1)])])]))),128))])):b(``,!0)]))),128))])):(S(),c(`div`,Pi,[...a[3]||=[s(`svg`,{width:`40`,height:`40`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z`})],-1),s(`p`,null,`暂无评论，来说点什么吧`,-1)]]))]))}},[[`__scopeId`,`data-v-98dfce57`]]),Zi={key:0,class:`toc-list-wrapper`},Qi={class:`toc-list`},$i=[`href`,`title`,`onClick`],ea={class:`toc-text`},ta={key:1,class:`toc-empty-state`},na=y({__name:`TocNav`,props:{html:{type:String,default:``}},setup(e){let t=e,n=w([]),i=w(null),u=null,f=[];function m(){if(!t.html){n.value=[];return}try{let e=new DOMParser().parseFromString(t.html,`text/html`),r=[];e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let n=e.id||`toc-heading-${t}`;r.push({id:n,tag:e.tagName.toLowerCase(),text:e.textContent||``})}),n.value=r}catch{n.value=[]}}function g(){if(!n.value.length)return;let e=document.querySelector(`.markdown-body`);e&&e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let r=n.value[t];r&&!e.id&&(e.id=r.id)})}function _(){u&&=(u.disconnect(),null),f=[],n.value.length&&(u=new IntersectionObserver(e=>{let t=e.filter(e=>e.isIntersecting);t.length?i.value=t[0].target.id:window.scrollY<100&&(i.value=n.value[0]?.id||null)},{rootMargin:`-80px 0px -60% 0px`,threshold:0}),o(()=>{n.value.forEach(e=>{let t=document.getElementById(e.id);t&&(u.observe(t),f.push(t))})}))}function v(e){let t=document.getElementById(e);t&&(t.scrollIntoView({behavior:`smooth`,block:`start`}),i.value=e)}return p(()=>t.html,()=>{m(),o(()=>{g(),_()})}),a(()=>{m(),o(()=>{g(),_()})}),C(()=>{u&&u.disconnect()}),(e,t)=>(S(),c(`nav`,{class:h([`toc-nav`,{"toc-empty":!n.value.length}])},[t[2]||=s(`h4`,{class:`toc-title`},`目录`,-1),n.value.length?(S(),c(`div`,Zi,[s(`ul`,Qi,[(S(!0),c(d,null,r(n.value,e=>(S(),c(`li`,{key:e.id,class:h([`toc-item`,[`toc-depth-${e.tag}`,{"toc-active":i.value===e.id}]])},[s(`a`,{href:`#`+e.id,class:`toc-link`,title:e.text,onClick:k(t=>v(e.id),[`prevent`])},[t[0]||=s(`span`,{class:`toc-dot`},null,-1),s(`span`,ea,l(e.text),1)],8,$i)],2))),128))])])):(S(),c(`div`,ta,[...t[1]||=[s(`p`,null,`无目录`,-1)]]))],2))}},[[`__scopeId`,`data-v-21d21cb1`]]),ra={class:`share-buttons`},ia={key:0,class:`copy-feedback`},aa=y({__name:`ShareButtons`,props:{title:{type:String,default:``},url:{type:String,default:``}},setup(e){let t=e,n=w(!1);function r(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://service.weibo.com/share/share.php?url=${e}&title=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function i(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://twitter.com/intent/tweet?url=${e}&text=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function a(){alert(`请复制链接后在微信中粘贴发送`)}async function o(){try{await navigator.clipboard.writeText(t.url||window.location.href),n.value=!0,setTimeout(()=>n.value=!1,2e3)}catch{let e=document.createElement(`textarea`);e.value=t.url||window.location.href,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),n.value=!0,setTimeout(()=>n.value=!1,2e3)}}return(e,t)=>(S(),c(`div`,ra,[t[4]||=s(`span`,{class:`share-label`},`分享：`,-1),s(`button`,{class:`share-btn wechat`,title:`微信`,onClick:a},[...t[0]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178A1.17 1.17 0 0 1 4.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178 1.17 1.17 0 0 1-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229.826 0 1.622-.12 2.361-.336a.722.722 0 0 1 .598.082l1.584.926a.272.272 0 0 0 .14.045c.136 0 .241-.11.241-.245 0-.06-.024-.12-.04-.178l-.325-1.233a.49.49 0 0 1 .178-.554C23.028 18.48 24 16.82 24 14.98c0-3.21-2.931-5.952-7.062-6.122zm-2.18 2.769c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982zm4.844 0c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982z`})],-1)]]),s(`button`,{class:`share-btn weibo`,title:`微博`,onClick:r},[...t[1]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M10.098 20.323c-3.977.391-7.414-1.406-7.672-4.02-.259-2.609 2.759-5.047 6.74-5.441 3.979-.394 7.413 1.404 7.671 4.018.259 2.6-2.759 5.049-6.739 5.443zm-7.317-6.781c-1.059-.2-1.911.419-1.903 1.383.008.964.87 1.907 1.93 2.107 1.058.2 1.91-.419 1.903-1.383-.008-.964-.87-1.907-1.93-2.107zm2.13 3.68c-.563-.249-.754-.766-.428-1.153.326-.388 1.019-.523 1.58-.275.56.248.753.764.429 1.153-.326.386-1.018.524-1.581.275zm.992-3.808c-2.07-.028-4.538.537-7.344 2.641C-.405 17.1-.279 19.15.35 20.49c.528 1.123 1.494 1.773 2.43 2.144 4.878 1.935 10.857.606 13.679-1.35 2.934-2.035 4.033-4.771 3.157-7.165-.516-1.405-1.797-2.398-3.31-2.882l.06-.05c2.485-2.08 4.213-4.585 4.213-7.146 0-5.213-7.11-7.735-10.966-5.371-1.742 1.07-2.772 2.788-3.064 4.72.422-.12.865-.197 1.323-.23 3.271-.241 7.273.776 7.273 3.86 0 3.502-3.823 4.667-6.721 4.667-.89 0-1.785-.215-2.595-.598z`})],-1)]]),s(`button`,{class:`share-btn twitter`,title:`Twitter`,onClick:i},[...t[2]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z`})],-1)]]),s(`button`,{class:`share-btn copy`,title:`复制链接`,onClick:o},[...t[3]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71`}),s(`path`,{d:`M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71`})],-1)]]),n.value?(S(),c(`span`,ia,`已复制`)):b(``,!0)]))}},[[`__scopeId`,`data-v-857c6fb5`]]),oa={key:0,class:`related-section`},sa={class:`related-grid`},ca={key:0,class:`related-cover`},la=[`src`,`alt`],ua={class:`related-card-title`},da=y({__name:`RelatedArticles`,props:{articles:{type:Array,default:()=>[]}},setup(t){return(i,a)=>{let o=n(`router-link`);return t.articles.length?(S(),c(`section`,oa,[a[0]||=s(`h3`,{class:`related-title`},`相关文章`,-1),s(`div`,sa,[(S(!0),c(d,null,r(t.articles,t=>(S(),m(o,{key:t.slug,to:`/article/`+t.slug,class:`related-card`},{default:e(()=>[t.cover_image?(S(),c(`div`,ca,[s(`img`,{src:t.cover_image,alt:t.title,loading:`lazy`},null,8,la)])):b(``,!0),s(`span`,ua,l(t.title),1)]),_:2},1032,[`to`]))),128))])])):b(``,!0)}}},[[`__scopeId`,`data-v-e3d8298c`]]),fa={class:`newsletter glass-card`},pa=[`disabled`],ma=[`disabled`],ha={key:0},ga={key:1},_a={key:2},va=y({__name:`NewsletterForm`,setup(e){let t=w(``),n=w(!1),r=w(!1),i=w(``),a=w(``);async function o(){if(t.value.trim()){n.value=!0,i.value=``;try{let e=await T.post(`/subscribe/`,{email:t.value.trim()});r.value=!0,i.value=e.data.detail||`订阅成功！`,a.value=`msg-success`}catch(e){let t=e?.response?.data?.error||e?.response?.data?.detail||`订阅失败`;i.value=typeof t==`string`?t:`订阅失败，请稍后重试`,a.value=`msg-error`}finally{n.value=!1}}}return(e,u)=>(S(),c(`div`,fa,[u[1]||=_(`<h4 class="newsletter-title" data-v-54a32a66><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-54a32a66><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" data-v-54a32a66></path><polyline points="22,6 12,13 2,6" data-v-54a32a66></polyline></svg> 订阅更新 </h4><p class="newsletter-desc" data-v-54a32a66>新文章发布时，通过邮件通知你</p>`,2),s(`form`,{onSubmit:k(o,[`prevent`]),class:`newsletter-form`},[f(s(`input`,{"onUpdate:modelValue":u[0]||=e=>t.value=e,type:`email`,placeholder:`your@email.com`,class:`newsletter-input`,disabled:r.value,required:``},null,8,pa),[[O,t.value]]),s(`button`,{type:`submit`,class:`newsletter-btn`,disabled:n.value||r.value},[n.value?(S(),c(`span`,ha,`...`)):r.value?(S(),c(`span`,ga,`✓`)):(S(),c(`span`,_a,`订阅`))],8,ma)],32),i.value?(S(),c(`p`,{key:0,class:h(a.value)},l(i.value),3)):b(``,!0)]))}},[[`__scopeId`,`data-v-54a32a66`]]),ya=`个人博客Blog`,ba=`Zhou Jun 的个人博客 — 技术、编程、AI 与科学`;function xa(e={}){let{title:t=ya,description:n=ba,image:r=``,url:i=window.location.href}=e,a=t===`个人博客Blog`?t:`${t} | ${ya}`;document.title=a;let o=(e,t,n=!1)=>{if(!t)return;let r=n?`name`:`property`,i=document.querySelector(`meta[${r}="${e}"]`);i||(i=document.createElement(`meta`),i.setAttribute(r,e),document.head.appendChild(i)),i.setAttribute(`content`,t)};o(`description`,n,!0),o(`og:title`,a),o(`og:description`,n),o(`og:image`,r),o(`og:url`,i),o(`og:type`,`article`),o(`twitter:card`,r?`summary_large_image`:`summary`),o(`twitter:title`,a),o(`twitter:description`,n),o(`twitter:image`,r),((e,t)=>{if(!t)return;let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement(`link`),n.setAttribute(`rel`,e),document.head.appendChild(n)),n.setAttribute(`href`,t)})(`canonical`,i)}var Sa={title:ya,description:ba,image:``,url:``};function Ca(){xa({...Sa,url:window.location.origin+`/`});let e=document.querySelector(`meta[property="og:type"]`);e&&e.setAttribute(`content`,`website`);let t=document.querySelector(`link[rel="canonical"]`);t&&t.setAttribute(`href`,window.location.origin+`/`)}function wa(e){if(!e)return 1;let t=(e.match(/[一-鿿㐀-䶿]/g)||[]).length+(e.match(/[a-zA-Z]+/g)||[]).length;return Math.max(1,Math.ceil(t/250))}function Ta(e){return e?e.replace(/```[\s\S]*?```/g,``).replace(/`[^`]*`/g,``).replace(/!\[.*?\]\(.*?\)/g,``).replace(/\[([^\]]*)\]\(.*?\)/g,`$1`).replace(/[#*>`~\-+|_:]/g,` `).replace(/\s+/g,` `).trim():``}var Ea={class:`page page-article-detail`},Da={key:0,class:`detail-skeleton`},Oa={key:1,class:`error-state`},ka={key:2,class:`detail-layout`},Aa={class:`detail-main`},ja={class:`article-header`},Ma={class:`article-title`},Na={class:`article-meta`},Pa={class:`meta-item meta-author`},Fa={class:`meta-item meta-date`},Ia={key:0,class:`meta-item meta-category neon-text-pink`},La={class:`meta-item meta-reading-time`},Ra={class:`meta-item meta-views`},za={key:0,class:`article-tags`},Ba={key:0,class:`article-cover`},Va=[`src`,`alt`],Ha={key:1,class:`article-nav`},Ua={class:`nav-title`},Wa={class:`nav-title`},Ga={class:`article-actions`},Ka=[`disabled`],qa={class:`comment-section`},Ja={class:`detail-sidebar`},Ya=y({__name:`ArticleDetail`,setup(i){let o=E();D();let f=te(),y=w(null),x=w(!0),C=w(null),O=w(null),k=w(0),M=0,ne=v(()=>y.value?.created_at?new Date(y.value.created_at).toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}):``),N=v(()=>ee(y.value?.author)),re=v(()=>j(y.value?.category)),P=v(()=>{let e=y.value?.tags;return!e||!Array.isArray(e)?[]:e.map(A).filter(Boolean)}),F=w(!1),ie=w(!1),ae=v(()=>window.location.origin+o.fullPath),oe=v(()=>y.value?y.value.reading_time?y.value.reading_time:wa(Ta(y.value.content||``)):1),se=v(()=>y.value?JSON.stringify({"@context":`https://schema.org`,"@type":`Article`,headline:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||void 0,datePublished:y.value.created_at,dateModified:y.value.updated_at,author:{"@type":`Person`,name:`Zhou Jun`},publisher:{"@type":`Person`,name:`Zhou Jun`}}):``),I=null;p(se,e=>{if(!e){I?.remove(),I=null;return}I||(I=document.createElement(`script`),I.type=`application/ld+json`,I.dataset.articleJsonLd=`1`,document.head.appendChild(I)),I.textContent=e},{immediate:!0});async function L(){if(!(F.value||ie.value)){ie.value=!0;try{let e=await T.post(`/articles/${y.value.slug}/like/`);y.value&&(y.value.likes_count=e.data.likes_count),F.value=!0}catch{}finally{ie.value=!1}}}async function R(){let e=o.params.slug,t=++M;if(!e){C.value=`缺少文章标识`,O.value=null,x.value=!1;return}x.value=!0,C.value=null,O.value=null,y.value=null,F.value=!1;try{let n=f.getArticleBySlug(e);if(n){if(t!==M)return;y.value=n,x.value=!1,ce();return}let r=await f.fetchArticleBySlug(e);if(t!==M)return;y.value=r,y.value?ce():C.value=`文章不存在`}catch(e){if(t!==M)return;O.value=e?.response?.status??null,O.value===404?C.value=`文章不存在`:C.value=e?.response?.data?.detail||e.message||`加载文章失败`}finally{t===M&&(x.value=!1)}}function ce(){y.value&&xa({title:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||``,url:window.location.origin+o.fullPath})}return a(R),p(()=>o.params.slug,()=>{window.scrollTo({top:0,behavior:`instant`}),k.value++,R()}),t(()=>{Ca(),I?.remove(),I=null}),(t,i)=>{let a=n(`router-link`);return S(),c(`div`,Ea,[x.value?(S(),c(`div`,Da,[...i[1]||=[_(`<div class="skeleton-header" data-v-c0862088><div class="skeleton-line w-80 skeleton-lg" data-v-c0862088></div><div class="skeleton-meta-row" data-v-c0862088><div class="skeleton-line w-20" data-v-c0862088></div><div class="skeleton-line w-15" data-v-c0862088></div><div class="skeleton-line w-10" data-v-c0862088></div></div></div><div class="skeleton-body" data-v-c0862088><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-90" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-70" data-v-c0862088></div></div>`,2)]])):C.value?(S(),c(`div`,Oa,[i[3]||=s(`svg`,{width:`48`,height:`48`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`line`,{x1:`12`,y1:`8`,x2:`12`,y2:`12`}),s(`line`,{x1:`12`,y1:`16`,x2:`12.01`,y2:`16`})],-1),s(`h2`,null,l(O.value===404?`文章不存在`:`加载失败`),1),s(`p`,null,l(C.value),1),u(a,{to:`/articles`,class:`back-link`},{default:e(()=>[...i[2]||=[g(`返回首页`,-1)]]),_:1})])):y.value?(S(),c(`div`,ka,[s(`article`,Aa,[s(`header`,ja,[s(`h1`,Ma,l(y.value.title),1),s(`div`,Na,[s(`span`,Pa,[i[4]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2`}),s(`circle`,{cx:`12`,cy:`7`,r:`4`})],-1),g(` `+l(N.value),1)]),s(`span`,Fa,[i[5]||=_(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-c0862088><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-c0862088></rect><line x1="16" y1="2" x2="16" y2="6" data-v-c0862088></line><line x1="8" y1="2" x2="8" y2="6" data-v-c0862088></line><line x1="3" y1="10" x2="21" y2="10" data-v-c0862088></line></svg>`,1),g(` `+l(ne.value),1)]),y.value.category?(S(),c(`span`,Ia,[i[6]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z`})],-1),g(` `+l(re.value),1)])):b(``,!0),s(`span`,La,[i[7]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`polyline`,{points:`12 6 12 12 16 14`})],-1),g(` 约 `+l(oe.value)+` 分钟 `,1)]),s(`span`,Ra,[i[8]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z`}),s(`circle`,{cx:`12`,cy:`12`,r:`3`})],-1),g(` `+l(y.value.views_count||0),1)])]),P.value.length?(S(),c(`div`,za,[(S(!0),c(d,null,r(P.value,(e,t)=>(S(),c(`span`,{key:t,class:`tag-pill`},l(e),1))),128))])):b(``,!0)]),y.value.cover_image?(S(),c(`div`,Ba,[s(`img`,{src:y.value.cover_image,alt:y.value.title},null,8,Va)])):b(``,!0),u(di,{html:y.value.html_content||y.value.content||``,title:y.value.title},null,8,[`html`,`title`]),y.value.prev_article||y.value.next_article?(S(),c(`nav`,Ha,[y.value.prev_article?(S(),m(a,{key:0,to:`/article/`+(y.value.prev_article.slug||y.value.prev_article),class:`nav-link prev-link`},{default:e(()=>[i[9]||=s(`span`,{class:`nav-direction`},[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`15 18 9 12 15 6`})]),g(` 上一篇 `)],-1),s(`span`,Ua,l(y.value.prev_article.title||y.value.prev_article),1)]),_:1},8,[`to`])):b(``,!0),y.value.next_article?(S(),m(a,{key:1,to:`/article/`+(y.value.next_article.slug||y.value.next_article),class:`nav-link next-link`},{default:e(()=>[i[10]||=s(`span`,{class:`nav-direction`},[g(` 下一篇 `),s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 18 15 12 9 6`})])],-1),s(`span`,Wa,l(y.value.next_article.title||y.value.next_article),1)]),_:1},8,[`to`])):b(``,!0)])):b(``,!0),s(`div`,Ga,[u(aa,{title:y.value.title,url:ae.value},null,8,[`title`,`url`]),s(`button`,{class:h([`like-btn`,{liked:F.value}]),disabled:ie.value,onClick:L},[i[11]||=s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z`})],-1),s(`span`,null,l(y.value.likes_count||0),1)],10,Ka)]),u(da,{articles:y.value.related_articles||[]},null,8,[`articles`]),u(va),s(`section`,qa,[(S(),m(Xi,{"article-slug":y.value.slug,key:k.value},null,8,[`article-slug`])),u(ki,{"article-slug":y.value.slug,onSubmitted:i[0]||=e=>k.value++},null,8,[`article-slug`])])]),s(`aside`,Ja,[u(na,{html:y.value.html_content||y.value.content||``},null,8,[`html`])])])):b(``,!0)])}}},[[`__scopeId`,`data-v-c0862088`]]);export{Ya as default};