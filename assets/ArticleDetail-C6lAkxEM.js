...
`;function Ws(){if(document.getElementById(ks))return;let e=document.createElement(`style`);e.id=ks,e.textContent=Us,document.head.appendChild(e)}function Gs(e,t={}){if(!e||e.dataset.tsMounted===`1`)return{destroy(){}};e.dataset.tsMounted=`1`,Ws();let n=Os(t),r=t.autoplay!==!1,i=Array.isArray(t.nums)?t.nums:[2,7,11,15],a=Number.isInteger(t.target)?t.target:9,o=i.length,s=X,c=document.createElement(`div`);c.className=`viz ts`;let l=document.createElement(`div`);l.className=`viz__stage`,c.appendChild(l);function u(){let e=document.createElement(`p`);return e.className=`viz__desc`,e.setAttribute(`aria-live`,`polite`),e}if(o===0){let t=s(`svg`,{class:`viz__svg ts__svg`,viewBox:`0 0 620 120`,role:`img`}),n=s(`text`,{class:`ts-empty__text`,x:620/2,y:120/2});return n.textContent=`空数组 —— 凑不出两个数`,t.appendChild(n),l.appendChild(t),c.appendChild(u()),c.appendChild(Q().root),e.textContent=``,e.appendChild(c),{destroy(){e.textContent=``,delete e.dataset.tsMounted,document.getElementById(ks)?.remove()}}}let d=js,f=Ms,p=20,m=o*d+(o-1)*f;if(m>Hs){let e=Hs/m;d=Math.max(28,Math.floor(d*e)),f=Math.max(4,Math.floor(f*e)),p=Math.max(12,Math.round(p*e))}let h=o*d+(o-1)*f,g=Math.max(660,zs*2+h+68),_=(g-h)/2,v=e=>_+e*(d+f),y=Math.min(620,g-zs*2),b=s(`svg`,{class:`viz__svg ts__svg`,viewBox:`0 0 ${g} 450`,role:`img`,"aria-label":`两数之和推演动画`});l.appendChild(b);let x=s(`g`,{class:`ts-arcs`}),S=s(`g`,{class:`ts-cells`}),C=s(`g`,{class:`ts-marks`});b.appendChild(x),b.appendChild(S),b.appendChild(C);let w=s(`path`,{class:`ts-arc`,d:`M 0 0`});x.appendChild(w);let T=[];for(let e=0;e<o;e+=1){let t=v(e),n=s(`g`,{class:`ts-cell`});n.appendChild(s(`rect`,{class:`ts-cell__ring`,x:t-5,y:Ns-5,width:d+10,height:66,rx:11})),n.appendChild(s(`rect`,{class:`ts-cell__box`,x:t,y:Ns,width:d,height:As,rx:8}));let r=s(`text`,{class:`ts-cell__value`,x:t+d/2,y:158,style:`font-size:${p}px`});r.textContent=String(i[e]),n.appendChild(r);let a=s(`text`,{class:`ts-cell__idx`,x:t+d/2,y:202});a.textContent=String(e),n.appendChild(a),S.appendChild(n),T.push({g:n,id:e})}let E=s(`path`,{class:`ts-ipin__tri`,d:`M 0 0 L 0 0 L 0 0`}),D=s(`text`,{class:`ts-ipin__text`,x:0,y:0});D.textContent=`i`,C.appendChild(E),C.appendChild(D);let O=s(`text`,{class:`ts-table__title`,x:zs,y:Is});O.textContent=`seen：见过的值 → 它的下标`,C.appendChild(O);let k=s(`text`,{class:`ts-table__empty`,x:zs,y:312});k.textContent=`（表还是空的）`,C.appendChild(k);let A=o>8?6:10,j=Math.max(40,Math.min(74,Math.floor((Hs-(Math.max(1,o)-1)*A)/Math.max(1,o)))),M=[];for(let e=0;e<o;e+=1){let t=zs+e*(j+A),n=s(`g`,{class:`ts-card`});n.appendChild(s(`rect`,{class:`ts-card__box`,x:t,y:Ls,width:j,height:Rs,rx:8}));let r=s(`text`,{class:`ts-card__key`,x:t+j/2,y:305});n.appendChild(r);let i=s(`text`,{class:`ts-card__val`,x:t+j/2,y:323});n.appendChild(i),C.appendChild(n),M.push({g:n,k:r,val:i})}let N=s(`rect`,{class:`ts-banner__box`,x:zs,y:372,width:y,height:Bs,rx:9});b.appendChild(N);let P=s(`text`,{class:`ts-banner__lead`,x:42,y:398});b.appendChild(P);let F=s(`text`,{class:`ts-banner__label`,x:zs+y-84,y:398});F.textContent=`答案下标`,b.appendChild(F);let I=s(`text`,{class:`ts-banner__ans`,x:zs+y-16,y:398});I.textContent=`—`,b.appendChild(I);let L=u();function R(e,t){if(!t)return;let n=t.seen??{},r=t.answer,s=t.i,c=new Set(r?[r[0],r[1]]:[]),l=new Set(Object.keys(n).map(Number));for(let e of T){let{g:n,id:r}=e,a=[`ts-cell`];l.has(i[r])&&a.push(`is-seen`),r===s&&t.phase!==`done`&&a.push(`is-cur`),c.has(r)&&a.push(`is-answer`),n.setAttribute(`class`,a.join(` `))}if(s>=0&&s<o&&t.phase!==`done`){let e=v(s)+d/2,t=Ns-Ps;E.setAttribute(`d`,`M ${e-6} ${t-10} L ${e+6} ${t-10} L ${e} ${t} z`),D.setAttribute(`x`,e),D.setAttribute(`y`,t-20),D.textContent=`i=${s}`,E.style.opacity=`1`,D.style.opacity=`1`}else E.style.opacity=`0`,D.style.opacity=`0`;if(r){let e=v(r[0])+d/2,t=v(r[1])+d/2,n=(e+t)/2;w.setAttribute(`d`,`M ${e} ${Fs} Q ${n} 240 ${t} ${Fs}`),w.style.opacity=`1`}else w.style.opacity=`0`;let u=Object.entries(n);u.length===0?k.style.opacity=`1`:k.style.opacity=`0`,M.forEach((e,n)=>{let r=u[n];if(r===void 0){e.g.style.opacity=`0`;return}let[i,a]=r;e.g.style.opacity=`1`,e.k.textContent=i,e.val.textContent=`↓${a}`;let o=t.phase===`put`&&Number(i)===t.x&&a===t.i,s=t.hitIdx!==null&&Number(a)===t.hitIdx&&t.phase===`hit`;e.g.setAttribute(`class`,`ts-card${s?` is-hit`:o?` is-new`:``}`)}),N.setAttribute(`class`,r?`ts-banner__box is-answer`:`ts-banner__box`),I.textContent=r?`[${r[0]}, ${r[1]}]`:`—`,t.phase===`init`?P.textContent=`nums = [${i.join(`, `)}]，target = ${a}`:t.phase===`miss`?P.textContent=`需要 ${a} - ${t.x} = ${t.need}，查表：没有`:t.phase===`put`?P.textContent=`把 ${t.x} → ${t.i} 登记进表`:t.phase===`hit`?P.textContent=`需要 ${a} - ${t.x} = ${t.need}，查表：命中下标 ${t.hitIdx}`:t.phase===`verify`?P.textContent=`验证 ${i[r[0]]} + ${i[r[1]]} = ${a} ✓`:P.textContent=r?`完成：nums[${r[0]}] + nums[${r[1]}] = ${a}`:`没有找到任何一对`,Z(L,t.desc)}c.appendChild(L);let z=Q();c.appendChild(z.root),e.textContent=``,e.appendChild(c),pt();let B=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches,V=ht({steps:n,controls:z,intervalMs:Vs,onRender:R});V.jumpTo(Math.trunc(t.initialStep)||0);let H=null;return r&&!B&&typeof IntersectionObserver==`function`&&(H=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){H.disconnect(),H=null,V.play();return}},{threshold:.35}),H.observe(c)),{destroy(){H&&=(H.disconnect(),null),V.destroy(),e.textContent=``,delete e.dataset.tsMounted,document.getElementById(ks)?.remove()}}}var Ks=[`innerHTML`],qs=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,Js=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,Ys=`0.16.21`,Xs=`11.4.1`,Zs=y({__name:`MarkdownView`,props:{html:{type:String,default:``},title:{type:String,default:``}},setup(e){let t=e,n=w(null),r=v(()=>st(ot.sanitize(t.html,{ADD_ATTR:[`target`,`rel`],FORBID_TAGS:[`style`,`iframe`,`object`,`embed`,`form`],FORBID_ATTR:[`onerror`,`onload`,`onclick`]}),t.title));function i(e){e.classList.add(`copied`),e.innerHTML=Js,setTimeout(()=>{e.classList.remove(`copied`),e.innerHTML=qs},2e3)}function s(){n.value&&n.value.querySelectorAll(`table`).forEach(e=>{if(e.parentElement?.classList.contains(`table-scroll`))return;let t=document.createElement(`div`);t.className=`table-scroll`,e.parentNode.insertBefore(t,e),t.appendChild(e)})}function l(){n.value&&n.value.querySelectorAll(`pre`).forEach(e=>{if(e.parentElement?.classList.contains(`code-block-wrapper`))return;let t=document.createElement(`div`);t.className=`code-block-wrapper`,e.parentNode.insertBefore(t,e),t.appendChild(e);let n=document.createElement(`button`);n.className=`copy-btn`,n.title=`复制代码`,n.innerHTML=qs,n.addEventListener(`click`,()=>{let t=(e.querySelector(`code`)||e).textContent||``;navigator.clipboard.writeText(t).then(()=>{i(n)}).catch(()=>{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),i(n)})}),t.appendChild(n)})}function u(e,t){return new Promise((n,r)=>{if(document.querySelector(`link[data-lib-href="${e}"]`))return n();let i=document.createElement(`link`);i.rel=`stylesheet`,i.href=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libHref=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load stylesheet `+e)),document.head.appendChild(i)})}function d(e,t){return new Promise((n,r)=>{if(document.querySelector(`script[data-lib-src="${e}"]`))return n();let i=document.createElement(`script`);i.src=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libSrc=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load script `+e)),document.head.appendChild(i)})}let f=null;async function m(){return f||=Promise.all([u(`https://cdn.jsdelivr.net/npm/katex@${Ys}/dist/katex.min.css`,`sha384-zh0CIslj+VczCZtlzBcjt5ppRcsAmDnRem7ESsYwWwg3m/OaJ2l4x7YBZl9Kxxib`),d(`https://cdn.jsdelivr.net/npm/katex@${Ys}/dist/katex.min.js`,`sha384-Rma6DA2IPUwhNxmrB/7S3Tno0YY7sFu9WSYMCuulLhIqYSGZ2gKCJWIqhBWqMQfh`)]).then(()=>window.katex),f}let h=null;async function g(){return h||=d(`https://cdn.jsdelivr.net/npm/mermaid@${Xs}/dist/mermaid.min.js`,`sha384-rbtjAdnIQE/aQJGEgXrVUlMibdfTSa4PQju4HDhN3sR2PmaKFzhEafuePsl9H/9I`).then(()=>window.mermaid),h}async function _(){if(!n.value)return;let e=n.value.querySelectorAll(`code.language-mermaid`);if(e.length)try{let t=await g();e.forEach(e=>{let n=e.closest(`pre`);if(!n||n.dataset.mermaidRendered)return;n.dataset.mermaidRendered=`1`;let r=document.createElement(`div`);r.className=`mermaid-container`,r.textContent=e.textContent,n.parentNode.replaceChild(r,n),t.run({nodes:[r]})})}catch(e){console.warn(`Mermaid failed to load/render:`,e?.message||e)}n.value.querySelectorAll(`img`).forEach(e=>{let t=e.getAttribute(`src`)||``;e.getAttribute(`alt`);let n=t.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([\w-]+)/);if(n){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://www.youtube.com/embed/${n[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}let r=t.match(/bilibili\.com\/video\/(BV[\w]+)/);if(r){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://player.bilibili.com/player.html?bvid=${r[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}});let t=/(\$\$[\s\S]+?\$\$|\$[^\s$](?:[^$]*[^\s$])?\$)/,r=document.createTreeWalker(n.value,NodeFilter.SHOW_TEXT),i=[],a;for(;a=r.nextNode();)!a.nodeValue||!t.test(a.nodeValue)||a.parentElement?.closest(`pre, code`)||i.push(a);if(i.length)try{let e=await m();for(let n of i){let r=document.createDocumentFragment();for(let i of n.nodeValue.split(t)){if(!i)continue;let t=i.startsWith(`$$`)&&i.endsWith(`$$`)&&i.length>3,n=!t&&i.startsWith(`$`)&&i.endsWith(`$`)&&i.length>2;if(!t&&!n){r.appendChild(document.createTextNode(i));continue}let a=i.slice(t?2:1,t?-2:-1),o=document.createElement(`span`);o.innerHTML=e.renderToString(a,{displayMode:t,throwOnError:!1}),r.appendChild(o)}n.parentNode.replaceChild(r,n)}}catch(e){console.warn(`KaTeX failed to load/render:`,e?.message||e)}}let y={"algo-viz--lc206":Ft,"algo-viz--lc21":nn,"algo-viz--lc23":Pn,"algo-viz--lc23dc":$n,"algo-viz--lc141":Er,"algo-viz--lc142":Br,"algo-viz--lc19":ai,"algo-viz--lc143":Ei,"algo-viz--lc234":Yi,"algo-viz--lc160":ba,"algo-viz--lc82":Wa,"algo-viz--lc102":ao,"algo-viz--lc236":bo,"algo-viz--lc124":No,"algo-viz--lc104":Ko,"algo-viz--lc226":os,"algo-viz--lc3":Ds,"algo-viz--lc1":Gs},b=[];function x(){b.forEach(e=>{try{e?.destroy?.()}catch(e){console.warn(`Algo viz teardown failed:`,e?.message||e)}}),b=[]}function T(){n.value&&(x(),n.value.querySelectorAll(`.algo-viz`).forEach(e=>{let t=Object.keys(y).find(t=>e.classList.contains(t));if(t)try{b.push(y[t](e))}catch(e){console.warn(`Algo viz failed to mount:`,t,e?.message||e)}}))}return a(()=>{o(()=>{T(),_(),s(),l()})}),C(x),p(()=>t.html,()=>{o(()=>{T(),_(),s(),l()})}),(e,t)=>(S(),c(`div`,{ref_key:`bodyRef`,ref:n,class:`markdown-body`,innerHTML:r.value},null,8,Ks))}},[[`__scopeId`,`data-v-932ab30a`]]);function Qs(e){return T.get(`/articles/${e}/comments/`)}function $s(e,t){return T.post(`/articles/${e}/comments/`,t)}var ec={key:0,class:`form-title`},tc={key:1,class:`form-title`},nc={class:`form-field`},rc={key:0,class:`field-error`},ic={class:`form-field`},ac={key:0,class:`field-error`},oc={class:`hp-field`,"aria-hidden":`true`},sc={class:`form-field`},cc={key:0,class:`field-error`},lc={key:0,class:`submit-error`},uc={key:1,class:`submit-success`},dc={class:`form-actions`},fc=[`disabled`],pc={key:0,class:`spinner`},mc={key:1},hc=y({__name:`CommentForm`,props:{articleSlug:{type:String,required:!0},parentId:{type:[Number,String],default:null}},emits:[`submitted`,`cancel`],setup(e,{emit:t}){let n=e,r=t,a=i({author_name:``,author_email:``,content:``,website:``}),o=i({author_name:``,author_email:``,content:``}),u=w(!1),d=w(null),p=w(!1);function m(){let e=!0;return o.author_name=``,o.author_email=``,o.content=``,a.author_name.trim()||(o.author_name=`请输入昵称`,e=!1),a.author_email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.author_email)||(o.author_email=`邮箱格式不正确`,e=!1):(o.author_email=`请输入邮箱`,e=!1),a.content.trim()?a.content.trim().length<3&&(o.content=`评论内容至少3个字符`,e=!1):(o.content=`请输入评论内容`,e=!1),e}function g(e){o[e]&&(o[e]=``),d.value=null}async function _(){if(m()){u.value=!0,d.value=null;try{let e={author_name:a.author_name.trim(),author_email:a.author_email.trim(),content:a.content.trim(),website:a.website};n.parentId&&(e.parent=n.parentId),await $s(n.articleSlug,e),p.value=!0,setTimeout(()=>{p.value=!1},3e3),r(`submitted`),a.author_name=``,a.author_email=``,a.content=``}catch(e){let t=e?.response?.data;if(typeof t==`object`&&t){let e=t;e.author_name&&(o.author_name=Array.isArray(e.author_name)?e.author_name[0]:e.author_name),e.author_email&&(o.author_email=Array.isArray(e.author_email)?e.author_email[0]:e.author_email),e.content&&(o.content=Array.isArray(e.content)?e.content[0]:e.content),e.detail&&(d.value=e.detail),e.non_field_errors&&(d.value=Array.isArray(e.non_field_errors)?e.non_field_errors[0]:e.non_field_errors)}else typeof t==`string`?d.value=t:d.value=e.message||`提交失败，请稍后重试`}finally{u.value=!1}}}return(t,n)=>(S(),c(`div`,{class:h([`comment-form`,{"reply-form":!!e.parentId}])},[e.parentId?(S(),c(`h4`,ec,`回复评论`)):(S(),c(`h4`,tc,`发表评论`)),s(`form`,{onSubmit:k(_,[`prevent`]),class:`form-body`},[s(`div`,nc,[f(s(`input`,{"onUpdate:modelValue":n[0]||=e=>a.author_name=e,type:`text`,placeholder:`昵称 *`,class:h([`form-input`,{"input-error":o.author_name}]),onInput:n[1]||=e=>g(`author_name`)},null,34),[[O,a.author_name]]),o.author_name?(S(),c(`p`,rc,l(o.author_name),1)):b(``,!0)]),s(`div`,ic,[f(s(`input`,{"onUpdate:modelValue":n[2]||=e=>a.author_email=e,type:`email`,placeholder:`邮箱 *`,class:h([`form-input`,{"input-error":o.author_email}]),onInput:n[3]||=e=>g(`author_email`)},null,34),[[O,a.author_email]]),o.author_email?(S(),c(`p`,ac,l(o.author_email),1)):b(``,!0)]),s(`div`,oc,[f(s(`input`,{"onUpdate:modelValue":n[4]||=e=>a.website=e,type:`text`,tabindex:`-1`,autocomplete:`off`},null,512),[[O,a.website]])]),s(`div`,sc,[f(s(`textarea`,{"onUpdate:modelValue":n[5]||=e=>a.content=e,placeholder:`说点什么...`,rows:`4`,class:h([`form-textarea`,{"input-error":o.content}]),onInput:n[6]||=e=>g(`content`)},null,34),[[O,a.content]]),o.content?(S(),c(`p`,cc,l(o.content),1)):b(``,!0)]),d.value?(S(),c(`p`,lc,l(d.value),1)):b(``,!0),p.value?(S(),c(`p`,uc,`评论已提交！`)):b(``,!0),s(`div`,dc,[e.parentId?(S(),c(`button`,{key:0,type:`button`,class:`cancel-btn`,onClick:n[7]||=e=>t.$emit(`cancel`)},` 取消回复 `)):b(``,!0),s(`button`,{type:`submit`,class:`submit-btn`,disabled:u.value},[u.value?(S(),c(`span`,pc)):(S(),c(`span`,mc,`提交`))],8,fc)])],32)],2))}},[[`__scopeId`,`data-v-49410be9`]]),gc={class:`comment-list`},_c={class:`comments-title`},vc={key:0,class:`comments-count`},yc={key:0,class:`skeleton-comments`},bc={key:1,class:`empty-comments`},xc={key:2,class:`comments-tree`},Sc={class:`comment-main`},Cc={class:`comment-content`},wc={class:`comment-header`},Tc={class:`comment-author`},Ec={class:`comment-time`},Dc={class:`comment-text`},Oc=[`onClick`],kc={key:1,class:`replies`},Ac={class:`comment-main`},jc={class:`comment-content`},Mc={class:`comment-header`},Nc={class:`comment-author`},Pc={class:`comment-time`},Fc={class:`comment-text`},Ic=y({__name:`CommentList`,props:{articleSlug:{type:String,required:!0}},setup(e){let t=e,n=w([]),i=w(!0),o=w(null),u=v(()=>n.value.filter(e=>!e.parent));function f(e){o.value=o.value===e?null:e}async function p(){i.value=!0;try{let e=await Qs(t.articleSlug);n.value=e.data.results||e.data||[]}catch{n.value=[]}finally{i.value=!1}}function h(){o.value=null,p()}function y(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<1?`刚刚`:n<60?`${n}分钟前`:r<24?`${r}小时前`:i<30?`${i}天前`:i<365?`${Math.floor(i/30)}个月前`:`${Math.floor(i/365)}年前`}function C(e){let t=[`#3f6b57`,`#a45f45`,`#8a6c3f`,`#637b68`,`#7b6757`,`#4f7477`,`#8a635f`,`#6b7250`,`#536b5d`,`#9b704e`,`#65706a`,`#7b6a83`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}return a(p),(t,a)=>(S(),c(`div`,gc,[s(`h3`,_c,[a[1]||=g(` 评论 `,-1),n.value.length?(S(),c(`span`,vc,`(`+l(n.value.length)+`)`,1)):b(``,!0)]),i.value?(S(),c(`div`,yc,[(S(),c(d,null,r(3,e=>s(`div`,{key:e,class:`skeleton-comment`},[...a[2]||=[_(`<div class="skeleton-avatar" data-v-98dfce57></div><div class="skeleton-body" data-v-98dfce57><div class="skeleton-line w-30" data-v-98dfce57></div><div class="skeleton-line w-50" data-v-98dfce57></div><div class="skeleton-line w-80" data-v-98dfce57></div></div>`,2)]])),64))])):u.value.length?(S(),c(`div`,xc,[(S(!0),c(d,null,r(u.value,t=>(S(),c(`div`,{key:t.id,class:`comment-item`},[s(`div`,Sc,[s(`div`,{class:`comment-avatar`,style:x({background:C(t.author_name)})},l(t.author_name?t.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,Cc,[s(`div`,wc,[s(`span`,Tc,l(t.author_name),1),s(`span`,Ec,l(y(t.created_at)),1)]),s(`p`,Dc,l(t.content),1),s(`button`,{class:`reply-btn`,onClick:e=>f(t.id)},[...a[4]||=[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 17 4 12 9 7`}),s(`path`,{d:`M20 18v-2a4 4 0 0 0-4-4H4`})],-1),g(` 回复 `,-1)]],8,Oc)])]),o.value===t.id?(S(),m(hc,{key:0,"article-slug":e.articleSlug,"parent-id":t.id,onSubmitted:h,onCancel:a[0]||=e=>o.value=null,class:`reply-form-wrapper`},null,8,[`article-slug`,`parent-id`])):b(``,!0),t.replies&&t.replies.length?(S(),c(`div`,kc,[(S(!0),c(d,null,r(t.replies,e=>(S(),c(`div`,{key:e.id,class:`comment-item reply-item`},[s(`div`,Ac,[s(`div`,{class:`comment-avatar comment-avatar-sm`,style:x({background:C(e.author_name)})},l(e.author_name?e.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,jc,[s(`div`,Mc,[s(`span`,Nc,l(e.author_name),1),s(`span`,Pc,l(y(e.created_at)),1)]),s(`p`,Fc,l(e.content),1)])])]))),128))])):b(``,!0)]))),128))])):(S(),c(`div`,bc,[...a[3]||=[s(`svg`,{width:`40`,height:`40`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z`})],-1),s(`p`,null,`暂无评论，来说点什么吧`,-1)]]))]))}},[[`__scopeId`,`data-v-98dfce57`]]),Lc={key:0,class:`toc-list-wrapper`},Rc={class:`toc-list`},zc=[`href`,`title`,`onClick`],Bc={class:`toc-text`},Vc={key:1,class:`toc-empty-state`},Hc=y({__name:`TocNav`,props:{html:{type:String,default:``}},setup(e){let t=e,n=w([]),i=w(null),u=null,f=[];function m(){if(!t.html){n.value=[];return}try{let e=new DOMParser().parseFromString(t.html,`text/html`),r=[];e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let n=e.id||`toc-heading-${t}`;r.push({id:n,tag:e.tagName.toLowerCase(),text:e.textContent||``})}),n.value=r}catch{n.value=[]}}function g(){if(!n.value.length)return;let e=document.querySelector(`.markdown-body`);e&&e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let r=n.value[t];r&&!e.id&&(e.id=r.id)})}function _(){u&&=(u.disconnect(),null),f=[],n.value.length&&(u=new IntersectionObserver(e=>{let t=e.filter(e=>e.isIntersecting);t.length?i.value=t[0].target.id:window.scrollY<100&&(i.value=n.value[0]?.id||null)},{rootMargin:`-80px 0px -60% 0px`,threshold:0}),o(()=>{n.value.forEach(e=>{let t=document.getElementById(e.id);t&&(u.observe(t),f.push(t))})}))}function v(e){let t=document.getElementById(e);t&&(t.scrollIntoView({behavior:`smooth`,block:`start`}),i.value=e)}return p(()=>t.html,()=>{m(),o(()=>{g(),_()})}),a(()=>{m(),o(()=>{g(),_()})}),C(()=>{u&&u.disconnect()}),(e,t)=>(S(),c(`nav`,{class:h([`toc-nav`,{"toc-empty":!n.value.length}])},[t[2]||=s(`h4`,{class:`toc-title`},`目录`,-1),n.value.length?(S(),c(`div`,Lc,[s(`ul`,Rc,[(S(!0),c(d,null,r(n.value,e=>(S(),c(`li`,{key:e.id,class:h([`toc-item`,[`toc-depth-${e.tag}`,{"toc-active":i.value===e.id}]])},[s(`a`,{href:`#`+e.id,class:`toc-link`,title:e.text,onClick:k(t=>v(e.id),[`prevent`])},[t[0]||=s(`span`,{class:`toc-dot`},null,-1),s(`span`,Bc,l(e.text),1)],8,zc)],2))),128))])])):(S(),c(`div`,Vc,[...t[1]||=[s(`p`,null,`无目录`,-1)]]))],2))}},[[`__scopeId`,`data-v-21d21cb1`]]),Uc={class:`share-buttons`},Wc={key:0,class:`copy-feedback`},Gc=y({__name:`ShareButtons`,props:{title:{type:String,default:``},url:{type:String,default:``}},setup(e){let t=e,n=w(!1);function r(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://service.weibo.com/share/share.php?url=${e}&title=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function i(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://twitter.com/intent/tweet?url=${e}&text=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function a(){alert(`请复制链接后在微信中粘贴发送`)}async function o(){try{await navigator.clipboard.writeText(t.url||window.location.href),n.value=!0,setTimeout(()=>n.value=!1,2e3)}catch{let e=document.createElement(`textarea`);e.value=t.url||window.location.href,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),n.value=!0,setTimeout(()=>n.value=!1,2e3)}}return(e,t)=>(S(),c(`div`,Uc,[t[4]||=s(`span`,{class:`share-label`},`分享：`,-1),s(`button`,{class:`share-btn wechat`,title:`微信`,onClick:a},[...t[0]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178A1.17 1.17 0 0 1 4.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178 1.17 1.17 0 0 1-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229.826 0 1.622-.12 2.361-.336a.722.722 0 0 1 .598.082l1.584.926a.272.272 0 0 0 .14.045c.136 0 .241-.11.241-.245 0-.06-.024-.12-.04-.178l-.325-1.233a.49.49 0 0 1 .178-.554C23.028 18.48 24 16.82 24 14.98c0-3.21-2.931-5.952-7.062-6.122zm-2.18 2.769c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982zm4.844 0c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982z`})],-1)]]),s(`button`,{class:`share-btn weibo`,title:`微博`,onClick:r},[...t[1]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M10.098 20.323c-3.977.391-7.414-1.406-7.672-4.02-.259-2.609 2.759-5.047 6.74-5.441 3.979-.394 7.413 1.404 7.671 4.018.259 2.6-2.759 5.049-6.739 5.443zm-7.317-6.781c-1.059-.2-1.911.419-1.903 1.383.008.964.87 1.907 1.93 2.107 1.058.2 1.91-.419 1.903-1.383-.008-.964-.87-1.907-1.93-2.107zm2.13 3.68c-.563-.249-.754-.766-.428-1.153.326-.388 1.019-.523 1.58-.275.56.248.753.764.429 1.153-.326.386-1.018.524-1.581.275zm.992-3.808c-2.07-.028-4.538.537-7.344 2.641C-.405 17.1-.279 19.15.35 20.49c.528 1.123 1.494 1.773 2.43 2.144 4.878 1.935 10.857.606 13.679-1.35 2.934-2.035 4.033-4.771 3.157-7.165-.516-1.405-1.797-2.398-3.31-2.882l.06-.05c2.485-2.08 4.213-4.585 4.213-7.146 0-5.213-7.11-7.735-10.966-5.371-1.742 1.07-2.772 2.788-3.064 4.72.422-.12.865-.197 1.323-.23 3.271-.241 7.273.776 7.273 3.86 0 3.502-3.823 4.667-6.721 4.667-.89 0-1.785-.215-2.595-.598z`})],-1)]]),s(`button`,{class:`share-btn twitter`,title:`Twitter`,onClick:i},[...t[2]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z`})],-1)]]),s(`button`,{class:`share-btn copy`,title:`复制链接`,onClick:o},[...t[3]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71`}),s(`path`,{d:`M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71`})],-1)]]),n.value?(S(),c(`span`,Wc,`已复制`)):b(``,!0)]))}},[[`__scopeId`,`data-v-857c6fb5`]]),Kc={key:0,class:`related-section`},qc={class:`related-grid`},Jc={key:0,class:`related-cover`},Yc=[`src`,`alt`],Xc={class:`related-card-title`},Zc=y({__name:`RelatedArticles`,props:{articles:{type:Array,default:()=>[]}},setup(t){return(i,a)=>{let o=n(`router-link`);return t.articles.length?(S(),c(`section`,Kc,[a[0]||=s(`h3`,{class:`related-title`},`相关文章`,-1),s(`div`,qc,[(S(!0),c(d,null,r(t.articles,t=>(S(),m(o,{key:t.slug,to:`/article/`+t.slug,class:`related-card`},{default:e(()=>[t.cover_image?(S(),c(`div`,Jc,[s(`img`,{src:t.cover_image,alt:t.title,loading:`lazy`},null,8,Yc)])):b(``,!0),s(`span`,Xc,l(t.title),1)]),_:2},1032,[`to`]))),128))])])):b(``,!0)}}},[[`__scopeId`,`data-v-e3d8298c`]]),Qc={class:`newsletter glass-card`},$c=[`disabled`],el=[`disabled`],tl={key:0},nl={key:1},rl={key:2},il=y({__name:`NewsletterForm`,setup(e){let t=w(``),n=w(!1),r=w(!1),i=w(``),a=w(``);async function o(){if(t.value.trim()){n.value=!0,i.value=``;try{let e=await T.post(`/subscribe/`,{email:t.value.trim()});r.value=!0,i.value=e.data.detail||`订阅成功！`,a.value=`msg-success`}catch(e){let t=e?.response?.data?.error||e?.response?.data?.detail||`订阅失败`;i.value=typeof t==`string`?t:`订阅失败，请稍后重试`,a.value=`msg-error`}finally{n.value=!1}}}return(e,u)=>(S(),c(`div`,Qc,[u[1]||=_(`<h4 class="newsletter-title" data-v-54a32a66><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-54a32a66><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" data-v-54a32a66></path><polyline points="22,6 12,13 2,6" data-v-54a32a66></polyline></svg> 订阅更新 </h4><p class="newsletter-desc" data-v-54a32a66>新文章发布时，通过邮件通知你</p>`,2),s(`form`,{onSubmit:k(o,[`prevent`]),class:`newsletter-form`},[f(s(`input`,{"onUpdate:modelValue":u[0]||=e=>t.value=e,type:`email`,placeholder:`your@email.com`,class:`newsletter-input`,disabled:r.value,required:``},null,8,$c),[[O,t.value]]),s(`button`,{type:`submit`,class:`newsletter-btn`,disabled:n.value||r.value},[n.value?(S(),c(`span`,tl,`...`)):r.value?(S(),c(`span`,nl,`✓`)):(S(),c(`span`,rl,`订阅`))],8,el)],32),i.value?(S(),c(`p`,{key:0,class:h(a.value)},l(i.value),3)):b(``,!0)]))}},[[`__scopeId`,`data-v-54a32a66`]]),al=`个人博客Blog`,ol=`Zhou Jun 的个人博客 — 技术、编程、AI 与科学`;function sl(e={}){let{title:t=al,description:n=ol,image:r=``,url:i=window.location.href}=e,a=t===`个人博客Blog`?t:`${t} | ${al}`;document.title=a;let o=(e,t,n=!1)=>{if(!t)return;let r=n?`name`:`property`,i=document.querySelector(`meta[${r}="${e}"]`);i||(i=document.createElement(`meta`),i.setAttribute(r,e),document.head.appendChild(i)),i.setAttribute(`content`,t)};o(`description`,n,!0),o(`og:title`,a),o(`og:description`,n),o(`og:image`,r),o(`og:url`,i),o(`og:type`,`article`),o(`twitter:card`,r?`summary_large_image`:`summary`),o(`twitter:title`,a),o(`twitter:description`,n),o(`twitter:image`,r),((e,t)=>{if(!t)return;let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement(`link`),n.setAttribute(`rel`,e),document.head.appendChild(n)),n.setAttribute(`href`,t)})(`canonical`,i)}var cl={title:al,description:ol,image:``,url:``};function ll(){sl({...cl,url:window.location.origin+`/`});let e=document.querySelector(`meta[property="og:type"]`);e&&e.setAttribute(`content`,`website`);let t=document.querySelector(`link[rel="canonical"]`);t&&t.setAttribute(`href`,window.location.origin+`/`)}function ul(e){if(!e)return 1;let t=(e.match(/[一-鿿㐀-䶿]/g)||[]).length+(e.match(/[a-zA-Z]+/g)||[]).length;return Math.max(1,Math.ceil(t/250))}function dl(e){return e?e.replace(/```[\s\S]*?```/g,``).replace(/`[^`]*`/g,``).replace(/!\[.*?\]\(.*?\)/g,``).replace(/\[([^\]]*)\]\(.*?\)/g,`$1`).replace(/[#*>`~\-+|_:]/g,` `).replace(/\s+/g,` `).trim():``}var fl={class:`page page-article-detail`},pl={key:0,class:`detail-skeleton`},ml={key:1,class:`error-state`},hl={key:2,class:`detail-layout`},gl={class:`detail-main`},_l={class:`article-header`},vl={class:`article-title`},yl={class:`article-meta`},bl={class:`meta-item meta-author`},xl={class:`meta-item meta-date`},Sl={key:0,class:`meta-item meta-category neon-text-pink`},Cl={class:`meta-item meta-reading-time`},wl={class:`meta-item meta-views`},Tl={key:0,class:`article-tags`},El={key:0,class:`article-cover`},Dl=[`src`,`alt`],Ol={key:1,class:`article-nav`},kl={class:`nav-title`},Al={class:`nav-title`},jl={class:`article-actions`},Ml=[`disabled`],Nl={class:`comment-section`},Pl={class:`detail-sidebar`},Fl=y({__name:`ArticleDetail`,setup(i){let o=E();D();let f=N(),y=w(null),x=w(!0),C=w(null),O=w(null),k=w(0),P=0,F=v(()=>y.value?.created_at?new Date(y.value.created_at).toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}):``),I=v(()=>M(y.value?.author)),L=v(()=>j(y.value?.category)),R=v(()=>{let e=y.value?.tags;return!e||!Array.isArray(e)?[]:e.map(A).filter(Boolean)}),z=w(!1),B=w(!1),V=v(()=>window.location.origin+o.fullPath),H=v(()=>y.value?y.value.reading_time?y.value.reading_time:ul(dl(y.value.content||``)):1),ee=v(()=>y.value?JSON.stringify({"@context":`https://schema.org`,"@type":`Article`,headline:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||void 0,datePublished:y.value.created_at,dateModified:y.value.updated_at,author:{"@type":`Person`,name:`Zhou Jun`},publisher:{"@type":`Person`,name:`Zhou Jun`}}):``),te=null;p(ee,e=>{if(!e){te?.remove(),te=null;return}te||(te=document.createElement(`script`),te.type=`application/ld+json`,te.dataset.articleJsonLd=`1`,document.head.appendChild(te)),te.textContent=e},{immediate:!0});async function U(){if(!(z.value||B.value)){B.value=!0;try{let e=await T.post(`/articles/${y.value.slug}/like/`);y.value&&(y.value.likes_count=e.data.likes_count),z.value=!0}catch{}finally{B.value=!1}}}async function W(){let e=o.params.slug,t=++P;if(!e){C.value=`缺少文章标识`,O.value=null,x.value=!1;return}x.value=!0,C.value=null,O.value=null,y.value=null,z.value=!1;try{let n=f.getArticleBySlug(e);if(n){if(t!==P)return;y.value=n,x.value=!1,G();return}let r=await f.fetchArticleBySlug(e);if(t!==P)return;y.value=r,y.value?G():C.value=`文章不存在`}catch(e){if(t!==P)return;O.value=e?.response?.status??null,O.value===404?C.value=`文章不存在`:C.value=e?.response?.data?.detail||e.message||`加载文章失败`}finally{t===P&&(x.value=!1)}}function G(){y.value&&sl({title:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||``,url:window.location.origin+o.fullPath})}return a(W),p(()=>o.params.slug,()=>{window.scrollTo({top:0,behavior:`instant`}),k.value++,W()}),t(()=>{ll(),te?.remove(),te=null}),(t,i)=>{let a=n(`router-link`);return S(),c(`div`,fl,[x.value?(S(),c(`div`,pl,[...i[1]||=[_(`<div class="skeleton-header" data-v-c0862088><div class="skeleton-line w-80 skeleton-lg" data-v-c0862088></div><div class="skeleton-meta-row" data-v-c0862088><div class="skeleton-line w-20" data-v-c0862088></div><div class="skeleton-line w-15" data-v-c0862088></div><div class="skeleton-line w-10" data-v-c0862088></div></div></div><div class="skeleton-body" data-v-c0862088><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-90" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-70" data-v-c0862088></div></div>`,2)]])):C.value?(S(),c(`div`,ml,[i[3]||=s(`svg`,{width:`48`,height:`48`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`line`,{x1:`12`,y1:`8`,x2:`12`,y2:`12`}),s(`line`,{x1:`12`,y1:`16`,x2:`12.01`,y2:`16`})],-1),s(`h2`,null,l(O.value===404?`文章不存在`:`加载失败`),1),s(`p`,null,l(C.value),1),u(a,{to:`/articles`,class:`back-link`},{default:e(()=>[...i[2]||=[g(`返回首页`,-1)]]),_:1})])):y.value?(S(),c(`div`,hl,[s(`article`,gl,[s(`header`,_l,[s(`h1`,vl,l(y.value.title),1),s(`div`,yl,[s(`span`,bl,[i[4]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2`}),s(`circle`,{cx:`12`,cy:`7`,r:`4`})],-1),g(` `+l(I.value),1)]),s(`span`,xl,[i[5]||=_(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-c0862088><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-c0862088></rect><line x1="16" y1="2" x2="16" y2="6" data-v-c0862088></line><line x1="8" y1="2" x2="8" y2="6" data-v-c0862088></line><line x1="3" y1="10" x2="21" y2="10" data-v-c0862088></line></svg>`,1),g(` `+l(F.value),1)]),y.value.category?(S(),c(`span`,Sl,[i[6]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z`})],-1),g(` `+l(L.value),1)])):b(``,!0),s(`span`,Cl,[i[7]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`polyline`,{points:`12 6 12 12 16 14`})],-1),g(` 约 `+l(H.value)+` 分钟 `,1)]),s(`span`,wl,[i[8]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z`}),s(`circle`,{cx:`12`,cy:`12`,r:`3`})],-1),g(` `+l(y.value.views_count||0),1)])]),R.value.length?(S(),c(`div`,Tl,[(S(!0),c(d,null,r(R.value,(e,t)=>(S(),c(`span`,{key:t,class:`tag-pill`},l(e),1))),128))])):b(``,!0)]),y.value.cover_image?(S(),c(`div`,El,[s(`img`,{src:y.value.cover_image,alt:y.value.title},null,8,Dl)])):b(``,!0),u(Zs,{html:y.value.html_content||y.value.content||``,title:y.value.title},null,8,[`html`,`title`]),y.value.prev_article||y.value.next_article?(S(),c(`nav`,Ol,[y.value.prev_article?(S(),m(a,{key:0,to:`/article/`+(y.value.prev_article.slug||y.value.prev_article),class:`nav-link prev-link`},{default:e(()=>[i[9]||=s(`span`,{class:`nav-direction`},[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`15 18 9 12 15 6`})]),g(` 上一篇 `)],-1),s(`span`,kl,l(y.value.prev_article.title||y.value.prev_article),1)]),_:1},8,[`to`])):b(``,!0),y.value.next_article?(S(),m(a,{key:1,to:`/article/`+(y.value.next_article.slug||y.value.next_article),class:`nav-link next-link`},{default:e(()=>[i[10]||=s(`span`,{class:`nav-direction`},[g(` 下一篇 `),s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 18 15 12 9 6`})])],-1),s(`span`,Al,l(y.value.next_article.title||y.value.next_article),1)]),_:1},8,[`to`])):b(``,!0)])):b(``,!0),s(`div`,jl,[u(Gc,{title:y.value.title,url:V.value},null,8,[`title`,`url`]),s(`button`,{class:h([`like-btn`,{liked:z.value}]),disabled:B.value,onClick:U},[i[11]||=s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z`})],-1),s(`span`,null,l(y.value.likes_count||0),1)],10,Ml)]),u(Zc,{articles:y.value.related_articles||[]},null,8,[`articles`]),u(il),s(`section`,Nl,[(S(),m(Ic,{"article-slug":y.value.slug,key:k.value},null,8,[`article-slug`])),u(hc,{"article-slug":y.value.slug,onSubmitted:i[0]||=e=>k.value++},null,8,[`article-slug`])])]),s(`aside`,Pl,[u(Hc,{html:y.value.html_content||y.value.content||``},null,8,[`html`])])])):b(``,!0)])}}},[[`__scopeId`,`data-v-c0862088`]]);export{Fl as default};