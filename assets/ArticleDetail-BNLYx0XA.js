import{A as e,C as t,D as n,E as r,R as i,S as a,b as o,c as s,d as c,dt as l,h as u,i as d,j as f,k as p,l as m,lt as h,m as g,p as _,s as v,t as y,u as b,ut as x,w as S,x as C,z as w}from"./_plugin-vue_export-helper-BK47PYcU.js";import{t as T}from"./client-DyaaoQco.js";import{f as E,p as D,v as O,y as k}from"./index-BqiBf9Qe.js";import{i as A,n as j,t as M}from"./labels-H7OcNmBE.js";import{t as N}from"./article-CGDNx2Dv.js";function P(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function F(e){if(Array.isArray(e))return e}function I(e,t){var n=e==null?null:typeof Symbol<`u`&&e[Symbol.iterator]||e[`@@iterator`];if(n!=null){var r,i,a,o,s=[],c=!0,l=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(c=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);c=!0);}catch(e){l=!0,i=e}finally{try{if(!c&&n.return!=null&&(o=n.return(),Object(o)!==o))return}finally{if(l)throw i}}return s}}function L(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function R(e,t){return F(e)||I(e,t)||z(e,t)||L()}function z(e,t){if(e){if(typeof e==`string`)return P(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?P(e,t):void 0}}var ee=Object.entries,B=Object.setPrototypeOf,V=Object.isFrozen,te=Object.getPrototypeOf,ne=Object.getOwnPropertyDescriptor,H=Object.freeze,U=Object.seal,W=Object.create,re=typeof Reflect<`u`&&Reflect,ie=re.apply,G=re.construct;H||=function(e){return e},U||=function(e){return e},ie||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},G||=function(e){return new e(...[...arguments].slice(1))};var ae=J(Array.prototype.forEach),oe=J(Array.prototype.lastIndexOf),se=J(Array.prototype.pop),ce=J(Array.prototype.push),le=J(Array.prototype.splice),ue=Array.isArray,de=J(String.prototype.toLowerCase),fe=J(String.prototype.toString),pe=J(String.prototype.match),me=J(String.prototype.replace),he=J(String.prototype.indexOf),ge=J(String.prototype.trim),_e=J(Number.prototype.toString),K=J(Boolean.prototype.toString),ve=typeof BigInt>`u`?null:J(BigInt.prototype.toString),q=typeof Symbol>`u`?null:J(Symbol.prototype.toString),ye=J(Object.prototype.hasOwnProperty),be=J(Object.prototype.toString),xe=J(RegExp.prototype.test),Se=Ce(TypeError);function J(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return ie(e,t,n)}}function Ce(e){return function(){return G(e,[...arguments])}}function Y(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:de;if(B&&B(e,null),!ue(t))return e;let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(V(t)||(t[r]=e),i=e)}e[i]=!0}return e}function we(e){for(let t=0;t<e.length;t++)ye(e,t)||(e[t]=null);return e}function Te(e){let t=W(null);for(let r of ee(e)){var n=R(r,2);let i=n[0],a=n[1];ye(e,i)&&(ue(a)?t[i]=we(a):a&&typeof a==`object`&&a.constructor===Object?t[i]=Te(a):t[i]=a)}return t}function Ee(e){switch(typeof e){case`string`:return e;case`number`:return _e(e);case`boolean`:return K(e);case`bigint`:return ve?ve(e):`0`;case`symbol`:return q?q(e):`Symbol()`;case`undefined`:return be(e);case`function`:case`object`:{if(e===null)return be(e);let t=e,n=De(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:be(e)}return be(e)}default:return be(e)}}function De(e,t){for(;e!==null;){let n=ne(e,t);if(n){if(n.get)return J(n.get);if(typeof n.value==`function`)return J(n.value)}e=te(e)}function n(){return null}return n}function Oe(e){try{return xe(e,``),!0}catch{return!1}}var ke=H(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),Ae=H(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),je=H([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),Me=H([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),Ne=H(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),Pe=H([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),Fe=H([`#text`]),Ie=H(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),Le=H(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dominant-baseline.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-orientation.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),Re=H(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),ze=H([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),Be=U(/{{[\w\W]*|^[\w\W]*}}/g),Ve=U(/<%[\w\W]*|^[\w\W]*%>/g),He=U(/\${[\w\W]*/g),Ue=U(/^data-[\-\w.\u00B7-\uFFFF]+$/),We=U(/^aria-[\-\w]+$/),Ge=U(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Ke=U(/^(?:\w+script|data):/i),qe=U(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Je=U(/^html$/i),Ye=U(/^[a-z][.\w]*(-[.\w]+)+$/i),Xe=U(/<[/\w!]/g),Ze=U(/<[/\w]/g),Qe=U(/<\/no(script|embed|frames)/i),$e=U(/\/>/i),et={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,processingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},tt=function(){return typeof window>`u`?null:window},nt=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},rt=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},it=function(e,t,n,r){return ye(e,t)&&ue(e[t])?Y(r.base?Te(r.base):{},e[t],r.transform):n};function at(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:tt(),t=e=>at(e);if(t.version=`3.4.12`,t.removed=[],!e||!e.document||e.document.nodeType!==et.document||!e.Element)return t.isSupported=!1,t;let n=e.document,r=n,i=r.currentScript;e.DocumentFragment;let a=e.HTMLTemplateElement,o=e.Node,s=e.Element,c=e.NodeFilter;e.NamedNodeMap===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;let l=e.DOMParser,u=e.trustedTypes,d=s.prototype,f=De(d,`cloneNode`),p=De(d,`remove`),m=De(d,`nextSibling`),h=De(d,`childNodes`),g=De(d,`parentNode`),_=De(d,`shadowRoot`),v=De(d,`attributes`),y=o&&o.prototype?De(o.prototype,`nodeType`):null,b=o&&o.prototype?De(o.prototype,`nodeName`):null;if(typeof a==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let x,S=``,C,w=!1,T=0,E=function(){if(T>0)throw Se(`A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.`)},D=function(e){E(),T++;try{return x.createHTML(e)}finally{T--}},O=function(e){E(),T++;try{return x.createScriptURL(e)}finally{T--}},k=function(){return w||=(C=nt(u,i),!0),C},A=n,j=A.implementation,M=A.createNodeIterator,N=A.createDocumentFragment,P=A.getElementsByTagName,F=r.importNode,I=rt();t.isSupported=typeof ee==`function`&&typeof g==`function`&&j&&j.createHTMLDocument!==void 0;let L=Be,R=Ve,z=He,B=Ue,V=We,te=Ke,ne=qe,re=Ye,ie=Ge,G=null,_e=Y({},[...ke,...Ae,...je,...Ne,...Fe]),K=null,ve=Y({},[...Ie,...Le,...Re,...ze]),q=Object.seal(W(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),be=null,J=null,Ce=Object.seal(W(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),we=!0,ot=!0,st=!1,ct=!0,lt=!1,ut=!0,X=!1,dt=!1,ft=null,pt=null,mt=!1,Z=!1,Q=!1,ht=!1,gt=!0,_t=!1,vt=`user-content-`,yt=!0,bt=!1,xt={},St=null,Ct=Y({},`annotation-xml.audio.colgroup.desc.foreignobject.head.iframe.math.mi.mn.mo.ms.mtext.noembed.noframes.noscript.plaintext.script.selectedcontent.style.svg.template.thead.title.video.xmp`.split(`.`)),wt=null,Tt=Y({},[`audio`,`video`,`img`,`source`,`image`,`track`]),Et=null,Dt=Y({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),Ot=`http://www.w3.org/1998/Math/MathML`,kt=`http://www.w3.org/2000/svg`,At=`http://www.w3.org/1999/xhtml`,jt=At,Mt=!1,Nt=null,Pt=Y({},[Ot,kt,At],fe),Ft=H([`mi`,`mo`,`mn`,`ms`,`mtext`]),It=Y({},Ft),Lt=H([`annotation-xml`]),Rt=Y({},Lt),zt=Y({},[`title`,`style`,`font`,`a`,`script`]),Bt=null,Vt=[`application/xhtml+xml`,`text/html`],$=null,Ht=null,Ut=n.createElement(`form`),Wt=function(e){return e instanceof RegExp||e instanceof Function},Gt=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ht&&Ht===e)return;(!e||typeof e!=`object`)&&(e={}),e=Te(e),Bt=Vt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,$=Bt===`application/xhtml+xml`?fe:de,G=it(e,`ALLOWED_TAGS`,_e,{transform:$}),K=it(e,`ALLOWED_ATTR`,ve,{transform:$}),Nt=it(e,`ALLOWED_NAMESPACES`,Pt,{transform:fe}),Et=it(e,`ADD_URI_SAFE_ATTR`,Dt,{transform:$,base:Dt}),wt=it(e,`ADD_DATA_URI_TAGS`,Tt,{transform:$,base:Tt}),St=it(e,`FORBID_CONTENTS`,Ct,{transform:$}),be=it(e,`FORBID_TAGS`,Te({}),{transform:$}),J=it(e,`FORBID_ATTR`,Te({}),{transform:$}),xt=ye(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?Te(e.USE_PROFILES):e.USE_PROFILES:!1,we=e.ALLOW_ARIA_ATTR!==!1,ot=e.ALLOW_DATA_ATTR!==!1,st=e.ALLOW_UNKNOWN_PROTOCOLS||!1,ct=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,lt=e.SAFE_FOR_TEMPLATES||!1,ut=e.SAFE_FOR_XML!==!1,X=e.WHOLE_DOCUMENT||!1,Z=e.RETURN_DOM||!1,Q=e.RETURN_DOM_FRAGMENT||!1,ht=e.RETURN_TRUSTED_TYPE||!1,mt=e.FORCE_BODY||!1,gt=e.SANITIZE_DOM!==!1,_t=e.SANITIZE_NAMED_PROPS||!1,yt=e.KEEP_CONTENT!==!1,bt=e.IN_PLACE||!1,ie=Oe(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:Ge,jt=typeof e.NAMESPACE==`string`?e.NAMESPACE:At,It=ye(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?Te(e.MATHML_TEXT_INTEGRATION_POINTS):Y({},Ft),Rt=ye(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?Te(e.HTML_INTEGRATION_POINTS):Y({},Lt);let t=ye(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?Te(e.CUSTOM_ELEMENT_HANDLING):W(null);if(q=W(null),ye(t,`tagNameCheck`)&&Wt(t.tagNameCheck)&&(q.tagNameCheck=t.tagNameCheck),ye(t,`attributeNameCheck`)&&Wt(t.attributeNameCheck)&&(q.attributeNameCheck=t.attributeNameCheck),ye(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(q.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),U(q),lt&&(ot=!1),Q&&(Z=!0),xt&&(G=Y({},Fe),K=W(null),xt.html===!0&&(Y(G,ke),Y(K,Ie)),xt.svg===!0&&(Y(G,Ae),Y(K,Le),Y(K,ze)),xt.svgFilters===!0&&(Y(G,je),Y(K,Le),Y(K,ze)),xt.mathMl===!0&&(Y(G,Ne),Y(K,Re),Y(K,ze))),Ce.tagCheck=null,Ce.attributeCheck=null,ye(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?Ce.tagCheck=e.ADD_TAGS:ue(e.ADD_TAGS)&&(G===_e&&(G=Te(G)),Y(G,e.ADD_TAGS,$))),ye(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?Ce.attributeCheck=e.ADD_ATTR:ue(e.ADD_ATTR)&&(K===ve&&(K=Te(K)),Y(K,e.ADD_ATTR,$))),ye(e,`ADD_URI_SAFE_ATTR`)&&ue(e.ADD_URI_SAFE_ATTR)&&Y(Et,e.ADD_URI_SAFE_ATTR,$),ye(e,`FORBID_CONTENTS`)&&ue(e.FORBID_CONTENTS)&&(St===Ct&&(St=Te(St)),Y(St,e.FORBID_CONTENTS,$)),ye(e,`ADD_FORBID_CONTENTS`)&&ue(e.ADD_FORBID_CONTENTS)&&(St===Ct&&(St=Te(St)),Y(St,e.ADD_FORBID_CONTENTS,$)),yt&&(G[`#text`]=!0),X&&Y(G,[`html`,`head`,`body`]),G.table&&(Y(G,[`tbody`]),delete be.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw Se(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw Se(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);let t=x;x=e.TRUSTED_TYPES_POLICY;try{S=D(``)}catch(e){throw x=t,e}}else e.TRUSTED_TYPES_POLICY===null?(x=void 0,S=``):(x===void 0&&(x=k()),x&&typeof S==`string`&&(S=D(``)));H&&H(e),Ht=e},Kt=Y({},[...Ae,...je,...Me]),qt=Y({},[...Ne,...Pe]),Jt=function(e,t,n){return t.namespaceURI===At?e===`svg`:t.namespaceURI===Ot?e===`svg`&&(n===`annotation-xml`||It[n]):!!Kt[e]},Yt=function(e,t,n){return t.namespaceURI===At?e===`math`:t.namespaceURI===kt?e===`math`&&Rt[n]:!!qt[e]},Xt=function(e,t,n){return t.namespaceURI===kt&&!Rt[n]||t.namespaceURI===Ot&&!It[n]?!1:!qt[e]&&(zt[e]||!Kt[e])},Zt=function(e){let t=g(e);(!t||!t.tagName)&&(t={namespaceURI:jt,tagName:`template`});let n=de(e.tagName),r=de(t.tagName);return Nt[e.namespaceURI]?e.namespaceURI===kt?Jt(n,t,r):e.namespaceURI===Ot?Yt(n,t,r):e.namespaceURI===At?Xt(n,t,r):!!(Bt===`application/xhtml+xml`&&Nt[e.namespaceURI]):!1},Qt=function(e){ce(t.removed,{element:e});try{g(e).removeChild(e)}catch{if(p(e),!g(e))throw Se(`a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place`)}},$t=function(e){nn(e);let t=h(e);if(t){let e=[];ae(t,t=>{ce(e,t)}),ae(e,e=>{try{p(e)}catch{}})}let n=v(e);if(n)for(let t=n.length-1;t>=0;--t){let r=n[t],i=r&&r.name;if(typeof i==`string`)try{e.removeAttribute(i)}catch{}}},en=function(e,n){try{ce(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{ce(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(Z||Q)try{Qt(n)}catch{}else try{n.setAttribute(e,``)}catch{}},tn=function(e){let t=v(e);if(t)for(let n=t.length-1;n>=0;--n){let r=t[n],i=r&&r.name;if(!(typeof i!=`string`||K[$(i)]))try{e.removeAttribute(i)}catch{}}},nn=function(e){let t=[e];for(;t.length>0;){let e=t.pop();(y?y(e):e.nodeType)===et.element&&tn(e);let n=h(e);if(n)for(let e=n.length-1;e>=0;--e)t.push(n[e])}},rn=function(e){if(!ut)return;let t=[e];for(;t.length>0;){let e=t.pop(),n=y?y(e):e.nodeType;if(n===et.processingInstruction||n===et.comment&&xe(Ze,e.data)){try{p(e)}catch{}continue}if(n===et.element){let t=e,n=$(b?b(e):e.nodeName);try{t.hasAttribute&&t.hasAttribute(`patchsrc`)&&t.removeAttribute(`patchsrc`),t.hasAttribute&&t.hasAttribute(`for`)&&n!==`label`&&n!==`output`&&t.removeAttribute(`for`)}catch{}}let r=h(e);if(r)for(let e=r.length-1;e>=0;--e)t.push(r[e])}},an=function(e){let t=null,r=null;if(mt)e=`<remove></remove>`+e;else{let t=pe(e,/^[\r\n\t ]+/);r=t&&t[0]}Bt===`application/xhtml+xml`&&jt===At&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=x?D(e):e;if(jt===At)try{t=new l().parseFromString(i,Bt)}catch{}if(!t||!t.documentElement){t=j.createDocument(jt,`template`,null);try{t.documentElement.innerHTML=Mt?S:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),jt===At?P.call(t,X?`html`:`body`)[0]:X?t.documentElement:a},on=function(e){return M.call(e.ownerDocument||e,e,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},sn=function(e){return e=me(e,L,` `),e=me(e,R,` `),e=me(e,z,` `),e},cn=function(e){e.normalize();let t=M.call(e.ownerDocument||e,e,c.SHOW_TEXT|c.SHOW_COMMENT|c.SHOW_CDATA_SECTION|c.SHOW_PROCESSING_INSTRUCTION,null),n=t.nextNode();for(;n;)n.data=sn(n.data),n=t.nextNode();let r=e.querySelectorAll?.call(e,`template`);r&&ae(r,e=>{un(e.content)&&cn(e.content)})},ln=function(e){let t=b?b(e):null;return typeof t!=`string`||$(t)!==`form`?!1:typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||e.attributes!==v(e)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`||e.nodeType!==y(e)||e.childNodes!==h(e)},un=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return y(e)===et.documentFragment}catch{return!1}},dn=function(e){if(!y||typeof e!=`object`||!e)return!1;try{return typeof y(e)==`number`}catch{return!1}};function fn(e,n,r){e.length!==0&&ae(e,e=>{e.call(t,n,r,Ht)})}let pn=function(e,t){return!!(ut&&e.hasChildNodes()&&!dn(e.firstElementChild)&&xe(Xe,e.textContent)&&xe(Xe,e.innerHTML)||ut&&e.namespaceURI===At&&t===`style`&&dn(e.firstElementChild)||e.nodeType===et.processingInstruction||ut&&e.nodeType===et.comment&&xe(Ze,e.data))},mn=function(e,t){if(!be[t]&&vn(t)&&(q.tagNameCheck instanceof RegExp&&xe(q.tagNameCheck,t)||q.tagNameCheck instanceof Function&&q.tagNameCheck(t)))return!1;if(yt&&!St[t]){let t=g(e),n=h(e);if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=bt?n[i]:f(n[i],!0);t.insertBefore(r,m(e))}}}return Qt(e),!0},hn=function(e,n){if(fn(I.beforeSanitizeElements,e,null),e!==n&&g(e)===null)return!0;if(ln(e))return Qt(e),!0;let r=$(b?b(e):e.nodeName);if(fn(I.uponSanitizeElement,e,{tagName:r,allowedTags:G}),e!==n&&g(e)===null)return!0;if(pn(e,r))return Qt(e),!0;if(be[r]||!(Ce.tagCheck instanceof Function&&Ce.tagCheck(r))&&!G[r]){let t=mn(e,r);return t===!1&&fn(I.afterSanitizeElements,e,null),t}if((y?y(e):e.nodeType)===et.element&&!Zt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&xe(Qe,e.innerHTML))return Qt(e),!0;if(lt&&e.nodeType===et.text){let n=sn(e.textContent);e.textContent!==n&&(ce(t.removed,{element:e.cloneNode()}),e.textContent=n)}return fn(I.afterSanitizeElements,e,null),!1},gn=function(e,t,r){if(J[t]||ut&&t===`patchsrc`||ut&&t===`for`&&e!==`label`&&e!==`output`||gt&&(t===`id`||t===`name`)&&(r in n||r in Ut))return!1;let i=K[t]||Ce.attributeCheck instanceof Function&&Ce.attributeCheck(t,e);if(!(ot&&xe(B,t))&&!(we&&xe(V,t))){if(!i){if(!(vn(e)&&(q.tagNameCheck instanceof RegExp&&xe(q.tagNameCheck,e)||q.tagNameCheck instanceof Function&&q.tagNameCheck(e))&&(q.attributeNameCheck instanceof RegExp&&xe(q.attributeNameCheck,t)||q.attributeNameCheck instanceof Function&&q.attributeNameCheck(t,e))||t===`is`&&q.allowCustomizedBuiltInElements&&(q.tagNameCheck instanceof RegExp&&xe(q.tagNameCheck,r)||q.tagNameCheck instanceof Function&&q.tagNameCheck(r))))return!1}else if(!Et[t]&&!xe(ie,me(r,ne,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&he(r,`data:`)===0&&wt[e])&&!(st&&!xe(te,me(r,ne,``)))&&r)return!1}return!0},_n=Y({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),vn=function(e){return!_n[de(e)]&&xe(re,e)},yn=function(e,t,n,r){if(x&&typeof u==`object`&&typeof u.getAttributeType==`function`&&!n)switch(u.getAttributeType(e,t)){case`TrustedHTML`:return D(r);case`TrustedScriptURL`:return O(r)}return r},bn=function(e,n,r,i){try{r?e.setAttributeNS(r,n,i):e.setAttribute(n,i),ln(e)?Qt(e):se(t.removed)}catch{en(n,e)}},xn=function(e){fn(I.beforeSanitizeAttributes,e,null);let t=e.attributes;if(!t||ln(e))return;let n={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:K,forceKeepAttr:void 0},r=t.length,i=$(e.nodeName);for(;r--;){let a=t[r],o=a.name,s=a.namespaceURI,c=a.value,l=$(o),u=c,d=o===`value`?u:ge(u);if(n.attrName=l,n.attrValue=d,n.keepAttr=!0,n.forceKeepAttr=void 0,fn(I.uponSanitizeAttribute,e,n),d=n.attrValue,_t&&(l===`id`||l===`name`)&&he(d,vt)!==0&&(en(o,e),d=vt+d),ut&&xe(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){en(o,e);continue}if(l===`attributename`&&pe(d,`href`)){en(o,e);continue}if(!n.forceKeepAttr){if(!n.keepAttr){en(o,e);continue}if(!ct&&xe($e,d)){en(o,e);continue}if(lt&&(d=sn(d)),!gn(i,l,d)){en(o,e);continue}d=yn(i,l,s,d),d!==u&&bn(e,o,s,d)}}fn(I.afterSanitizeAttributes,e,null)},Sn=function(e){let t=null,n=on(e);for(fn(I.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)if(fn(I.uponSanitizeShadowNode,t,null),hn(t,e),xn(t),un(t.content)&&Sn(t.content),(y?y(t):t.nodeType)===et.element){let e=_(t);un(e)&&(Cn(e),Sn(e))}fn(I.afterSanitizeShadowDOM,e,null)},Cn=function(e){let t=[{node:e,shadow:null}];for(;t.length>0;){let e=t.pop();if(e.shadow){Sn(e.shadow);continue}let n=e.node,r=(y?y(n):n.nodeType)===et.element,i=h(n);if(i)for(let e=i.length-1;e>=0;--e)t.push({node:i[e],shadow:null});if(r){let e=b?b(n):null;if(typeof e==`string`&&$(e)===`template`){let e=n.content;un(e)&&t.push({node:e,shadow:null})}}if(r){let e=_(n);un(e)&&t.push({node:null,shadow:e},{node:e,shadow:null})}}};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,a=null,o=null,s=null;if(Mt=!e,Mt&&(e=`<!-->`),typeof e!=`string`&&!dn(e)&&(e=Ee(e),typeof e!=`string`))throw Se(`dirty is not a string, aborting`);if(!t.isSupported)return e;dt?(G=ft,K=pt):Gt(n),(I.uponSanitizeElement.length>0||I.uponSanitizeAttribute.length>0)&&(G=Te(G)),I.uponSanitizeAttribute.length>0&&(K=Te(K)),t.removed=[];let c=bt&&typeof e!=`string`&&dn(e);if(c){rn(e);let t=b?b(e):e.nodeName;if(typeof t==`string`){let n=$(t);if(!G[n]||be[n])throw $t(e),Se(`root node is forbidden and cannot be sanitized in-place`)}if(ln(e))throw $t(e),Se(`root node is clobbered and cannot be sanitized in-place`);try{Cn(e)}catch(t){throw $t(e),t}}else if(dn(e))i=an(`<!---->`),a=i.ownerDocument.importNode(e,!0),a.nodeType===et.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?i=a:i.appendChild(a),Cn(a);else{if(!Z&&!lt&&!X&&e.indexOf(`<`)===-1)return x&&ht?D(e):e;if(i=an(e),!i)return Z?null:ht?S:``}i&&mt&&Qt(i.firstChild);let l=c?e:i,u=on(l);try{for(;o=u.nextNode();)hn(o,l),xn(o),un(o.content)&&Sn(o.content)}catch(n){throw c&&($t(e),ae(t.removed,e=>{e.element&&nn(e.element)})),n}if(c)return ae(t.removed,e=>{e.element&&nn(e.element)}),lt&&cn(e),e;if(Z){if(lt&&cn(i),Q)for(s=N.call(i.ownerDocument);i.firstChild;)s.appendChild(i.firstChild);else s=i;return(K.shadowroot||K.shadowrootmode)&&(s=F.call(r,s,!0)),s}let d=X?i.outerHTML:i.innerHTML;return X&&G[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&xe(Je,i.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+d),lt&&(d=sn(d)),x&&ht?D(d):d},t.setConfig=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Gt(e),dt=!0,ft=G,pt=K},t.clearConfig=function(){Ht=null,dt=!1,ft=null,pt=null,x=C,S=``},t.isValidAttribute=function(e,t,n){Ht||Gt({});let r=$(e),i=$(t);return gn(r,i,n)},t.addHook=function(e,t){typeof t==`function`&&ye(I,e)&&ce(I[e],t)},t.removeHook=function(e,t){if(ye(I,e)){if(t!==void 0){let n=oe(I[e],t);return n===-1?void 0:le(I[e],n,1)[0]}return se(I[e])}},t.removeHooks=function(e){ye(I,e)&&(I[e]=[])},t.removeAllHooks=function(){I=rt()},t}var ot=at();function st(e,t){let n=String(e??``),r=n.match(/^\s*<h1\b[^>]*>([\s\S]*?)<\/h1>\s*/i);if(!r)return n;let i=r[1].replace(/<[^>]*>/g,``).replace(/\s+/g,` `).trim(),a=String(t??``).replace(/\s+/g,` `).trim();return!a||i!==a?n:n.slice(r[0].length)}function ct(e){let t=e.length,n=Array.from({length:t},(e,n)=>n+1<t?n+1:null),r=[],i=null,a=t>0?0:null,o=null,s=(e,t)=>r.push({phase:e,desc:t,prev:i,curr:a,next:o,nextOf:[...n],done:!1}),c=t=>t===null?`∅`:String(e[t]);if(t===0)return s(`init`,"空链表。`head` 本身就是 ∅，直接返回 ∅ —— 这是必须单独处理的第一种边界。"),r[0].done=!0,r;for(s(`init`,`初始状态：\`prev\` 先站在 ∅（反转后头节点会变成尾节点，它的 \`next\` 必须指向空），\`curr\` 指向头节点 ${c(a)}。`);a!==null;)o=n[a],s(`read-next`,`① \`next = curr.next\`，先记住 ${c(o)}。这一步看着多余，其实是整个算法的命门：一旦 ② 把 \`curr\` 的指针掉头，通往后面节点的唯一线索就断了，所以必须提前存好。`),n[a]=i,s(`flip`,`② \`curr.next = prev\`，把 ${c(a)} 的箭头掉个头，指向 ${c(i)}。`+(i===null?` 因为 \`prev\` 还是 ∅，${c(a)} 就成了新的尾节点。`:``)),i=a,a=o,s(`advance`,a===null?`③ \`prev = curr\`，\`curr = next\` = ∅。curr 走出了链表，循环结束 —— 返回 \`prev\`（${c(i)}），它就是反转后的新头节点。`:`③ \`prev\` 和 \`curr\` 一起右移：\`prev\` 指向 ${c(i)}，\`curr\` 指向 ${c(a)}。准备处理下一个节点。`);return r[r.length-1].done=!0,r}var lt=`viz-chrome-styles`,ut=`http://www.w3.org/2000/svg`;function X(e,t){let n=document.createElementNS(ut,e);if(t)for(let e in t)n.setAttribute(e,t[e]);return n}function dt(e,t,n,r,i=`viz-arrow`){let a=X(`g`,{class:i}),o=r>0?t:e,s=r>0?e:t;return a.appendChild(X(`line`,{class:`${i}__line`,x1:s,y1:n,x2:o-r*9,y2:n})),a.appendChild(X(`path`,{class:`${i}__head`,d:`M ${o} ${n} L ${o-r*9} ${n-5.5} L ${o-r*9} ${n+5.5} Z`})),a}var ft=`
.viz {
  margin: 1.6em 0;
...
`;function Mo(){if(document.getElementById(So))return;let e=document.createElement(`style`);e.id=So,e.textContent=jo,document.head.appendChild(e)}function No(e,t={}){if(!e||e.dataset.mpsMounted===`1`)return{destroy(){}};e.dataset.mpsMounted=`1`,Mo();let n=xo(t),r=t.autoplay!==!1,{nodes:i,root:a}=Ga(Array.isArray(t.values)?t.values:[-10,9,20,null,null,15,7]),o=e=>e==null||!i[e]?null:i[e].value,s=X,c=document.createElement(`div`);c.className=`viz mps`;let l=document.createElement(`div`);l.className=`viz__stage`,c.appendChild(l);function u(){let e=document.createElement(`p`);return e.className=`viz__desc`,e.setAttribute(`aria-live`,`polite`),e}if(a===-1){let t=s(`svg`,{class:`viz__svg mps__svg`,viewBox:`0 0 620 120`,role:`img`}),n=s(`text`,{class:`mps-empty__text`,x:620/2,y:120/2});return n.textContent=`空树 —— 没有节点，路径和按 0 处理（LeetCode 保证至少一个节点）`,t.appendChild(n),l.appendChild(t),c.appendChild(u()),c.appendChild(Q().root),e.textContent=``,e.appendChild(c),{destroy(){e.textContent=``,delete e.dataset.mpsMounted,document.getElementById(So)?.remove()}}}let d=i.reduce((e,t)=>Math.max(e,t.depth),0),f=new Map;f.set(a,[]);for(let e of i)e.parent!==-1&&f.set(e.id,[...f.get(e.parent)??[],e.side]);let p=e=>Eo*2**Math.max(0,d-e),m=e=>{let t=0;for(let n of f.get(e.id)??[])t=t*2+ +(n===`R`);return(t+.5)*p(e.depth)},h=2**d*Eo,g=Math.max(660,Do+h+68),_=(g-h)/2,v=e=>To+e*wo,y=e=>({x:_+m(i[e]),y:v(i[e].depth)}),b=To+d*wo+Co+Oo,x=Math.min(600,g-Do*2),S=s(`svg`,{class:`viz__svg mps__svg`,viewBox:`0 0 ${g} ${b+ko+26}`,role:`img`,"aria-label":`二叉树最大路径和推演动画`});l.appendChild(S);let C=s(`g`,{class:`mps-edges`}),w=s(`g`,{class:`mps-nodes`}),T=s(`g`,{class:`mps-labels`});S.appendChild(C),S.appendChild(w),S.appendChild(T);let E=new Map;for(let e of i){if(e.parent===-1)continue;let t=y(e.parent),n=y(e.id),r=s(`path`,{class:`mps-edge`,d:`M ${t.x} ${t.y+Co} L ${n.x} ${n.y-Co}`});C.appendChild(r),E.set(e.id,r)}let D=e=>{if(e.parent===-1)return 0;let t=e.side===`L`?i[e.parent].right:i[e.parent].left;if(t==null)return 0;let n=Math.abs(y(e.id).x-y(t).x);if(n>=76)return 0;let r=(76-n)/2+4;return e.side===`L`?-r:r},O=[];for(let e of i){let t=y(e.id),n=s(`g`,{class:`mps-node`,transform:`translate(${t.x} ${t.y})`});n.appendChild(s(`circle`,{class:`mps-node__ring`,r:31})),n.appendChild(s(`circle`,{class:`mps-node__circle`,cx:0,cy:0,r:Co}));let r=s(`text`,{class:`mps-node__value`,x:0,y:0});r.textContent=String(e.value),n.appendChild(r),w.appendChild(n);let i=s(`g`,{class:`mps-node__gaing`,transform:`translate(${t.x+D(e)} ${t.y})`});i.appendChild(s(`rect`,{class:`mps-node__gain`,x:-32,y:-57,width:64,height:22,rx:7}));let a=s(`text`,{class:`mps-node__gain-text`,x:0,y:-46});i.appendChild(a),T.appendChild(i),O.push({g:n,gainG:i,gt:a,id:e.id})}let k=s(`g`,{class:`mps-banner`});k.appendChild(s(`rect`,{class:`mps-banner__box`,x:Do,y:b,width:x,height:ko,rx:9}));let A=s(`text`,{class:`mps-banner__label`,x:42,y:b+ko/2});A.textContent=`当前最优路径和`,k.appendChild(A);let j=s(`text`,{class:`mps-banner__value`,x:162,y:b+ko/2});k.appendChild(j);let M=s(`text`,{class:`mps-banner__path`,x:Do+x-16,y:b+ko/2});k.appendChild(M),S.appendChild(k);let N=u();function P(e,t){if(!t)return;let n=t.stack.length?t.stack[t.stack.length-1].id:null,r=new Set(t.bestPath??[]),a=new Set(t.pruned??[]),s=e=>Object.prototype.hasOwnProperty.call(t.gainOf,e);for(let e of O){let{id:i,g:o,gainG:c,gt:l}=e,u=[`mps-node`],d=s(i),f=d?t.gainOf[i]:null;d&&u.push(f>0?`is-plus`:`is-zero`),a.has(i)&&u.push(`is-zero`),i===n&&u.push(`is-visit`),r.has(i)&&u.push(`is-onpath`),i===t.bestNode&&u.push(`is-apex`),o.setAttribute(`class`,u.join(` `)),d?(c.style.opacity=`1`,l.textContent=`gain ${f}`):c.style.opacity=`0`}for(let e of i){if(e.parent===-1)continue;let n=E.get(e.id),i=[`mps-edge`];r.has(e.id)&&r.has(e.parent)&&i.push(`is-onpath`),s(e.id)&&t.gainOf[e.id]<=0&&i.push(`is-prune`),n.setAttribute(`class`,i.join(` `))}t.bestNode===null||!(t.bestPath??[]).length?(j.textContent=`—`,M.textContent=`还没算完任何一条路径`):(j.textContent=String(t.best),M.textContent=(t.bestPath??[]).map(e=>o(e)).join(` → `)),Z(N,t.desc)}c.appendChild(N);let F=Q();c.appendChild(F.root),e.textContent=``,e.appendChild(c),pt();let I=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches,L=ht({steps:n,controls:F,intervalMs:Ao,onRender:P});L.jumpTo(Math.trunc(t.initialStep)||0);let R=null;return r&&!I&&typeof IntersectionObserver==`function`&&(R=new IntersectionObserver(e=>{for(let t of e)if(t.isIntersecting){R.disconnect(),R=null,L.play();return}},{threshold:.35}),R.observe(c)),{destroy(){R&&=(R.disconnect(),null),L.destroy(),e.textContent=``,delete e.dataset.mpsMounted,document.getElementById(So)?.remove()}}}var Po=[`innerHTML`],Fo=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,Io=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,Lo=`0.16.21`,Ro=`11.4.1`,zo=y({__name:`MarkdownView`,props:{html:{type:String,default:``},title:{type:String,default:``}},setup(e){let t=e,n=w(null),r=v(()=>st(ot.sanitize(t.html,{ADD_ATTR:[`target`,`rel`],FORBID_TAGS:[`style`,`iframe`,`object`,`embed`,`form`],FORBID_ATTR:[`onerror`,`onload`,`onclick`]}),t.title));function i(e){e.classList.add(`copied`),e.innerHTML=Io,setTimeout(()=>{e.classList.remove(`copied`),e.innerHTML=Fo},2e3)}function s(){n.value&&n.value.querySelectorAll(`table`).forEach(e=>{if(e.parentElement?.classList.contains(`table-scroll`))return;let t=document.createElement(`div`);t.className=`table-scroll`,e.parentNode.insertBefore(t,e),t.appendChild(e)})}function l(){n.value&&n.value.querySelectorAll(`pre`).forEach(e=>{if(e.parentElement?.classList.contains(`code-block-wrapper`))return;let t=document.createElement(`div`);t.className=`code-block-wrapper`,e.parentNode.insertBefore(t,e),t.appendChild(e);let n=document.createElement(`button`);n.className=`copy-btn`,n.title=`复制代码`,n.innerHTML=Fo,n.addEventListener(`click`,()=>{let t=(e.querySelector(`code`)||e).textContent||``;navigator.clipboard.writeText(t).then(()=>{i(n)}).catch(()=>{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),i(n)})}),t.appendChild(n)})}function u(e,t){return new Promise((n,r)=>{if(document.querySelector(`link[data-lib-href="${e}"]`))return n();let i=document.createElement(`link`);i.rel=`stylesheet`,i.href=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libHref=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load stylesheet `+e)),document.head.appendChild(i)})}function d(e,t){return new Promise((n,r)=>{if(document.querySelector(`script[data-lib-src="${e}"]`))return n();let i=document.createElement(`script`);i.src=e,i.integrity=t,i.crossOrigin=`anonymous`,i.dataset.libSrc=e,i.onload=()=>n(),i.onerror=()=>r(Error(`Failed to load script `+e)),document.head.appendChild(i)})}let f=null;async function m(){return f||=Promise.all([u(`https://cdn.jsdelivr.net/npm/katex@${Lo}/dist/katex.min.css`,`sha384-zh0CIslj+VczCZtlzBcjt5ppRcsAmDnRem7ESsYwWwg3m/OaJ2l4x7YBZl9Kxxib`),d(`https://cdn.jsdelivr.net/npm/katex@${Lo}/dist/katex.min.js`,`sha384-Rma6DA2IPUwhNxmrB/7S3Tno0YY7sFu9WSYMCuulLhIqYSGZ2gKCJWIqhBWqMQfh`)]).then(()=>window.katex),f}let h=null;async function g(){return h||=d(`https://cdn.jsdelivr.net/npm/mermaid@${Ro}/dist/mermaid.min.js`,`sha384-rbtjAdnIQE/aQJGEgXrVUlMibdfTSa4PQju4HDhN3sR2PmaKFzhEafuePsl9H/9I`).then(()=>window.mermaid),h}async function _(){if(!n.value)return;let e=n.value.querySelectorAll(`code.language-mermaid`);if(e.length)try{let t=await g();e.forEach(e=>{let n=e.closest(`pre`);if(!n||n.dataset.mermaidRendered)return;n.dataset.mermaidRendered=`1`;let r=document.createElement(`div`);r.className=`mermaid-container`,r.textContent=e.textContent,n.parentNode.replaceChild(r,n),t.run({nodes:[r]})})}catch(e){console.warn(`Mermaid failed to load/render:`,e?.message||e)}n.value.querySelectorAll(`img`).forEach(e=>{let t=e.getAttribute(`src`)||``;e.getAttribute(`alt`);let n=t.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([\w-]+)/);if(n){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://www.youtube.com/embed/${n[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}let r=t.match(/bilibili\.com\/video\/(BV[\w]+)/);if(r){let t=document.createElement(`div`);t.className=`video-wrapper`,t.innerHTML=`<iframe src="https://player.bilibili.com/player.html?bvid=${r[1]}" frameborder="0" allowfullscreen></iframe>`,e.parentNode.replaceChild(t,e);return}});let t=/(\$\$[\s\S]+?\$\$|\$[^\s$](?:[^$]*[^\s$])?\$)/,r=document.createTreeWalker(n.value,NodeFilter.SHOW_TEXT),i=[],a;for(;a=r.nextNode();)!a.nodeValue||!t.test(a.nodeValue)||a.parentElement?.closest(`pre, code`)||i.push(a);if(i.length)try{let e=await m();for(let n of i){let r=document.createDocumentFragment();for(let i of n.nodeValue.split(t)){if(!i)continue;let t=i.startsWith(`$$`)&&i.endsWith(`$$`)&&i.length>3,n=!t&&i.startsWith(`$`)&&i.endsWith(`$`)&&i.length>2;if(!t&&!n){r.appendChild(document.createTextNode(i));continue}let a=i.slice(t?2:1,t?-2:-1),o=document.createElement(`span`);o.innerHTML=e.renderToString(a,{displayMode:t,throwOnError:!1}),r.appendChild(o)}n.parentNode.replaceChild(r,n)}}catch(e){console.warn(`KaTeX failed to load/render:`,e?.message||e)}}let y={"algo-viz--lc206":Ft,"algo-viz--lc21":nn,"algo-viz--lc23":Pn,"algo-viz--lc23dc":$n,"algo-viz--lc141":Er,"algo-viz--lc142":Br,"algo-viz--lc19":ai,"algo-viz--lc143":Ei,"algo-viz--lc234":Yi,"algo-viz--lc160":ba,"algo-viz--lc82":Wa,"algo-viz--lc102":ao,"algo-viz--lc236":bo,"algo-viz--lc124":No},b=[];function x(){b.forEach(e=>{try{e?.destroy?.()}catch(e){console.warn(`Algo viz teardown failed:`,e?.message||e)}}),b=[]}function T(){n.value&&(x(),n.value.querySelectorAll(`.algo-viz`).forEach(e=>{let t=Object.keys(y).find(t=>e.classList.contains(t));if(t)try{b.push(y[t](e))}catch(e){console.warn(`Algo viz failed to mount:`,t,e?.message||e)}}))}return a(()=>{o(()=>{T(),_(),s(),l()})}),C(x),p(()=>t.html,()=>{o(()=>{T(),_(),s(),l()})}),(e,t)=>(S(),c(`div`,{ref_key:`bodyRef`,ref:n,class:`markdown-body`,innerHTML:r.value},null,8,Po))}},[[`__scopeId`,`data-v-cc6cebd2`]]);function Bo(e){return T.get(`/articles/${e}/comments/`)}function Vo(e,t){return T.post(`/articles/${e}/comments/`,t)}var Ho={key:0,class:`form-title`},Uo={key:1,class:`form-title`},Wo={class:`form-field`},Go={key:0,class:`field-error`},Ko={class:`form-field`},qo={key:0,class:`field-error`},Jo={class:`hp-field`,"aria-hidden":`true`},Yo={class:`form-field`},Xo={key:0,class:`field-error`},Zo={key:0,class:`submit-error`},Qo={key:1,class:`submit-success`},$o={class:`form-actions`},es=[`disabled`],ts={key:0,class:`spinner`},ns={key:1},rs=y({__name:`CommentForm`,props:{articleSlug:{type:String,required:!0},parentId:{type:[Number,String],default:null}},emits:[`submitted`,`cancel`],setup(e,{emit:t}){let n=e,r=t,a=i({author_name:``,author_email:``,content:``,website:``}),o=i({author_name:``,author_email:``,content:``}),u=w(!1),d=w(null),p=w(!1);function m(){let e=!0;return o.author_name=``,o.author_email=``,o.content=``,a.author_name.trim()||(o.author_name=`请输入昵称`,e=!1),a.author_email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.author_email)||(o.author_email=`邮箱格式不正确`,e=!1):(o.author_email=`请输入邮箱`,e=!1),a.content.trim()?a.content.trim().length<3&&(o.content=`评论内容至少3个字符`,e=!1):(o.content=`请输入评论内容`,e=!1),e}function g(e){o[e]&&(o[e]=``),d.value=null}async function _(){if(m()){u.value=!0,d.value=null;try{let e={author_name:a.author_name.trim(),author_email:a.author_email.trim(),content:a.content.trim(),website:a.website};n.parentId&&(e.parent=n.parentId),await Vo(n.articleSlug,e),p.value=!0,setTimeout(()=>{p.value=!1},3e3),r(`submitted`),a.author_name=``,a.author_email=``,a.content=``}catch(e){let t=e?.response?.data;if(typeof t==`object`&&t){let e=t;e.author_name&&(o.author_name=Array.isArray(e.author_name)?e.author_name[0]:e.author_name),e.author_email&&(o.author_email=Array.isArray(e.author_email)?e.author_email[0]:e.author_email),e.content&&(o.content=Array.isArray(e.content)?e.content[0]:e.content),e.detail&&(d.value=e.detail),e.non_field_errors&&(d.value=Array.isArray(e.non_field_errors)?e.non_field_errors[0]:e.non_field_errors)}else typeof t==`string`?d.value=t:d.value=e.message||`提交失败，请稍后重试`}finally{u.value=!1}}}return(t,n)=>(S(),c(`div`,{class:h([`comment-form`,{"reply-form":!!e.parentId}])},[e.parentId?(S(),c(`h4`,Ho,`回复评论`)):(S(),c(`h4`,Uo,`发表评论`)),s(`form`,{onSubmit:k(_,[`prevent`]),class:`form-body`},[s(`div`,Wo,[f(s(`input`,{"onUpdate:modelValue":n[0]||=e=>a.author_name=e,type:`text`,placeholder:`昵称 *`,class:h([`form-input`,{"input-error":o.author_name}]),onInput:n[1]||=e=>g(`author_name`)},null,34),[[O,a.author_name]]),o.author_name?(S(),c(`p`,Go,l(o.author_name),1)):b(``,!0)]),s(`div`,Ko,[f(s(`input`,{"onUpdate:modelValue":n[2]||=e=>a.author_email=e,type:`email`,placeholder:`邮箱 *`,class:h([`form-input`,{"input-error":o.author_email}]),onInput:n[3]||=e=>g(`author_email`)},null,34),[[O,a.author_email]]),o.author_email?(S(),c(`p`,qo,l(o.author_email),1)):b(``,!0)]),s(`div`,Jo,[f(s(`input`,{"onUpdate:modelValue":n[4]||=e=>a.website=e,type:`text`,tabindex:`-1`,autocomplete:`off`},null,512),[[O,a.website]])]),s(`div`,Yo,[f(s(`textarea`,{"onUpdate:modelValue":n[5]||=e=>a.content=e,placeholder:`说点什么...`,rows:`4`,class:h([`form-textarea`,{"input-error":o.content}]),onInput:n[6]||=e=>g(`content`)},null,34),[[O,a.content]]),o.content?(S(),c(`p`,Xo,l(o.content),1)):b(``,!0)]),d.value?(S(),c(`p`,Zo,l(d.value),1)):b(``,!0),p.value?(S(),c(`p`,Qo,`评论已提交！`)):b(``,!0),s(`div`,$o,[e.parentId?(S(),c(`button`,{key:0,type:`button`,class:`cancel-btn`,onClick:n[7]||=e=>t.$emit(`cancel`)},` 取消回复 `)):b(``,!0),s(`button`,{type:`submit`,class:`submit-btn`,disabled:u.value},[u.value?(S(),c(`span`,ts)):(S(),c(`span`,ns,`提交`))],8,es)])],32)],2))}},[[`__scopeId`,`data-v-49410be9`]]),is={class:`comment-list`},as={class:`comments-title`},os={key:0,class:`comments-count`},ss={key:0,class:`skeleton-comments`},cs={key:1,class:`empty-comments`},ls={key:2,class:`comments-tree`},us={class:`comment-main`},ds={class:`comment-content`},fs={class:`comment-header`},ps={class:`comment-author`},ms={class:`comment-time`},hs={class:`comment-text`},gs=[`onClick`],_s={key:1,class:`replies`},vs={class:`comment-main`},ys={class:`comment-content`},bs={class:`comment-header`},xs={class:`comment-author`},Ss={class:`comment-time`},Cs={class:`comment-text`},ws=y({__name:`CommentList`,props:{articleSlug:{type:String,required:!0}},setup(e){let t=e,n=w([]),i=w(!0),o=w(null),u=v(()=>n.value.filter(e=>!e.parent));function f(e){o.value=o.value===e?null:e}async function p(){i.value=!0;try{let e=await Bo(t.articleSlug);n.value=e.data.results||e.data||[]}catch{n.value=[]}finally{i.value=!1}}function h(){o.value=null,p()}function y(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<1?`刚刚`:n<60?`${n}分钟前`:r<24?`${r}小时前`:i<30?`${i}天前`:i<365?`${Math.floor(i/30)}个月前`:`${Math.floor(i/365)}年前`}function C(e){let t=[`#3f6b57`,`#a45f45`,`#8a6c3f`,`#637b68`,`#7b6757`,`#4f7477`,`#8a635f`,`#6b7250`,`#536b5d`,`#9b704e`,`#65706a`,`#7b6a83`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}return a(p),(t,a)=>(S(),c(`div`,is,[s(`h3`,as,[a[1]||=g(` 评论 `,-1),n.value.length?(S(),c(`span`,os,`(`+l(n.value.length)+`)`,1)):b(``,!0)]),i.value?(S(),c(`div`,ss,[(S(),c(d,null,r(3,e=>s(`div`,{key:e,class:`skeleton-comment`},[...a[2]||=[_(`<div class="skeleton-avatar" data-v-98dfce57></div><div class="skeleton-body" data-v-98dfce57><div class="skeleton-line w-30" data-v-98dfce57></div><div class="skeleton-line w-50" data-v-98dfce57></div><div class="skeleton-line w-80" data-v-98dfce57></div></div>`,2)]])),64))])):u.value.length?(S(),c(`div`,ls,[(S(!0),c(d,null,r(u.value,t=>(S(),c(`div`,{key:t.id,class:`comment-item`},[s(`div`,us,[s(`div`,{class:`comment-avatar`,style:x({background:C(t.author_name)})},l(t.author_name?t.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,ds,[s(`div`,fs,[s(`span`,ps,l(t.author_name),1),s(`span`,ms,l(y(t.created_at)),1)]),s(`p`,hs,l(t.content),1),s(`button`,{class:`reply-btn`,onClick:e=>f(t.id)},[...a[4]||=[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 17 4 12 9 7`}),s(`path`,{d:`M20 18v-2a4 4 0 0 0-4-4H4`})],-1),g(` 回复 `,-1)]],8,gs)])]),o.value===t.id?(S(),m(rs,{key:0,"article-slug":e.articleSlug,"parent-id":t.id,onSubmitted:h,onCancel:a[0]||=e=>o.value=null,class:`reply-form-wrapper`},null,8,[`article-slug`,`parent-id`])):b(``,!0),t.replies&&t.replies.length?(S(),c(`div`,_s,[(S(!0),c(d,null,r(t.replies,e=>(S(),c(`div`,{key:e.id,class:`comment-item reply-item`},[s(`div`,vs,[s(`div`,{class:`comment-avatar comment-avatar-sm`,style:x({background:C(e.author_name)})},l(e.author_name?e.author_name.charAt(0).toUpperCase():`?`),5),s(`div`,ys,[s(`div`,bs,[s(`span`,xs,l(e.author_name),1),s(`span`,Ss,l(y(e.created_at)),1)]),s(`p`,Cs,l(e.content),1)])])]))),128))])):b(``,!0)]))),128))])):(S(),c(`div`,cs,[...a[3]||=[s(`svg`,{width:`40`,height:`40`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z`})],-1),s(`p`,null,`暂无评论，来说点什么吧`,-1)]]))]))}},[[`__scopeId`,`data-v-98dfce57`]]),Ts={key:0,class:`toc-list-wrapper`},Es={class:`toc-list`},Ds=[`href`,`title`,`onClick`],Os={class:`toc-text`},ks={key:1,class:`toc-empty-state`},As=y({__name:`TocNav`,props:{html:{type:String,default:``}},setup(e){let t=e,n=w([]),i=w(null),u=null,f=[];function m(){if(!t.html){n.value=[];return}try{let e=new DOMParser().parseFromString(t.html,`text/html`),r=[];e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let n=e.id||`toc-heading-${t}`;r.push({id:n,tag:e.tagName.toLowerCase(),text:e.textContent||``})}),n.value=r}catch{n.value=[]}}function g(){if(!n.value.length)return;let e=document.querySelector(`.markdown-body`);e&&e.querySelectorAll(`h2, h3, h4`).forEach((e,t)=>{let r=n.value[t];r&&!e.id&&(e.id=r.id)})}function _(){u&&=(u.disconnect(),null),f=[],n.value.length&&(u=new IntersectionObserver(e=>{let t=e.filter(e=>e.isIntersecting);t.length?i.value=t[0].target.id:window.scrollY<100&&(i.value=n.value[0]?.id||null)},{rootMargin:`-80px 0px -60% 0px`,threshold:0}),o(()=>{n.value.forEach(e=>{let t=document.getElementById(e.id);t&&(u.observe(t),f.push(t))})}))}function v(e){let t=document.getElementById(e);t&&(t.scrollIntoView({behavior:`smooth`,block:`start`}),i.value=e)}return p(()=>t.html,()=>{m(),o(()=>{g(),_()})}),a(()=>{m(),o(()=>{g(),_()})}),C(()=>{u&&u.disconnect()}),(e,t)=>(S(),c(`nav`,{class:h([`toc-nav`,{"toc-empty":!n.value.length}])},[t[2]||=s(`h4`,{class:`toc-title`},`目录`,-1),n.value.length?(S(),c(`div`,Ts,[s(`ul`,Es,[(S(!0),c(d,null,r(n.value,e=>(S(),c(`li`,{key:e.id,class:h([`toc-item`,[`toc-depth-${e.tag}`,{"toc-active":i.value===e.id}]])},[s(`a`,{href:`#`+e.id,class:`toc-link`,title:e.text,onClick:k(t=>v(e.id),[`prevent`])},[t[0]||=s(`span`,{class:`toc-dot`},null,-1),s(`span`,Os,l(e.text),1)],8,Ds)],2))),128))])])):(S(),c(`div`,ks,[...t[1]||=[s(`p`,null,`无目录`,-1)]]))],2))}},[[`__scopeId`,`data-v-21d21cb1`]]),js={class:`share-buttons`},Ms={key:0,class:`copy-feedback`},Ns=y({__name:`ShareButtons`,props:{title:{type:String,default:``},url:{type:String,default:``}},setup(e){let t=e,n=w(!1);function r(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://service.weibo.com/share/share.php?url=${e}&title=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function i(){let e=encodeURIComponent(t.url||window.location.href),n=encodeURIComponent(t.title);window.open(`https://twitter.com/intent/tweet?url=${e}&text=${n}`,`_blank`,`noopener,noreferrer,width=600,height=400`)}function a(){alert(`请复制链接后在微信中粘贴发送`)}async function o(){try{await navigator.clipboard.writeText(t.url||window.location.href),n.value=!0,setTimeout(()=>n.value=!1,2e3)}catch{let e=document.createElement(`textarea`);e.value=t.url||window.location.href,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),n.value=!0,setTimeout(()=>n.value=!1,2e3)}}return(e,t)=>(S(),c(`div`,js,[t[4]||=s(`span`,{class:`share-label`},`分享：`,-1),s(`button`,{class:`share-btn wechat`,title:`微信`,onClick:a},[...t[0]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178A1.17 1.17 0 0 1 4.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 0 1-1.162 1.178 1.17 1.17 0 0 1-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229.826 0 1.622-.12 2.361-.336a.722.722 0 0 1 .598.082l1.584.926a.272.272 0 0 0 .14.045c.136 0 .241-.11.241-.245 0-.06-.024-.12-.04-.178l-.325-1.233a.49.49 0 0 1 .178-.554C23.028 18.48 24 16.82 24 14.98c0-3.21-2.931-5.952-7.062-6.122zm-2.18 2.769c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982zm4.844 0c.535 0 .969.44.969.982a.976.976 0 0 1-.969.983.976.976 0 0 1-.969-.983c0-.542.434-.982.97-.982z`})],-1)]]),s(`button`,{class:`share-btn weibo`,title:`微博`,onClick:r},[...t[1]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M10.098 20.323c-3.977.391-7.414-1.406-7.672-4.02-.259-2.609 2.759-5.047 6.74-5.441 3.979-.394 7.413 1.404 7.671 4.018.259 2.6-2.759 5.049-6.739 5.443zm-7.317-6.781c-1.059-.2-1.911.419-1.903 1.383.008.964.87 1.907 1.93 2.107 1.058.2 1.91-.419 1.903-1.383-.008-.964-.87-1.907-1.93-2.107zm2.13 3.68c-.563-.249-.754-.766-.428-1.153.326-.388 1.019-.523 1.58-.275.56.248.753.764.429 1.153-.326.386-1.018.524-1.581.275zm.992-3.808c-2.07-.028-4.538.537-7.344 2.641C-.405 17.1-.279 19.15.35 20.49c.528 1.123 1.494 1.773 2.43 2.144 4.878 1.935 10.857.606 13.679-1.35 2.934-2.035 4.033-4.771 3.157-7.165-.516-1.405-1.797-2.398-3.31-2.882l.06-.05c2.485-2.08 4.213-4.585 4.213-7.146 0-5.213-7.11-7.735-10.966-5.371-1.742 1.07-2.772 2.788-3.064 4.72.422-.12.865-.197 1.323-.23 3.271-.241 7.273.776 7.273 3.86 0 3.502-3.823 4.667-6.721 4.667-.89 0-1.785-.215-2.595-.598z`})],-1)]]),s(`button`,{class:`share-btn twitter`,title:`Twitter`,onClick:i},[...t[2]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z`})],-1)]]),s(`button`,{class:`share-btn copy`,title:`复制链接`,onClick:o},[...t[3]||=[s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71`}),s(`path`,{d:`M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71`})],-1)]]),n.value?(S(),c(`span`,Ms,`已复制`)):b(``,!0)]))}},[[`__scopeId`,`data-v-857c6fb5`]]),Ps={key:0,class:`related-section`},Fs={class:`related-grid`},Is={key:0,class:`related-cover`},Ls=[`src`,`alt`],Rs={class:`related-card-title`},zs=y({__name:`RelatedArticles`,props:{articles:{type:Array,default:()=>[]}},setup(t){return(i,a)=>{let o=n(`router-link`);return t.articles.length?(S(),c(`section`,Ps,[a[0]||=s(`h3`,{class:`related-title`},`相关文章`,-1),s(`div`,Fs,[(S(!0),c(d,null,r(t.articles,t=>(S(),m(o,{key:t.slug,to:`/article/`+t.slug,class:`related-card`},{default:e(()=>[t.cover_image?(S(),c(`div`,Is,[s(`img`,{src:t.cover_image,alt:t.title,loading:`lazy`},null,8,Ls)])):b(``,!0),s(`span`,Rs,l(t.title),1)]),_:2},1032,[`to`]))),128))])])):b(``,!0)}}},[[`__scopeId`,`data-v-e3d8298c`]]),Bs={class:`newsletter glass-card`},Vs=[`disabled`],Hs=[`disabled`],Us={key:0},Ws={key:1},Gs={key:2},Ks=y({__name:`NewsletterForm`,setup(e){let t=w(``),n=w(!1),r=w(!1),i=w(``),a=w(``);async function o(){if(t.value.trim()){n.value=!0,i.value=``;try{let e=await T.post(`/subscribe/`,{email:t.value.trim()});r.value=!0,i.value=e.data.detail||`订阅成功！`,a.value=`msg-success`}catch(e){let t=e?.response?.data?.error||e?.response?.data?.detail||`订阅失败`;i.value=typeof t==`string`?t:`订阅失败，请稍后重试`,a.value=`msg-error`}finally{n.value=!1}}}return(e,u)=>(S(),c(`div`,Bs,[u[1]||=_(`<h4 class="newsletter-title" data-v-54a32a66><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-54a32a66><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" data-v-54a32a66></path><polyline points="22,6 12,13 2,6" data-v-54a32a66></polyline></svg> 订阅更新 </h4><p class="newsletter-desc" data-v-54a32a66>新文章发布时，通过邮件通知你</p>`,2),s(`form`,{onSubmit:k(o,[`prevent`]),class:`newsletter-form`},[f(s(`input`,{"onUpdate:modelValue":u[0]||=e=>t.value=e,type:`email`,placeholder:`your@email.com`,class:`newsletter-input`,disabled:r.value,required:``},null,8,Vs),[[O,t.value]]),s(`button`,{type:`submit`,class:`newsletter-btn`,disabled:n.value||r.value},[n.value?(S(),c(`span`,Us,`...`)):r.value?(S(),c(`span`,Ws,`✓`)):(S(),c(`span`,Gs,`订阅`))],8,Hs)],32),i.value?(S(),c(`p`,{key:0,class:h(a.value)},l(i.value),3)):b(``,!0)]))}},[[`__scopeId`,`data-v-54a32a66`]]),qs=`个人博客Blog`,Js=`Zhou Jun 的个人博客 — 技术、编程、AI 与科学`;function Ys(e={}){let{title:t=qs,description:n=Js,image:r=``,url:i=window.location.href}=e,a=t===`个人博客Blog`?t:`${t} | ${qs}`;document.title=a;let o=(e,t,n=!1)=>{if(!t)return;let r=n?`name`:`property`,i=document.querySelector(`meta[${r}="${e}"]`);i||(i=document.createElement(`meta`),i.setAttribute(r,e),document.head.appendChild(i)),i.setAttribute(`content`,t)};o(`description`,n,!0),o(`og:title`,a),o(`og:description`,n),o(`og:image`,r),o(`og:url`,i),o(`og:type`,`article`),o(`twitter:card`,r?`summary_large_image`:`summary`),o(`twitter:title`,a),o(`twitter:description`,n),o(`twitter:image`,r),((e,t)=>{if(!t)return;let n=document.querySelector(`link[rel="${e}"]`);n||(n=document.createElement(`link`),n.setAttribute(`rel`,e),document.head.appendChild(n)),n.setAttribute(`href`,t)})(`canonical`,i)}var Xs={title:qs,description:Js,image:``,url:``};function Zs(){Ys({...Xs,url:window.location.origin+`/`});let e=document.querySelector(`meta[property="og:type"]`);e&&e.setAttribute(`content`,`website`);let t=document.querySelector(`link[rel="canonical"]`);t&&t.setAttribute(`href`,window.location.origin+`/`)}function Qs(e){if(!e)return 1;let t=(e.match(/[一-鿿㐀-䶿]/g)||[]).length+(e.match(/[a-zA-Z]+/g)||[]).length;return Math.max(1,Math.ceil(t/250))}function $s(e){return e?e.replace(/```[\s\S]*?```/g,``).replace(/`[^`]*`/g,``).replace(/!\[.*?\]\(.*?\)/g,``).replace(/\[([^\]]*)\]\(.*?\)/g,`$1`).replace(/[#*>`~\-+|_:]/g,` `).replace(/\s+/g,` `).trim():``}var ec={class:`page page-article-detail`},tc={key:0,class:`detail-skeleton`},nc={key:1,class:`error-state`},rc={key:2,class:`detail-layout`},ic={class:`detail-main`},ac={class:`article-header`},oc={class:`article-title`},sc={class:`article-meta`},cc={class:`meta-item meta-author`},lc={class:`meta-item meta-date`},uc={key:0,class:`meta-item meta-category neon-text-pink`},dc={class:`meta-item meta-reading-time`},fc={class:`meta-item meta-views`},pc={key:0,class:`article-tags`},mc={key:0,class:`article-cover`},hc=[`src`,`alt`],gc={key:1,class:`article-nav`},_c={class:`nav-title`},vc={class:`nav-title`},yc={class:`article-actions`},bc=[`disabled`],xc={class:`comment-section`},Sc={class:`detail-sidebar`},Cc=y({__name:`ArticleDetail`,setup(i){let o=E();D();let f=N(),y=w(null),x=w(!0),C=w(null),O=w(null),k=w(0),P=0,F=v(()=>y.value?.created_at?new Date(y.value.created_at).toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}):``),I=v(()=>M(y.value?.author)),L=v(()=>j(y.value?.category)),R=v(()=>{let e=y.value?.tags;return!e||!Array.isArray(e)?[]:e.map(A).filter(Boolean)}),z=w(!1),ee=w(!1),B=v(()=>window.location.origin+o.fullPath),V=v(()=>y.value?y.value.reading_time?y.value.reading_time:Qs($s(y.value.content||``)):1),te=v(()=>y.value?JSON.stringify({"@context":`https://schema.org`,"@type":`Article`,headline:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||void 0,datePublished:y.value.created_at,dateModified:y.value.updated_at,author:{"@type":`Person`,name:`Zhou Jun`},publisher:{"@type":`Person`,name:`Zhou Jun`}}):``),ne=null;p(te,e=>{if(!e){ne?.remove(),ne=null;return}ne||(ne=document.createElement(`script`),ne.type=`application/ld+json`,ne.dataset.articleJsonLd=`1`,document.head.appendChild(ne)),ne.textContent=e},{immediate:!0});async function H(){if(!(z.value||ee.value)){ee.value=!0;try{let e=await T.post(`/articles/${y.value.slug}/like/`);y.value&&(y.value.likes_count=e.data.likes_count),z.value=!0}catch{}finally{ee.value=!1}}}async function U(){let e=o.params.slug,t=++P;if(!e){C.value=`缺少文章标识`,O.value=null,x.value=!1;return}x.value=!0,C.value=null,O.value=null,y.value=null,z.value=!1;try{let n=f.getArticleBySlug(e);if(n){if(t!==P)return;y.value=n,x.value=!1,W();return}let r=await f.fetchArticleBySlug(e);if(t!==P)return;y.value=r,y.value?W():C.value=`文章不存在`}catch(e){if(t!==P)return;O.value=e?.response?.status??null,O.value===404?C.value=`文章不存在`:C.value=e?.response?.data?.detail||e.message||`加载文章失败`}finally{t===P&&(x.value=!1)}}function W(){y.value&&Ys({title:y.value.title,description:y.value.excerpt||``,image:y.value.cover_image||``,url:window.location.origin+o.fullPath})}return a(U),p(()=>o.params.slug,()=>{window.scrollTo({top:0,behavior:`instant`}),k.value++,U()}),t(()=>{Zs(),ne?.remove(),ne=null}),(t,i)=>{let a=n(`router-link`);return S(),c(`div`,ec,[x.value?(S(),c(`div`,tc,[...i[1]||=[_(`<div class="skeleton-header" data-v-c0862088><div class="skeleton-line w-80 skeleton-lg" data-v-c0862088></div><div class="skeleton-meta-row" data-v-c0862088><div class="skeleton-line w-20" data-v-c0862088></div><div class="skeleton-line w-15" data-v-c0862088></div><div class="skeleton-line w-10" data-v-c0862088></div></div></div><div class="skeleton-body" data-v-c0862088><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-90" data-v-c0862088></div><div class="skeleton-line w-100" data-v-c0862088></div><div class="skeleton-line w-70" data-v-c0862088></div></div>`,2)]])):C.value?(S(),c(`div`,nc,[i[3]||=s(`svg`,{width:`48`,height:`48`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`line`,{x1:`12`,y1:`8`,x2:`12`,y2:`12`}),s(`line`,{x1:`12`,y1:`16`,x2:`12.01`,y2:`16`})],-1),s(`h2`,null,l(O.value===404?`文章不存在`:`加载失败`),1),s(`p`,null,l(C.value),1),u(a,{to:`/articles`,class:`back-link`},{default:e(()=>[...i[2]||=[g(`返回首页`,-1)]]),_:1})])):y.value?(S(),c(`div`,rc,[s(`article`,ic,[s(`header`,ac,[s(`h1`,oc,l(y.value.title),1),s(`div`,sc,[s(`span`,cc,[i[4]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2`}),s(`circle`,{cx:`12`,cy:`7`,r:`4`})],-1),g(` `+l(I.value),1)]),s(`span`,lc,[i[5]||=_(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-c0862088><rect x="3" y="4" width="18" height="18" rx="2" ry="2" data-v-c0862088></rect><line x1="16" y1="2" x2="16" y2="6" data-v-c0862088></line><line x1="8" y1="2" x2="8" y2="6" data-v-c0862088></line><line x1="3" y1="10" x2="21" y2="10" data-v-c0862088></line></svg>`,1),g(` `+l(F.value),1)]),y.value.category?(S(),c(`span`,uc,[i[6]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z`})],-1),g(` `+l(L.value),1)])):b(``,!0),s(`span`,dc,[i[7]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`circle`,{cx:`12`,cy:`12`,r:`10`}),s(`polyline`,{points:`12 6 12 12 16 14`})],-1),g(` 约 `+l(V.value)+` 分钟 `,1)]),s(`span`,fc,[i[8]||=s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`path`,{d:`M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z`}),s(`circle`,{cx:`12`,cy:`12`,r:`3`})],-1),g(` `+l(y.value.views_count||0),1)])]),R.value.length?(S(),c(`div`,pc,[(S(!0),c(d,null,r(R.value,(e,t)=>(S(),c(`span`,{key:t,class:`tag-pill`},l(e),1))),128))])):b(``,!0)]),y.value.cover_image?(S(),c(`div`,mc,[s(`img`,{src:y.value.cover_image,alt:y.value.title},null,8,hc)])):b(``,!0),u(zo,{html:y.value.html_content||y.value.content||``,title:y.value.title},null,8,[`html`,`title`]),y.value.prev_article||y.value.next_article?(S(),c(`nav`,gc,[y.value.prev_article?(S(),m(a,{key:0,to:`/article/`+(y.value.prev_article.slug||y.value.prev_article),class:`nav-link prev-link`},{default:e(()=>[i[9]||=s(`span`,{class:`nav-direction`},[s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`15 18 9 12 15 6`})]),g(` 上一篇 `)],-1),s(`span`,_c,l(y.value.prev_article.title||y.value.prev_article),1)]),_:1},8,[`to`])):b(``,!0),y.value.next_article?(S(),m(a,{key:1,to:`/article/`+(y.value.next_article.slug||y.value.next_article),class:`nav-link next-link`},{default:e(()=>[i[10]||=s(`span`,{class:`nav-direction`},[g(` 下一篇 `),s(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`},[s(`polyline`,{points:`9 18 15 12 9 6`})])],-1),s(`span`,vc,l(y.value.next_article.title||y.value.next_article),1)]),_:1},8,[`to`])):b(``,!0)])):b(``,!0),s(`div`,yc,[u(Ns,{title:y.value.title,url:B.value},null,8,[`title`,`url`]),s(`button`,{class:h([`like-btn`,{liked:z.value}]),disabled:ee.value,onClick:H},[i[11]||=s(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`},[s(`path`,{d:`M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z`})],-1),s(`span`,null,l(y.value.likes_count||0),1)],10,bc)]),u(zs,{articles:y.value.related_articles||[]},null,8,[`articles`]),u(Ks),s(`section`,xc,[(S(),m(ws,{"article-slug":y.value.slug,key:k.value},null,8,[`article-slug`])),u(rs,{"article-slug":y.value.slug,onSubmitted:i[0]||=e=>k.value++},null,8,[`article-slug`])])]),s(`aside`,Sc,[u(As,{html:y.value.html_content||y.value.content||``},null,8,[`html`])])])):b(``,!0)])}}},[[`__scopeId`,`data-v-c0862088`]]);export{Cc as default};